...
procedure verify_hop_partitions_MaxRecord1(keyname: int)
{
  ...
  var s9_r#FIELD2 : int;
  var s9_v2 : int;
  var s9_#tmp2276 : unit;
  var s10_#tmp2277 : int;
  var s10_keyname : int;
  var s10_#tmp2279 : int;
  var s10_#tmp2280 : int;
  var s10_#tmp2281 : int;
  var s10_#tmp2282 : int;
  var s10_#tmp2283 : int;
  var s10_#tmp2284 : int;
  var s10_#tmp2285 : int;
  var s10_#tmp2286 : int;
  var s10_#tmp2287 : int;
  var s10_#tmp2288 : int;
  var s10_#tmp2289 : int;
  var s10_#tmp2290 : int;
  var s10_#tmp2291 : int;
  var s10_#tmp2292 : int;
  var s10_#tmp2293 : int;
  var s10_#tmp2294 : int;
  var s10_#tmp2295 : int;
  var s10_#tmp2296 : int;
  var s10_#tmp2298 : int;
  var s10_#tmp2300 : int;
  var s10_#tmp2301 : int;
  var s10_#tmp2302 : int;
  var s10_#tmp2304 : int;
  var s10_#tmp2306 : int;
  var s10_#tmp2307 : int;
  var s10_#tmp2308 : int;
  var s10_#tmp2309 : int;
  var s10_#tmp2310 : int;
  var s10_#tmp2311 : int;
  var s10_#tmp2312 : int;
  var s10_#tmp2315 : int;
  var s10_#tmp2317 : int;
  var s10_#tmp2318 : int;
  var s10_#tmp2321 : int;
  var s10_#tmp2323 : int;
  var s10_#tmp2390 : int;
  var s10_r#FIELD2 : int;
  var s10_v2 : int;
  var s10_#tmp2529 : unit;

  // Hop partition verification for function 'MaxRecord1'
  s1_block1:
    s1_#tmp0 := s1_keyname + 0;
    s1_#tmp2 := s1_#tmp0;
    s1_#tmp3 := s1_#tmp2;
    s1_#tmp4 := s1_#tmp3;
    s1_#tmp5 := s1_#tmp4;
    ...
    s1_#tmp74 := s1_#tmp70;
    s1_#tmp77 := s1_#tmp74;
    s1_#tmp112 := s1_#tmp77;
    s1_#tmp113 := s1_#tmp112;
    s1_r#FIELD2 := htable_FIELD2[s1_#tmp113];
    s1_v2 := s1_r#FIELD2;
    s1_#tmp252 := to_unit(s1_v2);
    goto s1_hop_exit;
  s1_hop_exit:
  s2_block2:
    s2_#tmp253 := s2_keyname + 1;
    s2_#tmp255 := s2_#tmp253;
    s2_#tmp256 := s2_#tmp255;
    s2_#tmp257 := s2_#tmp256;
    s2_#tmp258 := s2_#tmp257;
    s2_#tmp259 := s2_#tmp258;
    s2_#tmp260 := s2_#tmp259;
    s2_#tmp261 := s2_#tmp260;
    s2_#tmp262 := s2_#tmp261;
    s2_#tmp263 := s2_#tmp262;
    s2_#tmp264 := s2_#tmp263;
    s2_#tmp265 := s2_#tmp264;
    s2_#tmp266 := s2_#tmp265;
    s2_#tmp267 := s2_#tmp266;
    s2_#tmp268 := s2_#tmp267;
    s2_#tmp269 := s2_#tmp268;
    s2_#tmp270 := s2_#tmp269;
    s2_#tmp271 := s2_#tmp270;
    s2_#tmp272 := s2_#tmp271;
    s2_#tmp273 := s2_#tmp272;
    s2_#tmp274 := s2_#tmp273;
    s2_#tmp275 := s2_#tmp274;
    s2_#tmp276 := s2_#tmp275;
    s2_#tmp277 := s2_#tmp276;
    s2_#tmp278 := s2_#tmp277;
    s2_#tmp280 := s2_#tmp278;
    s2_#tmp281 := s2_#tmp280;
    s2_#tmp283 := s2_#tmp281;
    s2_#tmp299 := s2_#tmp283;
    s2_#tmp307 := s2_#tmp299;
    s2_#tmp321 := s2_#tmp307;
    s2_#tmp360 := s2_#tmp321;
    s2_#tmp366 := s2_#tmp360;
    s2_r#FIELD2 := htable_FIELD2[s2_#tmp366];
    s2_v2 := s2_r#FIELD2;
    s2_#tmp505 := to_unit(s2_v2);
    goto s2_hop_exit;
  s2_hop_exit:
  s3_block3:
    s3_#tmp506 := s3_keyname + 2;
    s3_#tmp508 := s3_#tmp506;
    s3_#tmp509 := s3_#tmp508;
    s3_#tmp510 := s3_#tmp509;
    s3_#tmp511 := s3_#tmp510;
    s3_#tmp512 := s3_#tmp511;
    s3_#tmp513 := s3_#tmp512;
    s3_#tmp514 := s3_#tmp513;
    s3_#tmp515 := s3_#tmp514;
    s3_#tmp516 := s3_#tmp515;
    s3_#tmp517 := s3_#tmp516;
    s3_#tmp518 := s3_#tmp517;
    s3_#tmp519 := s3_#tmp518;
    s3_#tmp520 := s3_#tmp519;
    s3_#tmp521 := s3_#tmp520;
    s3_#tmp522 := s3_#tmp521;
    s3_#tmp523 := s3_#tmp522;
    s3_#tmp524 := s3_#tmp523;
    s3_#tmp525 := s3_#tmp524;
    s3_#tmp526 := s3_#tmp525;
    s3_#tmp527 := s3_#tmp526;
    s3_#tmp528 := s3_#tmp527;
    s3_#tmp529 := s3_#tmp528;
    s3_#tmp530 := s3_#tmp529;
    s3_#tmp531 := s3_#tmp530;
    s3_#tmp539 := s3_#tmp531;
    s3_#tmp544 := s3_#tmp539;
    s3_#tmp562 := s3_#tmp544;
    s3_#tmp567 := s3_#tmp562;
    s3_#tmp572 := s3_#tmp567;
    s3_#tmp581 := s3_#tmp572;
    s3_#tmp619 := s3_#tmp581;
    s3_r#FIELD2 := htable_FIELD2[s3_#tmp619];
    s3_v2 := s3_r#FIELD2;
    s3_#tmp758 := to_unit(s3_v2);
    goto s3_hop_exit;
  s3_hop_exit:
  s4_block4:
    s4_#tmp759 := s4_keyname + 3;
    s4_#tmp761 := s4_#tmp759;
    s4_#tmp762 := s4_#tmp761;
    s4_#tmp763 := s4_#tmp762;
    s4_#tmp764 := s4_#tmp763;
    s4_#tmp765 := s4_#tmp764;
    s4_#tmp766 := s4_#tmp765;
    s4_#tmp767 := s4_#tmp766;
    s4_#tmp768 := s4_#tmp767;
    s4_#tmp769 := s4_#tmp768;
    s4_#tmp770 := s4_#tmp769;
    s4_#tmp771 := s4_#tmp770;
    s4_#tmp773 := s4_#tmp771;
    s4_#tmp774 := s4_#tmp773;
    s4_#tmp775 := s4_#tmp774;
    s4_#tmp776 := s4_#tmp775;
    s4_#tmp777 := s4_#tmp776;
    s4_#tmp778 := s4_#tmp777;
    s4_#tmp781 := s4_#tmp778;
    s4_#tmp782 := s4_#tmp781;
    s4_#tmp783 := s4_#tmp782;
    s4_#tmp786 := s4_#tmp783;
    s4_#tmp787 := s4_#tmp786;
    s4_#tmp798 := s4_#tmp787;
    s4_#tmp799 := s4_#tmp798;
    s4_#tmp804 := s4_#tmp799;
    s4_#tmp805 := s4_#tmp804;
    s4_#tmp806 := s4_#tmp805;
    s4_#tmp807 := s4_#tmp806;
    s4_#tmp812 := s4_#tmp807;
    s4_#tmp815 := s4_#tmp812;
    s4_#tmp816 := s4_#tmp815;
    s4_#tmp823 := s4_#tmp816;
    s4_#tmp835 := s4_#tmp823;
    s4_#tmp872 := s4_#tmp835;
    s4_r#FIELD2 := htable_FIELD2[s4_#tmp872];
    s4_v2 := s4_r#FIELD2;
    s4_#tmp1011 := to_unit(s4_v2);
    goto s4_hop_exit;
  s4_hop_exit:
  s5_block5:
    s5_#tmp1012 := s5_keyname + 4;
    s5_#tmp1014 := s5_#tmp1012;
    s5_#tmp1015 := s5_#tmp1014;
    s5_#tmp1016 := s5_#tmp1015;
    s5_#tmp1017 := s5_#tmp1016;
    s5_#tmp1018 := s5_#tmp1017;
    s5_#tmp1019 := s5_#tmp1018;
    s5_#tmp1020 := s5_#tmp1019;
    s5_#tmp1021 := s5_#tmp1020;
    s5_#tmp1022 := s5_#tmp1021;
    s5_#tmp1023 := s5_#tmp1022;
    s5_#tmp1024 := s5_#tmp1023;
    s5_#tmp1025 := s5_#tmp1024;
    s5_#tmp1026 := s5_#tmp1025;
    s5_#tmp1027 := s5_#tmp1026;
    s5_#tmp1028 := s5_#tmp1027;
    s5_#tmp1029 := s5_#tmp1028;
    s5_#tmp1030 := s5_#tmp1029;
    s5_#tmp1031 := s5_#tmp1030;
    s5_#tmp1034 := s5_#tmp1031;
    s5_#tmp1038 := s5_#tmp1034;
    s5_#tmp1039 := s5_#tmp1038;
    s5_#tmp1083 := s5_#tmp1039;
    s5_#tmp1099 := s5_#tmp1083;
    s5_#tmp1125 := s5_#tmp1099;
    s5_r#FIELD2 := htable_FIELD2[s5_#tmp1125];
    s5_v2 := s5_r#FIELD2;
    s5_#tmp1264 := to_unit(s5_v2);
    goto s5_hop_exit;
  s5_hop_exit:
  s6_block6:
    s6_#tmp1265 := s6_keyname + 5;
    s6_#tmp1267 := s6_#tmp1265;
    s6_#tmp1268 := s6_#tmp1267;
    s6_#tmp1269 := s6_#tmp1268;
    s6_#tmp1270 := s6_#tmp1269;
    s6_#tmp1271 := s6_#tmp1270;
    s6_#tmp1272 := s6_#tmp1271;
    s6_#tmp1273 := s6_#tmp1272;
    s6_#tmp1274 := s6_#tmp1273;
    s6_#tmp1275 := s6_#tmp1274;
    s6_#tmp1276 := s6_#tmp1275;
    s6_#tmp1277 := s6_#tmp1276;
    s6_#tmp1278 := s6_#tmp1277;
    s6_#tmp1279 := s6_#tmp1278;
    s6_#tmp1280 := s6_#tmp1279;
    s6_#tmp1281 := s6_#tmp1280;
    s6_#tmp1282 := s6_#tmp1281;
    s6_#tmp1283 := s6_#tmp1282;
    s6_#tmp1284 := s6_#tmp1283;
    s6_#tmp1285 := s6_#tmp1284;
    s6_#tmp1286 := s6_#tmp1285;
    s6_#tmp1288 := s6_#tmp1286;
    s6_#tmp1296 := s6_#tmp1288;
    s6_#tmp1315 := s6_#tmp1296;
    s6_#tmp1322 := s6_#tmp1315;
    s6_#tmp1330 := s6_#tmp1322;
    s6_#tmp1331 := s6_#tmp1330;
    s6_#tmp1341 := s6_#tmp1331;
    s6_#tmp1378 := s6_#tmp1341;
    s6_r#FIELD2 := htable_FIELD2[s6_#tmp1378];
    s6_v2 := s6_r#FIELD2;
    s6_#tmp1517 := to_unit(s6_v2);
    goto s6_hop_exit;
  s6_hop_exit:
  s7_block7:
    s7_#tmp1518 := s7_keyname + 6;
    s7_#tmp1520 := s7_#tmp1518;
    s7_#tmp1521 := s7_#tmp1520;
    s7_#tmp1522 := s7_#tmp1521;
    s7_#tmp1524 := s7_#tmp1522;
    s7_#tmp1525 := s7_#tmp1524;
    s7_#tmp1526 := s7_#tmp1525;
    s7_#tmp1527 := s7_#tmp1526;
    s7_#tmp1528 := s7_#tmp1527;
    s7_#tmp1529 := s7_#tmp1528;
    s7_#tmp1531 := s7_#tmp1529;
    s7_#tmp1532 := s7_#tmp1531;
    s7_#tmp1533 := s7_#tmp1532;
    s7_#tmp1534 := s7_#tmp1533;
    s7_#tmp1535 := s7_#tmp1534;
    s7_#tmp1537 := s7_#tmp1535;
    s7_#tmp1538 := s7_#tmp1537;
    s7_#tmp1539 := s7_#tmp1538;
    s7_#tmp1541 := s7_#tmp1539;
    s7_#tmp1544 := s7_#tmp1541;
    s7_#tmp1545 := s7_#tmp1544;
    s7_#tmp1546 := s7_#tmp1545;
    s7_#tmp1548 := s7_#tmp1546;
    s7_#tmp1550 := s7_#tmp1548;
    s7_#tmp1553 := s7_#tmp1550;
    s7_#tmp1555 := s7_#tmp1553;
    s7_#tmp1558 := s7_#tmp1555;
    s7_#tmp1562 := s7_#tmp1558;
    s7_#tmp1565 := s7_#tmp1562;
    s7_#tmp1569 := s7_#tmp1565;
    s7_#tmp1605 := s7_#tmp1569;
    s7_#tmp1610 := s7_#tmp1605;
    s7_#tmp1613 := s7_#tmp1610;
    s7_#tmp1617 := s7_#tmp1613;
    s7_#tmp1621 := s7_#tmp1617;
    s7_#tmp1627 := s7_#tmp1621;
    s7_#tmp1631 := s7_#tmp1627;
    s7_r#FIELD2 := htable_FIELD2[s7_#tmp1631];
    s7_v2 := s7_r#FIELD2;
    s7_#tmp1770 := to_unit(s7_v2);
    goto s7_hop_exit;
  s7_hop_exit:
  s8_block8:
    s8_#tmp1771 := s8_keyname + 7;
    s8_#tmp1773 := s8_#tmp1771;
    s8_#tmp1774 := s8_#tmp1773;
    s8_#tmp1775 := s8_#tmp1774;
    s8_#tmp1776 := s8_#tmp1775;
    s8_#tmp1777 := s8_#tmp1776;
    s8_#tmp1778 := s8_#tmp1777;
    s8_#tmp1779 := s8_#tmp1778;
    s8_#tmp1780 := s8_#tmp1779;
    s8_#tmp1781 := s8_#tmp1780;
    s8_#tmp1782 := s8_#tmp1781;
    s8_#tmp1783 := s8_#tmp1782;
    s8_#tmp1784 := s8_#tmp1783;
    s8_#tmp1785 := s8_#tmp1784;
    s8_#tmp1786 := s8_#tmp1785;
    s8_#tmp1787 := s8_#tmp1786;
    s8_#tmp1789 := s8_#tmp1787;
    s8_#tmp1790 := s8_#tmp1789;
    s8_#tmp1791 := s8_#tmp1790;
    s8_#tmp1792 := s8_#tmp1791;
    s8_#tmp1794 := s8_#tmp1792;
    s8_#tmp1808 := s8_#tmp1794;
    s8_#tmp1814 := s8_#tmp1808;
    s8_#tmp1815 := s8_#tmp1814;
    s8_#tmp1816 := s8_#tmp1815;
    s8_#tmp1821 := s8_#tmp1816;
    s8_#tmp1828 := s8_#tmp1821;
    s8_#tmp1832 := s8_#tmp1828;
    s8_#tmp1843 := s8_#tmp1832;
    s8_#tmp1862 := s8_#tmp1843;
    s8_#tmp1876 := s8_#tmp1862;
    s8_#tmp1884 := s8_#tmp1876;
    s8_r#FIELD2 := htable_FIELD2[s8_#tmp1884];
    s8_v2 := s8_r#FIELD2;
    s8_#tmp2023 := to_unit(s8_v2);
    goto s8_hop_exit;
  s8_hop_exit:
  s9_block9:
    s9_#tmp2024 := s9_keyname + 8;
    s9_#tmp2026 := s9_#tmp2024;
    s9_#tmp2027 := s9_#tmp2026;
    s9_#tmp2028 := s9_#tmp2027;
    s9_#tmp2029 := s9_#tmp2028;
    s9_#tmp2030 := s9_#tmp2029;
    s9_#tmp2031 := s9_#tmp2030;
    s9_#tmp2032 := s9_#tmp2031;
    s9_#tmp2033 := s9_#tmp2032;
    s9_#tmp2034 := s9_#tmp2033;
    s9_#tmp2035 := s9_#tmp2034;
    s9_#tmp2036 := s9_#tmp2035;
    s9_#tmp2037 := s9_#tmp2036;
    s9_#tmp2038 := s9_#tmp2037;
    s9_#tmp2039 := s9_#tmp2038;
    s9_#tmp2040 := s9_#tmp2039;
    s9_#tmp2041 := s9_#tmp2040;
    s9_#tmp2042 := s9_#tmp2041;
    s9_#tmp2043 := s9_#tmp2042;
    s9_#tmp2045 := s9_#tmp2043;
    s9_#tmp2046 := s9_#tmp2045;
    s9_#tmp2047 := s9_#tmp2046;
    s9_#tmp2050 := s9_#tmp2047;
    s9_#tmp2053 := s9_#tmp2050;
    s9_#tmp2054 := s9_#tmp2053;
    s9_#tmp2055 := s9_#tmp2054;
    s9_#tmp2057 := s9_#tmp2055;
    s9_#tmp2070 := s9_#tmp2057;
    s9_#tmp2076 := s9_#tmp2070;
    s9_#tmp2083 := s9_#tmp2076;
    s9_#tmp2087 := s9_#tmp2083;
    s9_#tmp2112 := s9_#tmp2087;
    s9_#tmp2137 := s9_#tmp2112;
    s9_r#FIELD2 := htable_FIELD2[s9_#tmp2137];
    s9_v2 := s9_r#FIELD2;
    s9_#tmp2276 := to_unit(s9_v2);
    goto s9_hop_exit;
  s9_hop_exit:
  s10_block10:
    s10_#tmp2277 := s10_keyname + 9;
    s10_#tmp2279 := s10_#tmp2277;
    s10_#tmp2280 := s10_#tmp2279;
    s10_#tmp2281 := s10_#tmp2280;
    s10_#tmp2282 := s10_#tmp2281;
    s10_#tmp2283 := s10_#tmp2282;
    s10_#tmp2284 := s10_#tmp2283;
    s10_#tmp2285 := s10_#tmp2284;
    s10_#tmp2286 := s10_#tmp2285;
    s10_#tmp2287 := s10_#tmp2286;
    s10_#tmp2288 := s10_#tmp2287;
    s10_#tmp2289 := s10_#tmp2288;
    s10_#tmp2290 := s10_#tmp2289;
    s10_#tmp2291 := s10_#tmp2290;
    s10_#tmp2292 := s10_#tmp2291;
    s10_#tmp2293 := s10_#tmp2292;
    s10_#tmp2294 := s10_#tmp2293;
    s10_#tmp2295 := s10_#tmp2294;
    s10_#tmp2296 := s10_#tmp2295;
    s10_#tmp2298 := s10_#tmp2296;
    s10_#tmp2300 := s10_#tmp2298;
    s10_#tmp2301 := s10_#tmp2300;
    s10_#tmp2302 := s10_#tmp2301;
    s10_#tmp2304 := s10_#tmp2302;
    s10_#tmp2306 := s10_#tmp2304;
    s10_#tmp2307 := s10_#tmp2306;
    s10_#tmp2308 := s10_#tmp2307;
    s10_#tmp2309 := s10_#tmp2308;
    s10_#tmp2310 := s10_#tmp2309;
    s10_#tmp2311 := s10_#tmp2310;
    s10_#tmp2312 := s10_#tmp2311;
    s10_#tmp2315 := s10_#tmp2312;
    s10_#tmp2317 := s10_#tmp2315;
    s10_#tmp2318 := s10_#tmp2317;
    s10_#tmp2321 := s10_#tmp2318;
    s10_#tmp2323 := s10_#tmp2321;
    s10_#tmp2390 := s10_#tmp2323;
    s10_r#FIELD2 := htable_FIELD2[s10_#tmp2390];
    s10_v2 := s10_r#FIELD2;
    s10_#tmp2529 := to_unit(s10_v2);
    goto s10_epilogue;
  s10_hop_exit:
  s1_epilogue:
  s2_epilogue:
