...
modifies CallForwarding_end_time, CallForwarding_numberx, SpecialFacility_data_a, SpecialFacility_data_b, SpecialFacility_error_cntrl, SpecialFacility_is_active, Subscriber_bit_1, Subscriber_bit_10, Subscriber_bit_2, Subscriber_bit_3, Subscriber_bit_4, Subscriber_bit_5, Subscriber_bit_6, Subscriber_bit_7, Subscriber_bit_8, Subscriber_bit_9, Subscriber_byte2_1, Subscriber_byte2_10, Subscriber_byte2_2, Subscriber_byte2_3, Subscriber_byte2_4, Subscriber_byte2_5, Subscriber_byte2_6, Subscriber_byte2_7, Subscriber_byte2_8, Subscriber_byte2_9, Subscriber_hex_1, Subscriber_hex_10, Subscriber_hex_2, Subscriber_hex_3, Subscriber_hex_4, Subscriber_hex_5, Subscriber_hex_6, Subscriber_hex_7, Subscriber_hex_8, Subscriber_hex_9, Subscriber_msc_location, Subscriber_sub_nbr, Subscriber_vlr_location;
{
  var s0_s_id : int;
  var s0_sf_type : int;
  var s0_start_time : int;
  var s0_end_time : int;
  var s0_numberx : String;
  var s1_s_id : int;
  var s1_sf_type : int;
  var s1_start_time : int;
  var s1_end_time : int;
  var s1_numberx : String;
  var s0_active : bool;
  var s1_active : bool;
  var CallForwarding_end_time_init : [int][int][int]int;
  ...
  var s0_end_time_init : int;
  var s0_numberx_init : String;
  var s1_s_id_init : int;
  var s1_sf_type_init : int;
  var s1_start_time_init : int;
  var s1_end_time_init : int;
  var s1_numberx_init : String;
  var s0_#tmp10 : Row (Table (Subscriber));
  var s0_sub : Row (Table (Subscriber));
  var s0_#tmp11 : unit;
  var s0_#tmp12 : Row (Table (SpecialFacility));
  var s0_sf : Row (Table (SpecialFacility));
  var s0_#tmp13 : unit;
  var s1_#tmp10 : Row (Table (Subscriber));
  var s1_sub : Row (Table (Subscriber));
  var s1_#tmp11 : unit;
  var s1_#tmp12 : Row (Table (SpecialFacility));
  var s1_sf : Row (Table (SpecialFacility));
  var s1_#tmp13 : unit;
  var CallForwarding_end_time_a_then_b : [int][int][int]int;
  var CallForwarding_numberx_a_then_b : [int][int][int]String;
  var CallForwarding_end_time_b_then_a : [int][int][int]int;
  var CallForwarding_numberx_b_then_a : [int][int][int]String;

  // Slice commutativity verification: hop 5 vs hop 5
  // --- Step 1: Havoc initial state ---
    havoc CallForwarding_end_time;
  ...
  // --- Step 2: Save initial state ---
    CallForwarding_end_time_init := CallForwarding_end_time;
    ...
    s0_end_time_init := s0_end_time;
    s0_numberx_init := s0_numberx;
    s1_s_id_init := s1_s_id;
    s1_sf_type_init := s1_sf_type;
    s1_start_time_init := s1_start_time;
    s1_end_time_init := s1_end_time;
    s1_numberx_init := s1_numberx;
  // --- Step 3: Execute special interleavings ---
  // Executing A then B:
    if (s0_active) {
    s0_block7__ab:
      s0_#tmp10 := construct_Row_Subscriber(Subscriber_s_id[s0_s_id], Subscriber_sub_nbr[s0_s_id], Subscriber_bit_1[s0_s_id], Subscriber_bit_2[s0_s_id], Subscriber_bit_3[s0_s_id], Subscriber_bit_4[s0_s_id], Subscriber_bit_5[s0_s_id], Subscriber_bit_6[s0_s_id], Subscriber_bit_7[s0_s_id], Subscriber_bit_8[s0_s_id], Subscriber_bit_9[s0_s_id], Subscriber_bit_10[s0_s_id], Subscriber_hex_1[s0_s_id], Subscriber_hex_2[s0_s_id], Subscriber_hex_3[s0_s_id], Subscriber_hex_4[s0_s_id], Subscriber_hex_5[s0_s_id], Subscriber_hex_6[s0_s_id], Subscriber_hex_7[s0_s_id], Subscriber_hex_8[s0_s_id], Subscriber_hex_9[s0_s_id], Subscriber_hex_10[s0_s_id], Subscriber_byte2_1[s0_s_id], Subscriber_byte2_2[s0_s_id], Subscriber_byte2_3[s0_s_id], Subscriber_byte2_4[s0_s_id], Subscriber_byte2_5[s0_s_id], Subscriber_byte2_6[s0_s_id], Subscriber_byte2_7[s0_s_id], Subscriber_byte2_8[s0_s_id], Subscriber_byte2_9[s0_s_id], Subscriber_byte2_10[s0_s_id], Subscriber_msc_location[s0_s_id], Subscriber_vlr_location[s0_s_id]);
      s0_sub := s0_#tmp10;
      s0_#tmp11 := to_unit(s0_sub);
      s0_#tmp12 := construct_Row_SpecialFacility(SpecialFacility_s_id[s0_s_id][s0_sf_type], SpecialFacility_sf_type[s0_s_id][s0_sf_type], SpecialFacility_is_active[s0_s_id][s0_sf_type], SpecialFacility_error_cntrl[s0_s_id][s0_sf_type], SpecialFacility_data_a[s0_s_id][s0_sf_type], SpecialFacility_data_b[s0_s_id][s0_sf_type]);
      s0_sf := s0_#tmp12;
      s0_#tmp13 := to_unit(s0_sf);
      CallForwarding_end_time := CallForwarding_end_time[s0_s_id := CallForwarding_end_time[s0_s_id][s0_sf_type := CallForwarding_end_time[s0_s_id][s0_sf_type][s0_start_time := s0_end_time]]];
      CallForwarding_numberx := CallForwarding_numberx[s0_s_id := CallForwarding_numberx[s0_s_id][s0_sf_type := CallForwarding_numberx[s0_s_id][s0_sf_type][s0_start_time := s0_numberx]]];
      s0_active := false;
    ...
    if (s1_active) {
    s1_block7__ab:
      s1_#tmp10 := construct_Row_Subscriber(Subscriber_s_id[s1_s_id], Subscriber_sub_nbr[s1_s_id], Subscriber_bit_1[s1_s_id], Subscriber_bit_2[s1_s_id], Subscriber_bit_3[s1_s_id], Subscriber_bit_4[s1_s_id], Subscriber_bit_5[s1_s_id], Subscriber_bit_6[s1_s_id], Subscriber_bit_7[s1_s_id], Subscriber_bit_8[s1_s_id], Subscriber_bit_9[s1_s_id], Subscriber_bit_10[s1_s_id], Subscriber_hex_1[s1_s_id], Subscriber_hex_2[s1_s_id], Subscriber_hex_3[s1_s_id], Subscriber_hex_4[s1_s_id], Subscriber_hex_5[s1_s_id], Subscriber_hex_6[s1_s_id], Subscriber_hex_7[s1_s_id], Subscriber_hex_8[s1_s_id], Subscriber_hex_9[s1_s_id], Subscriber_hex_10[s1_s_id], Subscriber_byte2_1[s1_s_id], Subscriber_byte2_2[s1_s_id], Subscriber_byte2_3[s1_s_id], Subscriber_byte2_4[s1_s_id], Subscriber_byte2_5[s1_s_id], Subscriber_byte2_6[s1_s_id], Subscriber_byte2_7[s1_s_id], Subscriber_byte2_8[s1_s_id], Subscriber_byte2_9[s1_s_id], Subscriber_byte2_10[s1_s_id], Subscriber_msc_location[s1_s_id], Subscriber_vlr_location[s1_s_id]);
      s1_sub := s1_#tmp10;
      s1_#tmp11 := to_unit(s1_sub);
      s1_#tmp12 := construct_Row_SpecialFacility(SpecialFacility_s_id[s1_s_id][s1_sf_type], SpecialFacility_sf_type[s1_s_id][s1_sf_type], SpecialFacility_is_active[s1_s_id][s1_sf_type], SpecialFacility_error_cntrl[s1_s_id][s1_sf_type], SpecialFacility_data_a[s1_s_id][s1_sf_type], SpecialFacility_data_b[s1_s_id][s1_sf_type]);
      s1_sf := s1_#tmp12;
      s1_#tmp13 := to_unit(s1_sf);
      CallForwarding_end_time := CallForwarding_end_time[s1_s_id := CallForwarding_end_time[s1_s_id][s1_sf_type := CallForwarding_end_time[s1_s_id][s1_sf_type][s1_start_time := s1_end_time]]];
      CallForwarding_numberx := CallForwarding_numberx[s1_s_id := CallForwarding_numberx[s1_s_id][s1_sf_type := CallForwarding_numberx[s1_s_id][s1_sf_type][s1_start_time := s1_numberx]]];
      s1_active := false;
      goto s1_hop_exit__ab;
    s1_hop_exit__ab:
    }
  // Snapshotting final state for a_then_b
    CallForwarding_end_time_a_then_b := CallForwarding_end_time;
    CallForwarding_numberx_a_then_b := CallForwarding_numberx;
  // Restoring initial state:
    CallForwarding_end_time := CallForwarding_end_time_init;
    ...
    s0_end_time := s0_end_time_init;
    s0_numberx := s0_numberx_init;
    s1_s_id := s1_s_id_init;
    s1_sf_type := s1_sf_type_init;
    s1_start_time := s1_start_time_init;
    s1_end_time := s1_end_time_init;
    s1_numberx := s1_numberx_init;
    s0_active := true;
    s1_active := true;
  // Executing B then A:
    if (s1_active) {
  ...
  // Snapshotting final state for b_then_a
    CallForwarding_end_time_b_then_a := CallForwarding_end_time;
    CallForwarding_numberx_b_then_a := CallForwarding_numberx;
  // --- Step 4: Verify A→B ≡ B→A (Special interleavings equivalence) ---
  // Verifying A->B === B->A equivalence:
    assert {:msg "(SpecialInterleavingNonEquivalence (node_1 (function_id . 20) (instance . 0) (hop_id . 5)) (node_2 (function_id . 20) (instance . 1) (hop_id . 5)))"} ((CallForwarding_end_time_a_then_b == CallForwarding_end_time_b_then_a) && (CallForwarding_numberx_a_then_b == CallForwarding_numberx_b_then_a));
}
