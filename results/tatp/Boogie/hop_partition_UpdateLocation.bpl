...
{
  var s6_sub#bit_1 : int;
  var s6_s_id : int;
  var s6_sub#bit_10 : int;
  var s6_sub#bit_2 : int;
  var s6_sub#bit_3 : int;
  var s6_sub#bit_4 : int;
  var s6_sub#bit_5 : int;
  var s6_sub#bit_6 : int;
  var s6_sub#bit_7 : int;
  var s6_sub#bit_8 : int;
  var s6_sub#bit_9 : int;
  var s6_sub#byte2_1 : int;
  var s6_sub#byte2_10 : int;
  var s6_sub#byte2_2 : int;
  var s6_sub#byte2_3 : int;
  var s6_sub#byte2_4 : int;
  var s6_sub#byte2_5 : int;
  var s6_sub#byte2_6 : int;
  var s6_sub#byte2_7 : int;
  var s6_sub#byte2_8 : int;
  var s6_sub#byte2_9 : int;
  var s6_sub#hex_1 : int;
  var s6_sub#hex_10 : int;
  var s6_sub#hex_2 : int;
  var s6_sub#hex_3 : int;
  var s6_sub#hex_4 : int;
  var s6_sub#hex_5 : int;
  var s6_sub#hex_6 : int;
  var s6_sub#hex_7 : int;
  var s6_sub#hex_8 : int;
  var s6_sub#hex_9 : int;
  var s6_sub#msc_location : int;
  var s6_sub#s_id : int;
  var s6_sub#sub_nbr : String;
  var s6_sub#vlr_location : int;
  var s6_vlr_location : int;

  // Hop partition verification for function 'UpdateLocation'
  s6_block8:
