...
modifies SpecialFacility_data_a, SpecialFacility_data_b, SpecialFacility_error_cntrl, SpecialFacility_is_active, SpecialFacility_s_id, SpecialFacility_sf_type, Subscriber_bit_1, Subscriber_bit_10, Subscriber_bit_2, Subscriber_bit_3, Subscriber_bit_4, Subscriber_bit_5, Subscriber_bit_6, Subscriber_bit_7, Subscriber_bit_8, Subscriber_bit_9, Subscriber_byte2_1, Subscriber_byte2_10, Subscriber_byte2_2, Subscriber_byte2_3, Subscriber_byte2_4, Subscriber_byte2_5, Subscriber_byte2_6, Subscriber_byte2_7, Subscriber_byte2_8, Subscriber_byte2_9, Subscriber_hex_1, Subscriber_hex_10, Subscriber_hex_2, Subscriber_hex_3, Subscriber_hex_4, Subscriber_hex_5, Subscriber_hex_6, Subscriber_hex_7, Subscriber_hex_8, Subscriber_hex_9, Subscriber_msc_location, Subscriber_s_id, Subscriber_sub_nbr, Subscriber_vlr_location;
{
  ...
  // Partition check hop 7 func 'subPartition' tables 'Subscriber'=>'Subscriber' keys [k0=s_id] first_span Span { start: 3527, end: 3549, filename: "/Users/farzad/Desktop/Research/benchbase-transact/tatp.transact" } current_span Span { start: 3527, end: 3549, filename: "/Users/farzad/Desktop/Research/benchbase-transact/tatp.transact" }
    assert {:msg "(PartitionFunctionInconsistency (partition_function_id . 15) (function_id . 22) (hop_id . 7) (table_id . 0) (span ((start . 3527) (end . 3549) (filename . \"/Users/farzad/Desktop/Research/benchbase-transact/tatp.transact\"))))"} (s7_s_id == s7_s_id);
  ...
  // Partition check hop 7 func 'subPartition' tables 'Subscriber'=>'Subscriber' keys [k0=s_id] first_span Span { start: 3527, end: 3549, filename: "/Users/farzad/Desktop/Research/benchbase-transact/tatp.transact" } current_span Span { start: 3586, end: 3614, filename: "/Users/farzad/Desktop/Research/benchbase-transact/tatp.transact" }
    assert {:msg "(PartitionFunctionInconsistency (partition_function_id . 15) (function_id . 22) (hop_id . 7) (table_id . 0) (span ((start . 3586) (end . 3614) (filename . \"/Users/farzad/Desktop/Research/benchbase-transact/tatp.transact\"))))"} (s7_s_id == s7_s_id);
  ...
  // Partition check hop 7 func 'subPartition' tables 'Subscriber'=>'SpecialFacility' keys [k0=s_id] first_span Span { start: 3527, end: 3549, filename: "/Users/farzad/Desktop/Research/benchbase-transact/tatp.transact" } current_span Span { start: 3664, end: 3709, filename: "/Users/farzad/Desktop/Research/benchbase-transact/tatp.transact" }
    assert {:msg "(PartitionFunctionInconsistency (partition_function_id . 15) (function_id . 22) (hop_id . 7) (table_id . 2) (span ((start . 3664) (end . 3709) (filename . \"/Users/farzad/Desktop/Research/benchbase-transact/tatp.transact\"))))"} (s7_s_id == s7_s_id);
  ...
  // Partition check hop 7 func 'subPartition' tables 'Subscriber'=>'SpecialFacility' keys [k0=s_id] first_span Span { start: 3527, end: 3549, filename: "/Users/farzad/Desktop/Research/benchbase-transact/tatp.transact" } current_span Span { start: 3747, end: 3797, filename: "/Users/farzad/Desktop/Research/benchbase-transact/tatp.transact" }
    assert {:msg "(PartitionFunctionInconsistency (partition_function_id . 15) (function_id . 22) (hop_id . 7) (table_id . 2) (span ((start . 3747) (end . 3797) (filename . \"/Users/farzad/Desktop/Research/benchbase-transact/tatp.transact\"))))"} (s7_s_id == s7_s_id);
