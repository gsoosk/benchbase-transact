...
procedure Check_SliceCommut_Hop8_vs_Hop8()
modifies page_page_id, page_page_is_new, page_page_is_redirect, page_page_latest, page_page_len, page_page_namespace, page_page_title, page_page_touched, recentchanges_rc_comment, recentchanges_rc_cur_id, recentchanges_rc_ip, recentchanges_rc_last_oldid, recentchanges_rc_namespace, recentchanges_rc_new_len, recentchanges_rc_old_len, recentchanges_rc_this_oldid, recentchanges_rc_timestamp, recentchanges_rc_title, recentchanges_rc_user, recentchanges_rc_user_text, revision_rev_comment, revision_rev_len, revision_rev_parent_id, revision_rev_text_id, revision_rev_timestamp, revision_rev_user, revision_rev_user_text, text_old_flags, text_old_page, text_old_text;
{
  var s0_nextTextId : int;
  var s0_nextRevId : int;
  var s0_rcId : int;
  var s0_pageId : int;
  var s0_pageTitle : String;
  var s0_pageText : String;
  var s0_pageNamespace : int;
  var s0_pageLen : int;
  var s0_userId : int;
  var s0_userText : String;
  var s0_revisionId : int;
  var s0_revComment : String;
  var s0_otherUserId : int;
  var s1_nextTextId : int;
  var s1_nextRevId : int;
  var s1_rcId : int;
  var s1_pageId : int;
  var s1_pageTitle : String;
  var s1_pageText : String;
  var s1_pageNamespace : int;
  var s1_pageLen : int;
  var s1_userId : int;
  var s1_userText : String;
  var s1_revisionId : int;
  var s1_revComment : String;
  var s1_otherUserId : int;
  var s0_active : bool;
  var s1_active : bool;
  var page_page_id_init : [int]int;
  var page_page_is_new_init : [int]int;
  var page_page_is_redirect_init : [int]int;
  var page_page_latest_init : [int]int;
  var page_page_len_init : [int]int;
  var page_page_namespace_init : [int]int;
  var page_page_title_init : [int]String;
  var page_page_touched_init : [int]int;
  var recentchanges_rc_comment_init : [int]String;
  var recentchanges_rc_cur_id_init : [int]int;
  var recentchanges_rc_ip_init : [int]String;
  var recentchanges_rc_last_oldid_init : [int]int;
  var recentchanges_rc_namespace_init : [int]int;
  var recentchanges_rc_new_len_init : [int]int;
  var recentchanges_rc_old_len_init : [int]int;
  var recentchanges_rc_this_oldid_init : [int]int;
  var recentchanges_rc_timestamp_init : [int]int;
  var recentchanges_rc_title_init : [int]String;
  var recentchanges_rc_user_init : [int]int;
  var recentchanges_rc_user_text_init : [int]String;
  var revision_rev_comment_init : [int][int]String;
  var revision_rev_len_init : [int][int]int;
  var revision_rev_parent_id_init : [int][int]int;
  var revision_rev_text_id_init : [int][int]int;
  var revision_rev_timestamp_init : [int][int]int;
  var revision_rev_user_init : [int][int]int;
  var revision_rev_user_text_init : [int][int]String;
  var text_old_flags_init : [int]String;
  var text_old_page_init : [int]int;
  var text_old_text_init : [int]String;
  var s0_nextTextId_init : int;
  var s0_nextRevId_init : int;
  var s0_rcId_init : int;
  var s0_pageId_init : int;
  var s0_pageTitle_init : String;
  var s0_pageText_init : String;
  var s0_pageNamespace_init : int;
  var s0_pageLen_init : int;
  var s0_userId_init : int;
  var s0_userText_init : String;
  var s0_revisionId_init : int;
  var s0_revComment_init : String;
  var s0_otherUserId_init : int;
  var s1_nextTextId_init : int;
  var s1_nextRevId_init : int;
  var s1_rcId_init : int;
  var s1_pageId_init : int;
  var s1_pageTitle_init : String;
  var s1_pageText_init : String;
  var s1_pageNamespace_init : int;
  var s1_pageLen_init : int;
  var s1_userId_init : int;
  var s1_userText_init : String;
  var s1_revisionId_init : int;
  var s1_revComment_init : String;
  var s1_otherUserId_init : int;
  var s0_p#page_id : int;
  var s0_p#page_is_new : int;
  var s0_p#page_is_redirect : int;
  var s0_p#page_namespace : int;
  var s0_p#page_title : String;
  var s0_p#page_latest : int;
  var s0_p#page_len : int;
  var s1_p#page_id : int;
  var s1_p#page_is_new : int;
  var s1_p#page_is_redirect : int;
  var s1_p#page_namespace : int;
  var s1_p#page_title : String;
  var s1_p#page_latest : int;
  var s1_p#page_len : int;
  var page_page_id_a_then_b : [int]int;
  var page_page_is_new_a_then_b : [int]int;
  var page_page_is_redirect_a_then_b : [int]int;
  var page_page_latest_a_then_b : [int]int;
  var page_page_len_a_then_b : [int]int;
  var page_page_namespace_a_then_b : [int]int;
  var page_page_title_a_then_b : [int]String;
  var page_page_touched_a_then_b : [int]int;
  var recentchanges_rc_comment_a_then_b : [int]String;
  var recentchanges_rc_cur_id_a_then_b : [int]int;
  var recentchanges_rc_ip_a_then_b : [int]String;
  var recentchanges_rc_last_oldid_a_then_b : [int]int;
  var recentchanges_rc_namespace_a_then_b : [int]int;
  var recentchanges_rc_new_len_a_then_b : [int]int;
  var recentchanges_rc_old_len_a_then_b : [int]int;
  var recentchanges_rc_this_oldid_a_then_b : [int]int;
  var recentchanges_rc_timestamp_a_then_b : [int]int;
  var recentchanges_rc_title_a_then_b : [int]String;
  var recentchanges_rc_user_a_then_b : [int]int;
  var recentchanges_rc_user_text_a_then_b : [int]String;
  var revision_rev_comment_a_then_b : [int][int]String;
  var revision_rev_len_a_then_b : [int][int]int;
  var revision_rev_parent_id_a_then_b : [int][int]int;
  var revision_rev_text_id_a_then_b : [int][int]int;
  var revision_rev_timestamp_a_then_b : [int][int]int;
  var revision_rev_user_a_then_b : [int][int]int;
  var revision_rev_user_text_a_then_b : [int][int]String;
  var text_old_flags_a_then_b : [int]String;
  var text_old_page_a_then_b : [int]int;
  var text_old_text_a_then_b : [int]String;
  ...
  var s0_otherUserId_a_then_b : int;
  ...
  var s1_otherUserId_a_then_b : int;
  var page_page_id_b_then_a : [int]int;
  var page_page_is_new_b_then_a : [int]int;
  var page_page_is_redirect_b_then_a : [int]int;
  var page_page_latest_b_then_a : [int]int;
  var page_page_len_b_then_a : [int]int;
  var page_page_namespace_b_then_a : [int]int;
  var page_page_title_b_then_a : [int]String;
  var page_page_touched_b_then_a : [int]int;
  var recentchanges_rc_comment_b_then_a : [int]String;
  var recentchanges_rc_cur_id_b_then_a : [int]int;
  var recentchanges_rc_ip_b_then_a : [int]String;
  var recentchanges_rc_last_oldid_b_then_a : [int]int;
  var recentchanges_rc_namespace_b_then_a : [int]int;
  var recentchanges_rc_new_len_b_then_a : [int]int;
  var recentchanges_rc_old_len_b_then_a : [int]int;
  var recentchanges_rc_this_oldid_b_then_a : [int]int;
  var recentchanges_rc_timestamp_b_then_a : [int]int;
  var recentchanges_rc_title_b_then_a : [int]String;
  var recentchanges_rc_user_b_then_a : [int]int;
  var recentchanges_rc_user_text_b_then_a : [int]String;
  var revision_rev_comment_b_then_a : [int][int]String;
  var revision_rev_len_b_then_a : [int][int]int;
  var revision_rev_parent_id_b_then_a : [int][int]int;
  var revision_rev_text_id_b_then_a : [int][int]int;
  var revision_rev_timestamp_b_then_a : [int][int]int;
  var revision_rev_user_b_then_a : [int][int]int;
  var revision_rev_user_text_b_then_a : [int][int]String;
  var text_old_flags_b_then_a : [int]String;
  var text_old_page_b_then_a : [int]int;
  var text_old_text_b_then_a : [int]String;
  ...
  var s0_otherUserId_b_then_a : int;
  ...
  var s1_otherUserId_b_then_a : int;

  // Slice commutativity verification: hop 8 vs hop 8
  // --- Step 1: Havoc initial state ---
    havoc page_page_id;
    havoc page_page_is_new;
    havoc page_page_is_redirect;
    havoc page_page_latest;
    havoc page_page_len;
    havoc page_page_namespace;
    havoc page_page_title;
    havoc page_page_touched;
    havoc recentchanges_rc_comment;
    havoc recentchanges_rc_cur_id;
    havoc recentchanges_rc_ip;
    havoc recentchanges_rc_last_oldid;
    havoc recentchanges_rc_namespace;
    havoc recentchanges_rc_new_len;
    havoc recentchanges_rc_old_len;
    havoc recentchanges_rc_this_oldid;
    havoc recentchanges_rc_timestamp;
    havoc recentchanges_rc_title;
    havoc recentchanges_rc_user;
    havoc recentchanges_rc_user_text;
    havoc revision_rev_comment;
    havoc revision_rev_len;
    havoc revision_rev_parent_id;
    havoc revision_rev_text_id;
    havoc revision_rev_timestamp;
    havoc revision_rev_user;
    havoc revision_rev_user_text;
    havoc text_old_flags;
    havoc text_old_page;
    havoc text_old_text;
    havoc s0_nextTextId;
    havoc s0_nextRevId;
  ...
  // --- Step 2: Save initial state ---
    page_page_id_init := page_page_id;
    page_page_is_new_init := page_page_is_new;
    page_page_is_redirect_init := page_page_is_redirect;
    page_page_latest_init := page_page_latest;
    page_page_len_init := page_page_len;
    page_page_namespace_init := page_page_namespace;
    page_page_title_init := page_page_title;
    page_page_touched_init := page_page_touched;
    recentchanges_rc_comment_init := recentchanges_rc_comment;
    recentchanges_rc_cur_id_init := recentchanges_rc_cur_id;
    recentchanges_rc_ip_init := recentchanges_rc_ip;
    recentchanges_rc_last_oldid_init := recentchanges_rc_last_oldid;
    recentchanges_rc_namespace_init := recentchanges_rc_namespace;
    recentchanges_rc_new_len_init := recentchanges_rc_new_len;
    recentchanges_rc_old_len_init := recentchanges_rc_old_len;
    recentchanges_rc_this_oldid_init := recentchanges_rc_this_oldid;
    recentchanges_rc_timestamp_init := recentchanges_rc_timestamp;
    recentchanges_rc_title_init := recentchanges_rc_title;
    recentchanges_rc_user_init := recentchanges_rc_user;
    recentchanges_rc_user_text_init := recentchanges_rc_user_text;
    revision_rev_comment_init := revision_rev_comment;
    revision_rev_len_init := revision_rev_len;
    revision_rev_parent_id_init := revision_rev_parent_id;
    revision_rev_text_id_init := revision_rev_text_id;
    revision_rev_timestamp_init := revision_rev_timestamp;
    revision_rev_user_init := revision_rev_user;
    revision_rev_user_text_init := revision_rev_user_text;
    text_old_flags_init := text_old_flags;
    text_old_page_init := text_old_page;
    text_old_text_init := text_old_text;
    s0_nextTextId_init := s0_nextTextId;
    s0_nextRevId_init := s0_nextRevId;
    s0_rcId_init := s0_rcId;
    s0_pageId_init := s0_pageId;
    s0_pageTitle_init := s0_pageTitle;
    s0_pageText_init := s0_pageText;
    s0_pageNamespace_init := s0_pageNamespace;
    s0_pageLen_init := s0_pageLen;
    s0_userId_init := s0_userId;
    s0_userText_init := s0_userText;
    s0_revisionId_init := s0_revisionId;
    s0_revComment_init := s0_revComment;
    s0_otherUserId_init := s0_otherUserId;
    s1_nextTextId_init := s1_nextTextId;
    s1_nextRevId_init := s1_nextRevId;
    s1_rcId_init := s1_rcId;
    s1_pageId_init := s1_pageId;
    s1_pageTitle_init := s1_pageTitle;
    s1_pageText_init := s1_pageText;
    s1_pageNamespace_init := s1_pageNamespace;
    s1_pageLen_init := s1_pageLen;
    s1_userId_init := s1_userId;
    s1_userText_init := s1_userText;
    s1_revisionId_init := s1_revisionId;
    s1_revComment_init := s1_revComment;
    s1_otherUserId_init := s1_otherUserId;
  // --- Step 3: Execute special interleavings ---
  // Executing A then B:
    if (s0_active) {
    s0_block12__ab:
      text_old_page := text_old_page[s0_nextTextId := s0_pageId];
      text_old_text := text_old_text[s0_nextTextId := s0_pageText];
      text_old_flags := text_old_flags[s0_nextTextId := L_utf$u002D8];
      revision_rev_text_id := revision_rev_text_id[s0_pageId := revision_rev_text_id[s0_pageId][s0_nextRevId := s0_nextTextId]];
      revision_rev_comment := revision_rev_comment[s0_pageId := revision_rev_comment[s0_pageId][s0_nextRevId := s0_revComment]];
      revision_rev_user := revision_rev_user[s0_pageId := revision_rev_user[s0_pageId][s0_nextRevId := s0_userId]];
      revision_rev_user_text := revision_rev_user_text[s0_pageId := revision_rev_user_text[s0_pageId][s0_nextRevId := s0_userText]];
      revision_rev_timestamp := revision_rev_timestamp[s0_pageId := revision_rev_timestamp[s0_pageId][s0_nextRevId := 1]];
      revision_rev_len := revision_rev_len[s0_pageId := revision_rev_len[s0_pageId][s0_nextRevId := s0_pageLen]];
      revision_rev_parent_id := revision_rev_parent_id[s0_pageId := revision_rev_parent_id[s0_pageId][s0_nextRevId := s0_revisionId]];
      s0_p#page_id := page_page_id[s0_pageId];
      s0_p#page_is_new := page_page_is_new[s0_pageId];
      s0_p#page_is_redirect := page_page_is_redirect[s0_pageId];
      s0_p#page_namespace := page_page_namespace[s0_pageId];
      s0_p#page_title := page_page_title[s0_pageId];
      s0_p#page_latest := s0_nextRevId;
      s0_p#page_len := s0_pageLen;
      page_page_id := page_page_id[s0_pageId := s0_p#page_id];
      page_page_is_new := page_page_is_new[s0_pageId := s0_p#page_is_new];
      page_page_is_redirect := page_page_is_redirect[s0_pageId := s0_p#page_is_redirect];
      page_page_latest := page_page_latest[s0_pageId := s0_p#page_latest];
      page_page_len := page_page_len[s0_pageId := s0_p#page_len];
      page_page_namespace := page_page_namespace[s0_pageId := s0_p#page_namespace];
      page_page_title := page_page_title[s0_pageId := s0_p#page_title];
      page_page_touched := page_page_touched[s0_pageId := 1];
      recentchanges_rc_timestamp := recentchanges_rc_timestamp[s0_rcId := 1];
      recentchanges_rc_namespace := recentchanges_rc_namespace[s0_rcId := s0_pageNamespace];
      recentchanges_rc_title := recentchanges_rc_title[s0_rcId := s0_pageTitle];
      recentchanges_rc_cur_id := recentchanges_rc_cur_id[s0_rcId := s0_pageId];
      recentchanges_rc_user := recentchanges_rc_user[s0_rcId := s0_userId];
      recentchanges_rc_user_text := recentchanges_rc_user_text[s0_rcId := s0_userText];
      recentchanges_rc_comment := recentchanges_rc_comment[s0_rcId := s0_revComment];
      recentchanges_rc_this_oldid := recentchanges_rc_this_oldid[s0_rcId := s0_nextTextId];
      recentchanges_rc_last_oldid := recentchanges_rc_last_oldid[s0_rcId := s0_revisionId];
      recentchanges_rc_ip := recentchanges_rc_ip[s0_rcId := empty];
      recentchanges_rc_old_len := recentchanges_rc_old_len[s0_rcId := 0];
      recentchanges_rc_new_len := recentchanges_rc_new_len[s0_rcId := s0_p#page_len];
      goto s0_hop_exit__ab;
    s0_hop_exit__ab:
    }
    if (s1_active) {
    s1_block12__ab:
      text_old_page := text_old_page[s1_nextTextId := s1_pageId];
      text_old_text := text_old_text[s1_nextTextId := s1_pageText];
      text_old_flags := text_old_flags[s1_nextTextId := L_utf$u002D8];
      revision_rev_text_id := revision_rev_text_id[s1_pageId := revision_rev_text_id[s1_pageId][s1_nextRevId := s1_nextTextId]];
      revision_rev_comment := revision_rev_comment[s1_pageId := revision_rev_comment[s1_pageId][s1_nextRevId := s1_revComment]];
      revision_rev_user := revision_rev_user[s1_pageId := revision_rev_user[s1_pageId][s1_nextRevId := s1_userId]];
      revision_rev_user_text := revision_rev_user_text[s1_pageId := revision_rev_user_text[s1_pageId][s1_nextRevId := s1_userText]];
      revision_rev_timestamp := revision_rev_timestamp[s1_pageId := revision_rev_timestamp[s1_pageId][s1_nextRevId := 1]];
      revision_rev_len := revision_rev_len[s1_pageId := revision_rev_len[s1_pageId][s1_nextRevId := s1_pageLen]];
      revision_rev_parent_id := revision_rev_parent_id[s1_pageId := revision_rev_parent_id[s1_pageId][s1_nextRevId := s1_revisionId]];
      s1_p#page_id := page_page_id[s1_pageId];
      s1_p#page_is_new := page_page_is_new[s1_pageId];
      s1_p#page_is_redirect := page_page_is_redirect[s1_pageId];
      s1_p#page_namespace := page_page_namespace[s1_pageId];
      s1_p#page_title := page_page_title[s1_pageId];
      s1_p#page_latest := s1_nextRevId;
      s1_p#page_len := s1_pageLen;
      page_page_id := page_page_id[s1_pageId := s1_p#page_id];
      page_page_is_new := page_page_is_new[s1_pageId := s1_p#page_is_new];
      page_page_is_redirect := page_page_is_redirect[s1_pageId := s1_p#page_is_redirect];
      page_page_latest := page_page_latest[s1_pageId := s1_p#page_latest];
      page_page_len := page_page_len[s1_pageId := s1_p#page_len];
      page_page_namespace := page_page_namespace[s1_pageId := s1_p#page_namespace];
      page_page_title := page_page_title[s1_pageId := s1_p#page_title];
      page_page_touched := page_page_touched[s1_pageId := 1];
      recentchanges_rc_timestamp := recentchanges_rc_timestamp[s1_rcId := 1];
      recentchanges_rc_namespace := recentchanges_rc_namespace[s1_rcId := s1_pageNamespace];
      recentchanges_rc_title := recentchanges_rc_title[s1_rcId := s1_pageTitle];
      recentchanges_rc_cur_id := recentchanges_rc_cur_id[s1_rcId := s1_pageId];
      recentchanges_rc_user := recentchanges_rc_user[s1_rcId := s1_userId];
      recentchanges_rc_user_text := recentchanges_rc_user_text[s1_rcId := s1_userText];
      recentchanges_rc_comment := recentchanges_rc_comment[s1_rcId := s1_revComment];
      recentchanges_rc_this_oldid := recentchanges_rc_this_oldid[s1_rcId := s1_nextTextId];
      recentchanges_rc_last_oldid := recentchanges_rc_last_oldid[s1_rcId := s1_revisionId];
      recentchanges_rc_ip := recentchanges_rc_ip[s1_rcId := empty];
      recentchanges_rc_old_len := recentchanges_rc_old_len[s1_rcId := 0];
      recentchanges_rc_new_len := recentchanges_rc_new_len[s1_rcId := s1_p#page_len];
      goto s1_hop_exit__ab;
    s1_hop_exit__ab:
    }
  // Snapshotting final state for a_then_b
    page_page_id_a_then_b := page_page_id;
    page_page_is_new_a_then_b := page_page_is_new;
    page_page_is_redirect_a_then_b := page_page_is_redirect;
    page_page_latest_a_then_b := page_page_latest;
    page_page_len_a_then_b := page_page_len;
    page_page_namespace_a_then_b := page_page_namespace;
    page_page_title_a_then_b := page_page_title;
    page_page_touched_a_then_b := page_page_touched;
    recentchanges_rc_comment_a_then_b := recentchanges_rc_comment;
    recentchanges_rc_cur_id_a_then_b := recentchanges_rc_cur_id;
    recentchanges_rc_ip_a_then_b := recentchanges_rc_ip;
    recentchanges_rc_last_oldid_a_then_b := recentchanges_rc_last_oldid;
    recentchanges_rc_namespace_a_then_b := recentchanges_rc_namespace;
    recentchanges_rc_new_len_a_then_b := recentchanges_rc_new_len;
    recentchanges_rc_old_len_a_then_b := recentchanges_rc_old_len;
    recentchanges_rc_this_oldid_a_then_b := recentchanges_rc_this_oldid;
    recentchanges_rc_timestamp_a_then_b := recentchanges_rc_timestamp;
    recentchanges_rc_title_a_then_b := recentchanges_rc_title;
    recentchanges_rc_user_a_then_b := recentchanges_rc_user;
    recentchanges_rc_user_text_a_then_b := recentchanges_rc_user_text;
    revision_rev_comment_a_then_b := revision_rev_comment;
    revision_rev_len_a_then_b := revision_rev_len;
    revision_rev_parent_id_a_then_b := revision_rev_parent_id;
    revision_rev_text_id_a_then_b := revision_rev_text_id;
    revision_rev_timestamp_a_then_b := revision_rev_timestamp;
    revision_rev_user_a_then_b := revision_rev_user;
    revision_rev_user_text_a_then_b := revision_rev_user_text;
    text_old_flags_a_then_b := text_old_flags;
    text_old_page_a_then_b := text_old_page;
    text_old_text_a_then_b := text_old_text;
    ...
    s0_otherUserId_a_then_b := s0_otherUserId;
    ...
    s1_otherUserId_a_then_b := s1_otherUserId;
  // Restoring initial state:
    page_page_id := page_page_id_init;
    page_page_is_new := page_page_is_new_init;
    page_page_is_redirect := page_page_is_redirect_init;
    page_page_latest := page_page_latest_init;
    page_page_len := page_page_len_init;
    page_page_namespace := page_page_namespace_init;
    page_page_title := page_page_title_init;
    page_page_touched := page_page_touched_init;
    recentchanges_rc_comment := recentchanges_rc_comment_init;
    recentchanges_rc_cur_id := recentchanges_rc_cur_id_init;
    recentchanges_rc_ip := recentchanges_rc_ip_init;
    recentchanges_rc_last_oldid := recentchanges_rc_last_oldid_init;
    recentchanges_rc_namespace := recentchanges_rc_namespace_init;
    recentchanges_rc_new_len := recentchanges_rc_new_len_init;
    recentchanges_rc_old_len := recentchanges_rc_old_len_init;
    recentchanges_rc_this_oldid := recentchanges_rc_this_oldid_init;
    recentchanges_rc_timestamp := recentchanges_rc_timestamp_init;
    recentchanges_rc_title := recentchanges_rc_title_init;
    recentchanges_rc_user := recentchanges_rc_user_init;
    recentchanges_rc_user_text := recentchanges_rc_user_text_init;
    revision_rev_comment := revision_rev_comment_init;
    revision_rev_len := revision_rev_len_init;
    revision_rev_parent_id := revision_rev_parent_id_init;
    revision_rev_text_id := revision_rev_text_id_init;
    revision_rev_timestamp := revision_rev_timestamp_init;
    revision_rev_user := revision_rev_user_init;
    revision_rev_user_text := revision_rev_user_text_init;
    text_old_flags := text_old_flags_init;
    text_old_page := text_old_page_init;
    text_old_text := text_old_text_init;
    s0_nextTextId := s0_nextTextId_init;
    s0_nextRevId := s0_nextRevId_init;
    s0_rcId := s0_rcId_init;
    s0_pageId := s0_pageId_init;
    s0_pageTitle := s0_pageTitle_init;
    s0_pageText := s0_pageText_init;
    s0_pageNamespace := s0_pageNamespace_init;
    s0_pageLen := s0_pageLen_init;
    s0_userId := s0_userId_init;
    s0_userText := s0_userText_init;
    s0_revisionId := s0_revisionId_init;
    s0_revComment := s0_revComment_init;
    s0_otherUserId := s0_otherUserId_init;
    s1_nextTextId := s1_nextTextId_init;
    s1_nextRevId := s1_nextRevId_init;
    s1_rcId := s1_rcId_init;
    s1_pageId := s1_pageId_init;
    s1_pageTitle := s1_pageTitle_init;
    s1_pageText := s1_pageText_init;
    s1_pageNamespace := s1_pageNamespace_init;
    s1_pageLen := s1_pageLen_init;
    s1_userId := s1_userId_init;
    s1_userText := s1_userText_init;
    s1_revisionId := s1_revisionId_init;
    s1_revComment := s1_revComment_init;
  ...
  // Snapshotting final state for b_then_a
    page_page_id_b_then_a := page_page_id;
    page_page_is_new_b_then_a := page_page_is_new;
    page_page_is_redirect_b_then_a := page_page_is_redirect;
    page_page_latest_b_then_a := page_page_latest;
    page_page_len_b_then_a := page_page_len;
    page_page_namespace_b_then_a := page_page_namespace;
    page_page_title_b_then_a := page_page_title;
    page_page_touched_b_then_a := page_page_touched;
    recentchanges_rc_comment_b_then_a := recentchanges_rc_comment;
    recentchanges_rc_cur_id_b_then_a := recentchanges_rc_cur_id;
    recentchanges_rc_ip_b_then_a := recentchanges_rc_ip;
    recentchanges_rc_last_oldid_b_then_a := recentchanges_rc_last_oldid;
    recentchanges_rc_namespace_b_then_a := recentchanges_rc_namespace;
    recentchanges_rc_new_len_b_then_a := recentchanges_rc_new_len;
    recentchanges_rc_old_len_b_then_a := recentchanges_rc_old_len;
    recentchanges_rc_this_oldid_b_then_a := recentchanges_rc_this_oldid;
    recentchanges_rc_timestamp_b_then_a := recentchanges_rc_timestamp;
    recentchanges_rc_title_b_then_a := recentchanges_rc_title;
    recentchanges_rc_user_b_then_a := recentchanges_rc_user;
    recentchanges_rc_user_text_b_then_a := recentchanges_rc_user_text;
    revision_rev_comment_b_then_a := revision_rev_comment;
    revision_rev_len_b_then_a := revision_rev_len;
    revision_rev_parent_id_b_then_a := revision_rev_parent_id;
    revision_rev_text_id_b_then_a := revision_rev_text_id;
    revision_rev_timestamp_b_then_a := revision_rev_timestamp;
    revision_rev_user_b_then_a := revision_rev_user;
    revision_rev_user_text_b_then_a := revision_rev_user_text;
    text_old_flags_b_then_a := text_old_flags;
    text_old_page_b_then_a := text_old_page;
    text_old_text_b_then_a := text_old_text;
    ...
    s0_otherUserId_b_then_a := s0_otherUserId;
    ...
    s1_otherUserId_b_then_a := s1_otherUserId;
  // --- Step 4: Verify A→B ≡ B→A (Special interleavings equivalence) ---
  // Verifying A->B === B->A equivalence:
    assert {:msg "(SpecialInterleavingNonEquivalence (node_1 (function_id . 20) (instance . 0) (hop_id . 8)) (node_2 (function_id . 20) (instance . 1) (hop_id . 8)))"} ((((((((((((((((((((((((((((((((((((((((((((page_page_id_a_then_b == page_page_id_b_then_a) && (page_page_is_new_a_then_b == page_page_is_new_b_then_a)) && (page_page_is_redirect_a_then_b == page_page_is_redirect_b_then_a)) && (page_page_latest_a_then_b == page_page_latest_b_then_a)) && (page_page_len_a_then_b == page_page_len_b_then_a)) && (page_page_namespace_a_then_b == page_page_namespace_b_then_a)) && (page_page_title_a_then_b == page_page_title_b_then_a)) && (page_page_touched_a_then_b == page_page_touched_b_then_a)) && (recentchanges_rc_comment_a_then_b == recentchanges_rc_comment_b_then_a)) && (recentchanges_rc_cur_id_a_then_b == recentchanges_rc_cur_id_b_then_a)) && (recentchanges_rc_ip_a_then_b == recentchanges_rc_ip_b_then_a)) && (recentchanges_rc_last_oldid_a_then_b == recentchanges_rc_last_oldid_b_then_a)) && (recentchanges_rc_namespace_a_then_b == recentchanges_rc_namespace_b_then_a)) && (recentchanges_rc_new_len_a_then_b == recentchanges_rc_new_len_b_then_a)) && (recentchanges_rc_old_len_a_then_b == recentchanges_rc_old_len_b_then_a)) && (recentchanges_rc_this_oldid_a_then_b == recentchanges_rc_this_oldid_b_then_a)) && (recentchanges_rc_timestamp_a_then_b == recentchanges_rc_timestamp_b_then_a)) && (recentchanges_rc_title_a_then_b == recentchanges_rc_title_b_then_a)) && (recentchanges_rc_user_a_then_b == recentchanges_rc_user_b_then_a)) && (recentchanges_rc_user_text_a_then_b == recentchanges_rc_user_text_b_then_a)) && (revision_rev_comment_a_then_b == revision_rev_comment_b_then_a)) && (revision_rev_len_a_then_b == revision_rev_len_b_then_a)) && (revision_rev_parent_id_a_then_b == revision_rev_parent_id_b_then_a)) && (revision_rev_text_id_a_then_b == revision_rev_text_id_b_then_a)) && (revision_rev_timestamp_a_then_b == revision_rev_timestamp_b_then_a)) && (revision_rev_user_a_then_b == revision_rev_user_b_then_a)) && (revision_rev_user_text_a_then_b == revision_rev_user_text_b_then_a)) && (text_old_flags_a_then_b == text_old_flags_b_then_a)) && (text_old_page_a_then_b == text_old_page_b_then_a)) && (text_old_text_a_then_b == text_old_text_b_then_a)) && (s0_nextRevId_a_then_b == s0_nextRevId_b_then_a)) && (s0_pageId_a_then_b == s0_pageId_b_then_a)) && (s0_pageTitle_a_then_b == s0_pageTitle_b_then_a)) && (s0_pageNamespace_a_then_b == s0_pageNamespace_b_then_a)) && (s0_userId_a_then_b == s0_userId_b_then_a)) && (s0_userText_a_then_b == s0_userText_b_then_a)) && (s0_otherUserId_a_then_b == s0_otherUserId_b_then_a)) && (s1_nextRevId_a_then_b == s1_nextRevId_b_then_a)) && (s1_pageId_a_then_b == s1_pageId_b_then_a)) && (s1_pageTitle_a_then_b == s1_pageTitle_b_then_a)) && (s1_pageNamespace_a_then_b == s1_pageNamespace_b_then_a)) && (s1_userId_a_then_b == s1_userId_b_then_a)) && (s1_userText_a_then_b == s1_userText_b_then_a)) && (s1_otherUserId_a_then_b == s1_otherUserId_b_then_a));
}
