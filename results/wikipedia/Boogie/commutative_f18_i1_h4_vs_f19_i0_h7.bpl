...
procedure Check_SliceCommut_Hop4_vs_Hop7()
modifies ipblocks_ipb_address, ipblocks_ipb_expiry, user_user_editcount, user_user_id, user_user_name, user_user_touched, watchlist_wl_namespace, watchlist_wl_notificationtimestamp, watchlist_wl_title, watchlist_wl_user;
{
  var s0_userId : int;
  var s0_pageId : int;
  ...
  // Slice commutativity verification: hop 4 vs hop 7
  ...
  // --- Step 2: Save initial state ---
    ...
    s1_nameSpace_init := s1_nameSpace;
  ...
  // Executing A then B:
    ...
    if (s1_active) {
    s1_block9__ab:
      s1_wl#wl_namespace := watchlist_wl_namespace[s1_userId][s1_nameSpace][s1_pageTitle];
      s1_wl#wl_notificationtimestamp := watchlist_wl_notificationtimestamp[s1_userId][s1_nameSpace][s1_pageTitle];
      s1_wl#wl_title := watchlist_wl_title[s1_userId][s1_nameSpace][s1_pageTitle];
      s1_wl#wl_user := watchlist_wl_user[s1_userId][s1_nameSpace][s1_pageTitle];
      watchlist_wl_namespace := watchlist_wl_namespace[s1_userId := watchlist_wl_namespace[s1_userId][s1_nameSpace := watchlist_wl_namespace[s1_userId][s1_nameSpace][s1_pageTitle := s1_wl#wl_namespace]]];
    ...
    s1_block10__ab:
      s1_wl2#wl_namespace := watchlist_wl_namespace[s1_userId][1][s1_pageTitle];
      s1_wl2#wl_notificationtimestamp := watchlist_wl_notificationtimestamp[s1_userId][1][s1_pageTitle];
      s1_wl2#wl_title := watchlist_wl_title[s1_userId][1][s1_pageTitle];
      s1_wl2#wl_user := watchlist_wl_user[s1_userId][1][s1_pageTitle];
      watchlist_wl_namespace := watchlist_wl_namespace[s1_userId := watchlist_wl_namespace[s1_userId][1 := watchlist_wl_namespace[s1_userId][1][s1_pageTitle := s1_wl2#wl_namespace]]];
      watchlist_wl_notificationtimestamp := watchlist_wl_notificationtimestamp[s1_userId := watchlist_wl_notificationtimestamp[s1_userId][1 := watchlist_wl_notificationtimestamp[s1_userId][1][s1_pageTitle := s1_wl2#wl_notificationtimestamp]]];
      watchlist_wl_title := watchlist_wl_title[s1_userId := watchlist_wl_title[s1_userId][1 := watchlist_wl_title[s1_userId][1][s1_pageTitle := s1_wl2#wl_title]]];
      watchlist_wl_user := watchlist_wl_user[s1_userId := watchlist_wl_user[s1_userId][1 := watchlist_wl_user[s1_userId][1][s1_pageTitle := s1_wl2#wl_user]]];
      goto s1_block11__ab;
    s1_block11__ab:
      ...
      user_user_touched := user_user_touched[s1_userId := 0];
      s1_active := false;
  ...
  // Restoring initial state:
    ...
    s1_nameSpace := s1_nameSpace_init;
