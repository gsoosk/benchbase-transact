...
procedure Check_SliceCommut_Hop7_vs_Hop10()
modifies logging_log_action, logging_log_comment, logging_log_namespace, logging_log_page, logging_log_params, logging_log_timestamp, logging_log_title, logging_log_type, logging_log_user_text, user_user_editcount, user_user_id, user_user_name, user_user_touched, watchlist_wl_namespace, watchlist_wl_notificationtimestamp, watchlist_wl_title, watchlist_wl_user;
{
  var s0_userId : int;
  var s0_nameSpace : int;
  ...
  var s0_active : bool;
  var s1_active : bool;
  var logging_log_action_init : [int][int]String;
  var logging_log_comment_init : [int][int]String;
  var logging_log_namespace_init : [int][int]int;
  var logging_log_page_init : [int][int]int;
  var logging_log_params_init : [int][int]String;
  var logging_log_timestamp_init : [int][int]int;
  var logging_log_title_init : [int][int]String;
  var logging_log_type_init : [int][int]String;
  var logging_log_user_text_init : [int][int]String;
  var user_user_editcount_init : [int]int;
  var user_user_id_init : [int]int;
  var user_user_name_init : [int]String;
  var user_user_touched_init : [int]int;
  ...
  var s0_wl2#wl_user : int;
  var s0_u#user_editcount : int;
  var s0_u#user_id : int;
  var s0_u#user_name : String;
  var s1_u#user_editcount : int;
  var s1_u#user_id : int;
  var s1_u#user_name : String;
  var s1_#tmp20 : int;
  var logging_log_action_a_then_b : [int][int]String;
  var logging_log_comment_a_then_b : [int][int]String;
  var logging_log_namespace_a_then_b : [int][int]int;
  var logging_log_page_a_then_b : [int][int]int;
  var logging_log_params_a_then_b : [int][int]String;
  var logging_log_timestamp_a_then_b : [int][int]int;
  var logging_log_title_a_then_b : [int][int]String;
  var logging_log_type_a_then_b : [int][int]String;
  var logging_log_user_text_a_then_b : [int][int]String;
  var user_user_editcount_a_then_b : [int]int;
  var user_user_id_a_then_b : [int]int;
  var user_user_name_a_then_b : [int]String;
  var user_user_touched_a_then_b : [int]int;
  ...
  var logging_log_action_b_then_a : [int][int]String;
  var logging_log_comment_b_then_a : [int][int]String;
  var logging_log_namespace_b_then_a : [int][int]int;
  var logging_log_page_b_then_a : [int][int]int;
  var logging_log_params_b_then_a : [int][int]String;
  var logging_log_timestamp_b_then_a : [int][int]int;
  var logging_log_title_b_then_a : [int][int]String;
  var logging_log_type_b_then_a : [int][int]String;
  var logging_log_user_text_b_then_a : [int][int]String;
  var user_user_editcount_b_then_a : [int]int;
  var user_user_id_b_then_a : [int]int;
  var user_user_name_b_then_a : [int]String;
  var user_user_touched_b_then_a : [int]int;
  ...
  // Slice commutativity verification: hop 7 vs hop 10
  // --- Step 1: Havoc initial state ---
    havoc logging_log_action;
    havoc logging_log_comment;
    havoc logging_log_namespace;
    havoc logging_log_page;
    havoc logging_log_params;
    havoc logging_log_timestamp;
    havoc logging_log_title;
    havoc logging_log_type;
    havoc logging_log_user_text;
    havoc user_user_editcount;
    havoc user_user_id;
    havoc user_user_name;
    havoc user_user_touched;
  ...
  // --- Step 2: Save initial state ---
    logging_log_action_init := logging_log_action;
    logging_log_comment_init := logging_log_comment;
    logging_log_namespace_init := logging_log_namespace;
    logging_log_page_init := logging_log_page;
    logging_log_params_init := logging_log_params;
    logging_log_timestamp_init := logging_log_timestamp;
    logging_log_title_init := logging_log_title;
    logging_log_type_init := logging_log_type;
    logging_log_user_text_init := logging_log_user_text;
    user_user_editcount_init := user_user_editcount;
    user_user_id_init := user_user_id;
    user_user_name_init := user_user_name;
    user_user_touched_init := user_user_touched;
    ...
    s0_nameSpace_init := s0_nameSpace;
  ...
  // Executing A then B:
    if (s0_active) {
    s0_block9__ab:
      s0_wl#wl_namespace := watchlist_wl_namespace[s0_userId][s0_nameSpace][s0_pageTitle];
      s0_wl#wl_notificationtimestamp := watchlist_wl_notificationtimestamp[s0_userId][s0_nameSpace][s0_pageTitle];
      s0_wl#wl_title := watchlist_wl_title[s0_userId][s0_nameSpace][s0_pageTitle];
      s0_wl#wl_user := watchlist_wl_user[s0_userId][s0_nameSpace][s0_pageTitle];
      watchlist_wl_namespace := watchlist_wl_namespace[s0_userId := watchlist_wl_namespace[s0_userId][s0_nameSpace := watchlist_wl_namespace[s0_userId][s0_nameSpace][s0_pageTitle := s0_wl#wl_namespace]]];
    ...
    s0_block10__ab:
      s0_wl2#wl_namespace := watchlist_wl_namespace[s0_userId][1][s0_pageTitle];
      s0_wl2#wl_notificationtimestamp := watchlist_wl_notificationtimestamp[s0_userId][1][s0_pageTitle];
      s0_wl2#wl_title := watchlist_wl_title[s0_userId][1][s0_pageTitle];
      s0_wl2#wl_user := watchlist_wl_user[s0_userId][1][s0_pageTitle];
      watchlist_wl_namespace := watchlist_wl_namespace[s0_userId := watchlist_wl_namespace[s0_userId][1 := watchlist_wl_namespace[s0_userId][1][s0_pageTitle := s0_wl2#wl_namespace]]];
      watchlist_wl_notificationtimestamp := watchlist_wl_notificationtimestamp[s0_userId := watchlist_wl_notificationtimestamp[s0_userId][1 := watchlist_wl_notificationtimestamp[s0_userId][1][s0_pageTitle := s0_wl2#wl_notificationtimestamp]]];
      watchlist_wl_title := watchlist_wl_title[s0_userId := watchlist_wl_title[s0_userId][1 := watchlist_wl_title[s0_userId][1][s0_pageTitle := s0_wl2#wl_title]]];
      watchlist_wl_user := watchlist_wl_user[s0_userId := watchlist_wl_user[s0_userId][1 := watchlist_wl_user[s0_userId][1][s0_pageTitle := s0_wl2#wl_user]]];
      goto s0_block11__ab;
    s0_block11__ab:
      s0_u#user_editcount := user_user_editcount[s0_userId];
      s0_u#user_id := user_user_id[s0_userId];
      s0_u#user_name := user_user_name[s0_userId];
      user_user_editcount := user_user_editcount[s0_userId := s0_u#user_editcount];
      user_user_id := user_user_id[s0_userId := s0_u#user_id];
      user_user_name := user_user_name[s0_userId := s0_u#user_name];
      user_user_touched := user_user_touched[s0_userId := 0];
      s0_active := false;
    ...
    if (s1_active) {
    s1_block14__ab:
      logging_log_type := logging_log_type[s1_userId := logging_log_type[s1_userId][s1_nextRevId := L_patrol]];
      logging_log_action := logging_log_action[s1_userId := logging_log_action[s1_userId][s1_nextRevId := L_patrol]];
      logging_log_timestamp := logging_log_timestamp[s1_userId := logging_log_timestamp[s1_userId][s1_nextRevId := 1]];
      logging_log_user_text := logging_log_user_text[s1_userId := logging_log_user_text[s1_userId][s1_nextRevId := s1_userText]];
      logging_log_namespace := logging_log_namespace[s1_userId := logging_log_namespace[s1_userId][s1_nextRevId := s1_pageNamespace]];
      logging_log_title := logging_log_title[s1_userId := logging_log_title[s1_userId][s1_nextRevId := s1_pageTitle]];
      logging_log_page := logging_log_page[s1_userId := logging_log_page[s1_userId][s1_nextRevId := s1_pageId]];
      logging_log_comment := logging_log_comment[s1_userId := logging_log_comment[s1_userId][s1_nextRevId := empty]];
      logging_log_params := logging_log_params[s1_userId := logging_log_params[s1_userId][s1_nextRevId := empty]];
      s1_u#user_editcount := user_user_editcount[s1_userId];
      s1_u#user_id := user_user_id[s1_userId];
      s1_u#user_name := user_user_name[s1_userId];
      s1_#tmp20 := s1_u#user_editcount + 1;
      s1_u#user_editcount := s1_#tmp20;
      user_user_editcount := user_user_editcount[s1_userId := s1_u#user_editcount];
      user_user_id := user_user_id[s1_userId := s1_u#user_id];
      user_user_name := user_user_name[s1_userId := s1_u#user_name];
      user_user_touched := user_user_touched[s1_userId := 1];
      s1_active := false;
      goto s1_hop_exit__ab;
    s1_hop_exit__ab:
    }
  // Snapshotting final state for a_then_b
    logging_log_action_a_then_b := logging_log_action;
    logging_log_comment_a_then_b := logging_log_comment;
    logging_log_namespace_a_then_b := logging_log_namespace;
    logging_log_page_a_then_b := logging_log_page;
    logging_log_params_a_then_b := logging_log_params;
    logging_log_timestamp_a_then_b := logging_log_timestamp;
    logging_log_title_a_then_b := logging_log_title;
    logging_log_type_a_then_b := logging_log_type;
    logging_log_user_text_a_then_b := logging_log_user_text;
    user_user_editcount_a_then_b := user_user_editcount;
    user_user_id_a_then_b := user_user_id;
    user_user_name_a_then_b := user_user_name;
    user_user_touched_a_then_b := user_user_touched;
  ...
  // Restoring initial state:
    logging_log_action := logging_log_action_init;
    logging_log_comment := logging_log_comment_init;
    logging_log_namespace := logging_log_namespace_init;
    logging_log_page := logging_log_page_init;
    logging_log_params := logging_log_params_init;
    logging_log_timestamp := logging_log_timestamp_init;
    logging_log_title := logging_log_title_init;
    logging_log_type := logging_log_type_init;
    logging_log_user_text := logging_log_user_text_init;
    user_user_editcount := user_user_editcount_init;
    user_user_id := user_user_id_init;
    user_user_name := user_user_name_init;
    user_user_touched := user_user_touched_init;
    ...
    s0_nameSpace := s0_nameSpace_init;
  ...
  // Snapshotting final state for b_then_a
    logging_log_action_b_then_a := logging_log_action;
    logging_log_comment_b_then_a := logging_log_comment;
    logging_log_namespace_b_then_a := logging_log_namespace;
    logging_log_page_b_then_a := logging_log_page;
    logging_log_params_b_then_a := logging_log_params;
    logging_log_timestamp_b_then_a := logging_log_timestamp;
    logging_log_title_b_then_a := logging_log_title;
    logging_log_type_b_then_a := logging_log_type;
    logging_log_user_text_b_then_a := logging_log_user_text;
    user_user_editcount_b_then_a := user_user_editcount;
    user_user_id_b_then_a := user_user_id;
    user_user_name_b_then_a := user_user_name;
    user_user_touched_b_then_a := user_user_touched;
  ...
  // Verifying A->B === B->A equivalence:
    assert {:msg "(SpecialInterleavingNonEquivalence (node_1 (function_id . 19) (instance . 1) (hop_id . 7)) (node_2 (function_id . 20) (instance . 0) (hop_id . 10)))"} (((((((((((((((((logging_log_action_a_then_b == logging_log_action_b_then_a) && (logging_log_comment_a_then_b == logging_log_comment_b_then_a)) && (logging_log_namespace_a_then_b == logging_log_namespace_b_then_a)) && (logging_log_page_a_then_b == logging_log_page_b_then_a)) && (logging_log_params_a_then_b == logging_log_params_b_then_a)) && (logging_log_timestamp_a_then_b == logging_log_timestamp_b_then_a)) && (logging_log_title_a_then_b == logging_log_title_b_then_a)) && (logging_log_type_a_then_b == logging_log_type_b_then_a)) && (logging_log_user_text_a_then_b == logging_log_user_text_b_then_a)) && (user_user_editcount_a_then_b == user_user_editcount_b_then_a)) && (user_user_id_a_then_b == user_user_id_b_then_a)) && (user_user_name_a_then_b == user_user_name_b_then_a)) && (user_user_touched_a_then_b == user_user_touched_b_then_a)) && (watchlist_wl_namespace_a_then_b == watchlist_wl_namespace_b_then_a)) && (watchlist_wl_notificationtimestamp_a_then_b == watchlist_wl_notificationtimestamp_b_then_a)) && (watchlist_wl_title_a_then_b == watchlist_wl_title_b_then_a)) && (watchlist_wl_user_a_then_b == watchlist_wl_user_b_then_a));
}
