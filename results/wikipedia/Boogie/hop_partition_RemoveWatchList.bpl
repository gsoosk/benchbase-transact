...
{
  var s7_wl#wl_namespace : int;
  var s7_userId : int;
  var s7_nameSpace : int;
  var s7_pageTitle : String;
  ...
  var s7_wl2#wl_user : int;
  var s7_u#user_editcount : int;
  var s7_u#user_id : int;
  var s7_u#user_name : String;

  // Hop partition verification for function 'RemoveWatchList'
  s7_block9:
