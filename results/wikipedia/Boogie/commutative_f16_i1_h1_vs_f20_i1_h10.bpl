...
procedure Check_SliceCommut_Hop1_vs_Hop10()
modifies logging_log_action, logging_log_comment, logging_log_namespace, logging_log_page, logging_log_params, logging_log_timestamp, logging_log_title, logging_log_type, logging_log_user_text, user_user_editcount, user_user_id, user_user_name, user_user_touched, watchlist_wl_notificationtimestamp;
{
  var s0_userId : int;
  ...
  // Slice commutativity verification: hop 1 vs hop 10
  ...
  // Executing A then B:
    if (s0_active) {
    s0_block1__ab:
      watchlist_wl_notificationtimestamp := watchlist_wl_notificationtimestamp[s0_userId := watchlist_wl_notificationtimestamp[s0_userId][s0_nameSpace := watchlist_wl_notificationtimestamp[s0_userId][s0_nameSpace][s0_pageTitle := 0]]];
      s0_#tmp0 := s0_nameSpace == 0;
      if (s0_#tmp0) {
      goto s0_block2__ab;
    } else {
      goto s0_block3__ab;
    ...
    s0_block2__ab:
      watchlist_wl_notificationtimestamp := watchlist_wl_notificationtimestamp[s0_userId := watchlist_wl_notificationtimestamp[s0_userId][1 := watchlist_wl_notificationtimestamp[s0_userId][1][s0_pageTitle := 0]]];
      goto s0_block3__ab;
    s0_block3__ab:
