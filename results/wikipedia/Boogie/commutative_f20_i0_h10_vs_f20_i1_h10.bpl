...
procedure Check_SliceCommut_Hop10_vs_Hop10()
modifies logging_log_action, logging_log_comment, logging_log_namespace, logging_log_page, logging_log_params, logging_log_timestamp, logging_log_title, logging_log_type, logging_log_user_text, user_user_editcount, user_user_id, user_user_name, user_user_touched;
{
  ...
  // Slice commutativity verification: hop 10 vs hop 10
  ...
  // Executing A then B:
    if (s0_active) {
    s0_block14__ab:
      logging_log_type := logging_log_type[s0_userId := logging_log_type[s0_userId][s0_nextRevId := L_patrol]];
      logging_log_action := logging_log_action[s0_userId := logging_log_action[s0_userId][s0_nextRevId := L_patrol]];
      logging_log_timestamp := logging_log_timestamp[s0_userId := logging_log_timestamp[s0_userId][s0_nextRevId := 1]];
      logging_log_user_text := logging_log_user_text[s0_userId := logging_log_user_text[s0_userId][s0_nextRevId := s0_userText]];
      logging_log_namespace := logging_log_namespace[s0_userId := logging_log_namespace[s0_userId][s0_nextRevId := s0_pageNamespace]];
      logging_log_title := logging_log_title[s0_userId := logging_log_title[s0_userId][s0_nextRevId := s0_pageTitle]];
      logging_log_page := logging_log_page[s0_userId := logging_log_page[s0_userId][s0_nextRevId := s0_pageId]];
      logging_log_comment := logging_log_comment[s0_userId := logging_log_comment[s0_userId][s0_nextRevId := empty]];
      logging_log_params := logging_log_params[s0_userId := logging_log_params[s0_userId][s0_nextRevId := empty]];
      ...
      s0_#tmp20 := s0_u#user_editcount + 1;
      s0_u#user_editcount := s0_#tmp20;
      ...
      user_user_touched := user_user_touched[s0_userId := 1];
      s0_active := false;
