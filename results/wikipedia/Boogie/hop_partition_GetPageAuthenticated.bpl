...
procedure verify_hop_partitions_GetPageAuthenticated(userId: int, pageId: int, ug_group: String, pr_type: String, latest_rev_id: int, text_id: int, ipb_id: int)
{
  var s4_#tmp9 : Row (Table (user));
  var s4_userId : int;
  var s4_u : Row (Table (user));
  var s4_#tmp10 : unit;
  var s4_#tmp11 : Row (Table (user_groups));
  var s4_ug_group : String;
  var s4_ug : Row (Table (user_groups));
  var s4_#tmp12 : unit;
  var s4_#tmp13 : Row (Table (ipblocks));
  var s4_ipb_id : int;
  var s4_ip : Row (Table (ipblocks));
  var s4_#tmp14 : unit;
  var s5_#tmp15 : Row (Table (page));
  var s5_pageId : int;
  var s5_p : Row (Table (page));
  var s5_#tmp16 : unit;
  var s5_#tmp17 : Row (Table (page_restrictions));
  var s5_pr_type : String;
  var s5_pr : Row (Table (page_restrictions));
  var s5_#tmp18 : unit;
  var s5_r#rev_text_id : int;
  var s5_latest_rev_id : int;
  var s5_textId : int;
  var s6_t#old_text : String;
  var s6_textId : int;
  var s6_content : String;
  var s6_#tmp21 : unit;

  // Hop partition verification for function 'GetPageAuthenticated'
  s4_block6:
    s4_#tmp9 := construct_Row_user(user_user_id[s4_userId], user_user_name[s4_userId], user_user_touched[s4_userId], user_user_editcount[s4_userId]);
    s4_u := s4_#tmp9;
    s4_#tmp10 := to_unit(s4_u);
    s4_#tmp11 := construct_Row_user_groups(user_groups_ug_user[s4_userId][s4_ug_group], user_groups_ug_group[s4_userId][s4_ug_group]);
  // Partition check hop 4 func 'f' tables 'user'=>'user_groups' keys [k0=userId] first_span Span { start: 7190, end: 7211, filename: "/Users/farzad/Desktop/Research/benchbase-transact/wikipedia.transact" } current_span Span { start: 7268, end: 7316, filename: "/Users/farzad/Desktop/Research/benchbase-transact/wikipedia.transact" }
    assert {:msg "(PartitionFunctionInconsistency (partition_function_id . 15) (function_id . 18) (hop_id . 4) (table_id . 7) (span ((start . 7268) (end . 7316) (filename . \"/Users/farzad/Desktop/Research/benchbase-transact/wikipedia.transact\"))))"} (s4_userId == s4_userId);
    s4_ug := s4_#tmp11;
    s4_#tmp12 := to_unit(s4_ug);
    s4_#tmp13 := construct_Row_ipblocks(ipblocks_ipb_user[s4_userId][s4_ipb_id], ipblocks_ipb_id[s4_userId][s4_ipb_id], ipblocks_ipb_address[s4_userId][s4_ipb_id], ipblocks_ipb_expiry[s4_userId][s4_ipb_id]);
  // Partition check hop 4 func 'f' tables 'user'=>'ipblocks' keys [k0=userId] first_span Span { start: 7190, end: 7211, filename: "/Users/farzad/Desktop/Research/benchbase-transact/wikipedia.transact" } current_span Span { start: 7371, end: 7413, filename: "/Users/farzad/Desktop/Research/benchbase-transact/wikipedia.transact" }
    assert {:msg "(PartitionFunctionInconsistency (partition_function_id . 15) (function_id . 18) (hop_id . 4) (table_id . 4) (span ((start . 7371) (end . 7413) (filename . \"/Users/farzad/Desktop/Research/benchbase-transact/wikipedia.transact\"))))"} (s4_userId == s4_userId);
    s4_ip := s4_#tmp13;
    s4_#tmp14 := to_unit(s4_ip);
    goto s4_hop_exit;
  s4_hop_exit:
  s5_block7:
    s5_#tmp15 := construct_Row_page(page_page_id[s5_pageId], page_page_namespace[s5_pageId], page_page_title[s5_pageId], page_page_latest[s5_pageId], page_page_touched[s5_pageId], page_page_is_new[s5_pageId], page_page_is_redirect[s5_pageId], page_page_len[s5_pageId]);
    s5_p := s5_#tmp15;
    s5_#tmp16 := to_unit(s5_p);
    s5_#tmp17 := construct_Row_page_restrictions(page_restrictions_pr_page[s5_pageId][s5_pr_type], page_restrictions_pr_type[s5_pageId][s5_pr_type], page_restrictions_pr_level[s5_pageId][s5_pr_type]);
  // Partition check hop 5 func 'f' tables 'page'=>'page_restrictions' keys [k0=pageId] first_span Span { start: 7530, end: 7551, filename: "/Users/farzad/Desktop/Research/benchbase-transact/wikipedia.transact" } current_span Span { start: 7614, end: 7666, filename: "/Users/farzad/Desktop/Research/benchbase-transact/wikipedia.transact" }
    assert {:msg "(PartitionFunctionInconsistency (partition_function_id . 15) (function_id . 18) (hop_id . 5) (table_id . 3) (span ((start . 7614) (end . 7666) (filename . \"/Users/farzad/Desktop/Research/benchbase-transact/wikipedia.transact\"))))"} (s5_pageId == s5_pageId);
    s5_pr := s5_#tmp17;
    s5_#tmp18 := to_unit(s5_pr);
    s5_r#rev_text_id := revision_rev_text_id[s5_pageId][s5_latest_rev_id];
  // Partition check hop 5 func 'f' tables 'page'=>'revision' keys [k0=pageId] first_span Span { start: 7530, end: 7551, filename: "/Users/farzad/Desktop/Research/benchbase-transact/wikipedia.transact" } current_span Span { start: 7720, end: 7769, filename: "/Users/farzad/Desktop/Research/benchbase-transact/wikipedia.transact" }
    assert {:msg "(PartitionFunctionInconsistency (partition_function_id . 15) (function_id . 18) (hop_id . 5) (table_id . 5) (span ((start . 7720) (end . 7769) (filename . \"/Users/farzad/Desktop/Research/benchbase-transact/wikipedia.transact\"))))"} (s5_pageId == s5_pageId);
    s5_textId := s5_r#rev_text_id;
    goto s5_hop_exit;
  s5_hop_exit:
  s6_block8:
    s6_t#old_text := text_old_text[s6_textId];
    s6_content := s6_t#old_text;
    s6_#tmp21 := to_unit(s6_content);
    goto s6_epilogue;
  s6_hop_exit:
  s4_epilogue:
  s5_epilogue:
