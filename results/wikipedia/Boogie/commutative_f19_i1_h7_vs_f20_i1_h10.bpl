...
modifies logging_log_action, logging_log_comment, logging_log_namespace, logging_log_page, logging_log_params, logging_log_timestamp, logging_log_title, logging_log_type, logging_log_user_text, user_user_editcount, user_user_id, user_user_name, user_user_touched, watchlist_wl_namespace, watchlist_wl_notificationtimestamp, watchlist_wl_title, watchlist_wl_user;
{
  ...
  // Executing A then B:
    ...
    s1_block14__ab:
      ...
      s1_#tmp29 := s1_u#user_editcount + 1;
      s1_u#user_editcount := s1_#tmp29;
