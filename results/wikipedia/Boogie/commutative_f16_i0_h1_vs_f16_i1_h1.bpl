...
procedure Check_SliceCommut_Hop1_vs_Hop1()
modifies user_user_editcount, user_user_id, user_user_name, user_user_touched, watchlist_wl_notificationtimestamp;
{
  var s0_userId : int;
  ...
  // Slice commutativity verification: hop 1 vs hop 1
  ...
  // Executing A then B:
    ...
    if (s1_active) {
    s1_block1__ab:
      watchlist_wl_notificationtimestamp := watchlist_wl_notificationtimestamp[s1_userId := watchlist_wl_notificationtimestamp[s1_userId][s1_nameSpace := watchlist_wl_notificationtimestamp[s1_userId][s1_nameSpace][s1_pageTitle := 0]]];
      s1_#tmp0 := s1_nameSpace == 0;
      if (s1_#tmp0) {
      goto s1_block2__ab;
    } else {
      goto s1_block3__ab;
    ...
    s1_block2__ab:
      watchlist_wl_notificationtimestamp := watchlist_wl_notificationtimestamp[s1_userId := watchlist_wl_notificationtimestamp[s1_userId][1 := watchlist_wl_notificationtimestamp[s1_userId][1][s1_pageTitle := 0]]];
      goto s1_block3__ab;
    s1_block3__ab:
  ...
  // Verifying A->B === B->A equivalence:
    assert {:msg "(SpecialInterleavingNonEquivalence (node_1 (function_id . 16) (instance . 0) (hop_id . 1)) (node_2 (function_id . 16) (instance . 1) (hop_id . 1)))"} (((((user_user_editcount_a_then_b == user_user_editcount_b_then_a) && (user_user_id_a_then_b == user_user_id_b_then_a)) && (user_user_name_a_then_b == user_user_name_b_then_a)) && (user_user_touched_a_then_b == user_user_touched_b_then_a)) && (watchlist_wl_notificationtimestamp_a_then_b == watchlist_wl_notificationtimestamp_b_then_a));
}
