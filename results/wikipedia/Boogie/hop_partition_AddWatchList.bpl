...
procedure verify_hop_partitions_AddWatchList(userId: int, nameSpace: int, pageTitle: String)
modifies user_user_editcount, user_user_id, user_user_name, user_user_touched, watchlist_wl_notificationtimestamp;
{
  ...
  // Hop partition verification for function 'AddWatchList'
  s1_block1:
  ...
  // Partition check hop 1 func 'f' tables 'watchlist'=>'watchlist' keys [k0=userId] first_span Span { start: 4860, end: 4986, filename: "/Users/farzad/Desktop/Research/benchbase-transact/wikipedia.transact" } current_span Span { start: 5118, end: 5244, filename: "/Users/farzad/Desktop/Research/benchbase-transact/wikipedia.transact" }
    assert {:msg "(PartitionFunctionInconsistency (partition_function_id . 15) (function_id . 16) (hop_id . 1) (table_id . 1) (span ((start . 5118) (end . 5244) (filename . \"/Users/farzad/Desktop/Research/benchbase-transact/wikipedia.transact\"))))"} (s1_userId == s1_userId);
    goto s1_block3;
  s1_block3:
    s1_u#user_editcount := user_user_editcount[s1_userId];
  // Partition check hop 1 func 'f' tables 'watchlist'=>'user' keys [k0=userId] first_span Span { start: 4860, end: 4986, filename: "/Users/farzad/Desktop/Research/benchbase-transact/wikipedia.transact" } current_span Span { start: 5317, end: 5338, filename: "/Users/farzad/Desktop/Research/benchbase-transact/wikipedia.transact" }
    assert {:msg "(PartitionFunctionInconsistency (partition_function_id . 15) (function_id . 16) (hop_id . 1) (table_id . 0) (span ((start . 5317) (end . 5338) (filename . \"/Users/farzad/Desktop/Research/benchbase-transact/wikipedia.transact\"))))"} (s1_userId == s1_userId);
  ...
  // Partition check hop 1 func 'f' tables 'watchlist'=>'user' keys [k0=userId] first_span Span { start: 4860, end: 4986, filename: "/Users/farzad/Desktop/Research/benchbase-transact/wikipedia.transact" } current_span Span { start: 5376, end: 5401, filename: "/Users/farzad/Desktop/Research/benchbase-transact/wikipedia.transact" }
    assert {:msg "(PartitionFunctionInconsistency (partition_function_id . 15) (function_id . 16) (hop_id . 1) (table_id . 0) (span ((start . 5376) (end . 5401) (filename . \"/Users/farzad/Desktop/Research/benchbase-transact/wikipedia.transact\"))))"} (s1_userId == s1_userId);
