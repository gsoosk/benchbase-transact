...
procedure Check_SliceCommut_Hop27_vs_Hop28()
modifies Customer_C_BALANCE, Customer_C_DELIVERY_CNT, District_D_NEXT_NO_ID, District_D_NEXT_O_ID, Order_Line_OL_AMOUNT, Order_Line_OL_DELIVERY_DATE, Order_Line_OL_I_ID, Order_Line_OL_QUANTITY, Order_Line_OL_SUPPLY_W_ID, Order_O_ALL_LOCAL, Order_O_CARRIER_ID, Order_O_C_ID, Order_O_ENTRY_DATE, Order_O_OL_CNT;
{
  ...
  // Slice commutativity verification: hop 27 vs hop 28
  ...
  // Executing A then B:
    ...
    if (s1_active) {
    s1_block82__ab:
      s1_#tmp267 := District_D_NEXT_NO_ID[s1_w_id][0];
      s1_no_o_id := s1_#tmp267;
      s1_#tmp268 := s1_no_o_id + 1;
      District_D_NEXT_NO_ID := District_D_NEXT_NO_ID[s1_w_id := District_D_NEXT_NO_ID[s1_w_id][0 := s1_#tmp268]];
      s1_#tmp269 := Order_O_C_ID[s1_w_id][0][s1_no_o_id];
      s1_c_id := s1_#tmp269;
      s1_#tmp270 := Order_O_OL_CNT[s1_w_id][0][s1_no_o_id];
      s1_ol_cnt := s1_#tmp270;
      s1_#tmp271 := to_unit(s1_ol_cnt);
      Order_O_CARRIER_ID := Order_O_CARRIER_ID[s1_w_id := Order_O_CARRIER_ID[s1_w_id][0 := Order_O_CARRIER_ID[s1_w_id][0][s1_no_o_id := s1_o_carrier_id]]];
      goto s1_block84__ab;
    s1_block83__ab:
      s1_#tmp272 := s1_ol_number < O_OL_CNT;
      if (s1_#tmp272) {
      goto s1_block84__ab;
    } else {
      goto s1_block86__ab;
    ...
    s1_block84__ab:
      Order_Line_OL_DELIVERY_DATE := Order_Line_OL_DELIVERY_DATE[s1_w_id := Order_Line_OL_DELIVERY_DATE[s1_w_id][0 := Order_Line_OL_DELIVERY_DATE[s1_w_id][0][s1_no_o_id := Order_Line_OL_DELIVERY_DATE[s1_w_id][0][s1_no_o_id][0 := s1_date]]]];
      s1_#tmp273 := Order_Line_OL_AMOUNT[s1_w_id][0][s1_no_o_id][0];
      s1_#tmp274 := real(s1_#tmp273);
      s1_#tmp275 := 0.0000000 + s1_#tmp274;
      s1_ol_total := s1_#tmp275;
      goto s1_block157__ab;
    s1_block86__ab:
      s1_#tmp277 := Customer_C_BALANCE[s1_w_id][0][s1_c_id];
      s1_#tmp278 := s1_#tmp277 + s1_ol_total;
      Customer_C_BALANCE := Customer_C_BALANCE[s1_w_id := Customer_C_BALANCE[s1_w_id][0 := Customer_C_BALANCE[s1_w_id][0][s1_c_id := s1_#tmp278]]];
      s1_#tmp279 := Customer_C_DELIVERY_CNT[s1_w_id][0][s1_c_id];
      s1_#tmp280 := s1_#tmp279 + 1.0000000;
      Customer_C_DELIVERY_CNT := Customer_C_DELIVERY_CNT[s1_w_id := Customer_C_DELIVERY_CNT[s1_w_id][0 := Customer_C_DELIVERY_CNT[s1_w_id][0][s1_c_id := s1_#tmp280]]];
      goto s1_hop_exit__ab;
    s1_block157__ab:
      Order_Line_OL_DELIVERY_DATE := Order_Line_OL_DELIVERY_DATE[s1_w_id := Order_Line_OL_DELIVERY_DATE[s1_w_id][0 := Order_Line_OL_DELIVERY_DATE[s1_w_id][0][s1_no_o_id := Order_Line_OL_DELIVERY_DATE[s1_w_id][0][s1_no_o_id][1 := s1_date]]]];
      s1_#tmp273 := Order_Line_OL_AMOUNT[s1_w_id][0][s1_no_o_id][1];
      s1_#tmp274 := real(s1_#tmp273);
      s1_#tmp275 := s1_ol_total + s1_#tmp274;
      s1_ol_total := s1_#tmp275;
      goto s1_block158__ab;
    s1_block158__ab:
      Order_Line_OL_DELIVERY_DATE := Order_Line_OL_DELIVERY_DATE[s1_w_id := Order_Line_OL_DELIVERY_DATE[s1_w_id][0 := Order_Line_OL_DELIVERY_DATE[s1_w_id][0][s1_no_o_id := Order_Line_OL_DELIVERY_DATE[s1_w_id][0][s1_no_o_id][2 := s1_date]]]];
      s1_#tmp273 := Order_Line_OL_AMOUNT[s1_w_id][0][s1_no_o_id][2];
      s1_#tmp274 := real(s1_#tmp273);
      s1_#tmp275 := s1_ol_total + s1_#tmp274;
      s1_ol_total := s1_#tmp275;
      goto s1_block159__ab;
    s1_block159__ab:
      Order_Line_OL_DELIVERY_DATE := Order_Line_OL_DELIVERY_DATE[s1_w_id := Order_Line_OL_DELIVERY_DATE[s1_w_id][0 := Order_Line_OL_DELIVERY_DATE[s1_w_id][0][s1_no_o_id := Order_Line_OL_DELIVERY_DATE[s1_w_id][0][s1_no_o_id][3 := s1_date]]]];
      s1_#tmp273 := Order_Line_OL_AMOUNT[s1_w_id][0][s1_no_o_id][3];
      s1_#tmp274 := real(s1_#tmp273);
      s1_#tmp275 := s1_ol_total + s1_#tmp274;
      s1_ol_total := s1_#tmp275;
      goto s1_block160__ab;
    s1_block160__ab:
      Order_Line_OL_DELIVERY_DATE := Order_Line_OL_DELIVERY_DATE[s1_w_id := Order_Line_OL_DELIVERY_DATE[s1_w_id][0 := Order_Line_OL_DELIVERY_DATE[s1_w_id][0][s1_no_o_id := Order_Line_OL_DELIVERY_DATE[s1_w_id][0][s1_no_o_id][4 := s1_date]]]];
      s1_#tmp273 := Order_Line_OL_AMOUNT[s1_w_id][0][s1_no_o_id][4];
      s1_#tmp274 := real(s1_#tmp273);
      s1_#tmp275 := s1_ol_total + s1_#tmp274;
      s1_ol_total := s1_#tmp275;
      goto s1_block161__ab;
    s1_block161__ab:
      Order_Line_OL_DELIVERY_DATE := Order_Line_OL_DELIVERY_DATE[s1_w_id := Order_Line_OL_DELIVERY_DATE[s1_w_id][0 := Order_Line_OL_DELIVERY_DATE[s1_w_id][0][s1_no_o_id := Order_Line_OL_DELIVERY_DATE[s1_w_id][0][s1_no_o_id][5 := s1_date]]]];
      s1_#tmp273 := Order_Line_OL_AMOUNT[s1_w_id][0][s1_no_o_id][5];
      s1_#tmp274 := real(s1_#tmp273);
      s1_#tmp275 := s1_ol_total + s1_#tmp274;
      s1_ol_total := s1_#tmp275;
      goto s1_block162__ab;
    s1_block162__ab:
      Order_Line_OL_DELIVERY_DATE := Order_Line_OL_DELIVERY_DATE[s1_w_id := Order_Line_OL_DELIVERY_DATE[s1_w_id][0 := Order_Line_OL_DELIVERY_DATE[s1_w_id][0][s1_no_o_id := Order_Line_OL_DELIVERY_DATE[s1_w_id][0][s1_no_o_id][6 := s1_date]]]];
      s1_#tmp273 := Order_Line_OL_AMOUNT[s1_w_id][0][s1_no_o_id][6];
      s1_#tmp274 := real(s1_#tmp273);
      s1_#tmp275 := s1_ol_total + s1_#tmp274;
      s1_ol_total := s1_#tmp275;
      goto s1_block163__ab;
    s1_block163__ab:
      Order_Line_OL_DELIVERY_DATE := Order_Line_OL_DELIVERY_DATE[s1_w_id := Order_Line_OL_DELIVERY_DATE[s1_w_id][0 := Order_Line_OL_DELIVERY_DATE[s1_w_id][0][s1_no_o_id := Order_Line_OL_DELIVERY_DATE[s1_w_id][0][s1_no_o_id][7 := s1_date]]]];
      s1_#tmp273 := Order_Line_OL_AMOUNT[s1_w_id][0][s1_no_o_id][7];
      s1_#tmp274 := real(s1_#tmp273);
      s1_#tmp275 := s1_ol_total + s1_#tmp274;
      s1_ol_total := s1_#tmp275;
      goto s1_block164__ab;
    s1_block164__ab:
      Order_Line_OL_DELIVERY_DATE := Order_Line_OL_DELIVERY_DATE[s1_w_id := Order_Line_OL_DELIVERY_DATE[s1_w_id][0 := Order_Line_OL_DELIVERY_DATE[s1_w_id][0][s1_no_o_id := Order_Line_OL_DELIVERY_DATE[s1_w_id][0][s1_no_o_id][8 := s1_date]]]];
      s1_#tmp273 := Order_Line_OL_AMOUNT[s1_w_id][0][s1_no_o_id][8];
      s1_#tmp274 := real(s1_#tmp273);
      s1_#tmp275 := s1_ol_total + s1_#tmp274;
      s1_ol_total := s1_#tmp275;
      goto s1_block165__ab;
    s1_block165__ab:
      Order_Line_OL_DELIVERY_DATE := Order_Line_OL_DELIVERY_DATE[s1_w_id := Order_Line_OL_DELIVERY_DATE[s1_w_id][0 := Order_Line_OL_DELIVERY_DATE[s1_w_id][0][s1_no_o_id := Order_Line_OL_DELIVERY_DATE[s1_w_id][0][s1_no_o_id][9 := s1_date]]]];
      s1_#tmp273 := Order_Line_OL_AMOUNT[s1_w_id][0][s1_no_o_id][9];
      s1_#tmp274 := real(s1_#tmp273);
      s1_#tmp275 := s1_ol_total + s1_#tmp274;
      s1_ol_total := s1_#tmp275;
      goto s1_block86__ab;
