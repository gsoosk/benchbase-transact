...
modifies Customer_C_BALANCE, Customer_C_DELIVERY_CNT, District_D_NEXT_NO_ID, District_D_NEXT_O_ID, Order_Line_OL_AMOUNT, Order_Line_OL_DELIVERY_DATE, Order_Line_OL_I_ID, Order_Line_OL_QUANTITY, Order_Line_OL_SUPPLY_W_ID, Order_O_ALL_LOCAL, Order_O_CARRIER_ID, Order_O_C_ID, Order_O_ENTRY_DATE, Order_O_OL_CNT;
{
  ...
  // Executing A then B:
    ...
    s1_block82__ab:
      ...
      goto s1_block84__ab;
    s1_block83__ab:
      s1_#tmp271 := s1_ol_number < O_OL_CNT;
      if (s1_#tmp271) {
      goto s1_block84__ab;
    } else {
      goto s1_block86__ab;
    ...
    s1_block84__ab:
      ...
      s1_#tmp272 := Order_Line_OL_AMOUNT[s1_w_id][0][s1_no_o_id][0];
      s1_#tmp273 := real(s1_#tmp272);
      s1_#tmp274 := 0.0000000 + s1_#tmp273;
      s1_ol_total := s1_#tmp274;
      goto s1_block157__ab;
    s1_block86__ab:
      s1_#tmp276 := Customer_C_BALANCE[s1_w_id][0][s1_c_id];
      s1_#tmp277 := s1_#tmp276 + s1_ol_total;
      Customer_C_BALANCE := Customer_C_BALANCE[s1_w_id := Customer_C_BALANCE[s1_w_id][0 := Customer_C_BALANCE[s1_w_id][0][s1_c_id := s1_#tmp277]]];
      s1_#tmp278 := Customer_C_DELIVERY_CNT[s1_w_id][0][s1_c_id];
      s1_#tmp279 := s1_#tmp278 + 1.0000000;
      Customer_C_DELIVERY_CNT := Customer_C_DELIVERY_CNT[s1_w_id := Customer_C_DELIVERY_CNT[s1_w_id][0 := Customer_C_DELIVERY_CNT[s1_w_id][0][s1_c_id := s1_#tmp279]]];
    ...
    s1_block157__ab:
      ...
      s1_#tmp272 := Order_Line_OL_AMOUNT[s1_w_id][0][s1_no_o_id][1];
      s1_#tmp273 := real(s1_#tmp272);
      s1_#tmp274 := s1_ol_total + s1_#tmp273;
      s1_ol_total := s1_#tmp274;
    ...
    s1_block158__ab:
      ...
      s1_#tmp272 := Order_Line_OL_AMOUNT[s1_w_id][0][s1_no_o_id][2];
      s1_#tmp273 := real(s1_#tmp272);
      s1_#tmp274 := s1_ol_total + s1_#tmp273;
      s1_ol_total := s1_#tmp274;
    ...
    s1_block159__ab:
      ...
      s1_#tmp272 := Order_Line_OL_AMOUNT[s1_w_id][0][s1_no_o_id][3];
      s1_#tmp273 := real(s1_#tmp272);
      s1_#tmp274 := s1_ol_total + s1_#tmp273;
      s1_ol_total := s1_#tmp274;
    ...
    s1_block160__ab:
      ...
      s1_#tmp272 := Order_Line_OL_AMOUNT[s1_w_id][0][s1_no_o_id][4];
      s1_#tmp273 := real(s1_#tmp272);
      s1_#tmp274 := s1_ol_total + s1_#tmp273;
      s1_ol_total := s1_#tmp274;
    ...
    s1_block161__ab:
      ...
      s1_#tmp272 := Order_Line_OL_AMOUNT[s1_w_id][0][s1_no_o_id][5];
      s1_#tmp273 := real(s1_#tmp272);
      s1_#tmp274 := s1_ol_total + s1_#tmp273;
      s1_ol_total := s1_#tmp274;
    ...
    s1_block162__ab:
      ...
      s1_#tmp272 := Order_Line_OL_AMOUNT[s1_w_id][0][s1_no_o_id][6];
      s1_#tmp273 := real(s1_#tmp272);
      s1_#tmp274 := s1_ol_total + s1_#tmp273;
      s1_ol_total := s1_#tmp274;
    ...
    s1_block163__ab:
      ...
      s1_#tmp272 := Order_Line_OL_AMOUNT[s1_w_id][0][s1_no_o_id][7];
      s1_#tmp273 := real(s1_#tmp272);
      s1_#tmp274 := s1_ol_total + s1_#tmp273;
      s1_ol_total := s1_#tmp274;
    ...
    s1_block164__ab:
      ...
      s1_#tmp272 := Order_Line_OL_AMOUNT[s1_w_id][0][s1_no_o_id][8];
      s1_#tmp273 := real(s1_#tmp272);
      s1_#tmp274 := s1_ol_total + s1_#tmp273;
      s1_ol_total := s1_#tmp274;
    ...
    s1_block165__ab:
      ...
      s1_#tmp272 := Order_Line_OL_AMOUNT[s1_w_id][0][s1_no_o_id][9];
      s1_#tmp273 := real(s1_#tmp272);
      s1_#tmp274 := s1_ol_total + s1_#tmp273;
      s1_ol_total := s1_#tmp274;
      goto s1_block86__ab;
