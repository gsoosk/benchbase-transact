...
modifies Customer_C_BALANCE, Customer_C_DELIVERY_CNT, District_D_NEXT_NO_ID, Order_Line_OL_AMOUNT, Order_Line_OL_DELIVERY_DATE, Order_O_CARRIER_ID, Order_O_C_ID;
{
  ...
  // Executing A then B:
    if (s0_active) {
    s0_block127__ab:
      s0_#tmp384 := District_D_NEXT_NO_ID[s0_w_id][9];
      s0_no_o_id := s0_#tmp384;
      s0_#tmp385 := s0_no_o_id + 1;
      District_D_NEXT_NO_ID := District_D_NEXT_NO_ID[s0_w_id := District_D_NEXT_NO_ID[s0_w_id][9 := s0_#tmp385]];
      s0_#tmp386 := Order_O_C_ID[s0_w_id][9][s0_no_o_id];
      s0_c_id := s0_#tmp386;
    ...
    s0_block128__ab:
      s0_#tmp388 := s0_ol_number < O_OL_CNT;
      if (s0_#tmp388) {
      goto s0_block129__ab;
    } else {
    ...
    s0_block129__ab:
      ...
      s0_#tmp389 := Order_Line_OL_AMOUNT[s0_w_id][9][s0_no_o_id][0];
      s0_#tmp390 := real(s0_#tmp389);
      s0_#tmp391 := 0.0000000 + s0_#tmp390;
      s0_ol_total := s0_#tmp391;
      goto s0_block238__ab;
    s0_block131__ab:
      s0_#tmp393 := Customer_C_BALANCE[s0_w_id][9][s0_c_id];
      s0_#tmp394 := s0_#tmp393 + s0_ol_total;
      Customer_C_BALANCE := Customer_C_BALANCE[s0_w_id := Customer_C_BALANCE[s0_w_id][9 := Customer_C_BALANCE[s0_w_id][9][s0_c_id := s0_#tmp394]]];
      s0_#tmp395 := Customer_C_DELIVERY_CNT[s0_w_id][9][s0_c_id];
      s0_#tmp396 := s0_#tmp395 + 1.0000000;
      Customer_C_DELIVERY_CNT := Customer_C_DELIVERY_CNT[s0_w_id := Customer_C_DELIVERY_CNT[s0_w_id][9 := Customer_C_DELIVERY_CNT[s0_w_id][9][s0_c_id := s0_#tmp396]]];
      s0_active := false;
    ...
    s0_block238__ab:
      ...
      s0_#tmp389 := Order_Line_OL_AMOUNT[s0_w_id][9][s0_no_o_id][1];
      s0_#tmp390 := real(s0_#tmp389);
      s0_#tmp391 := s0_ol_total + s0_#tmp390;
      s0_ol_total := s0_#tmp391;
    ...
    s0_block239__ab:
      ...
      s0_#tmp389 := Order_Line_OL_AMOUNT[s0_w_id][9][s0_no_o_id][2];
      s0_#tmp390 := real(s0_#tmp389);
      s0_#tmp391 := s0_ol_total + s0_#tmp390;
      s0_ol_total := s0_#tmp391;
    ...
    s0_block240__ab:
      ...
      s0_#tmp389 := Order_Line_OL_AMOUNT[s0_w_id][9][s0_no_o_id][3];
      s0_#tmp390 := real(s0_#tmp389);
      s0_#tmp391 := s0_ol_total + s0_#tmp390;
      s0_ol_total := s0_#tmp391;
    ...
    s0_block241__ab:
      ...
      s0_#tmp389 := Order_Line_OL_AMOUNT[s0_w_id][9][s0_no_o_id][4];
      s0_#tmp390 := real(s0_#tmp389);
      s0_#tmp391 := s0_ol_total + s0_#tmp390;
      s0_ol_total := s0_#tmp391;
    ...
    s0_block242__ab:
      ...
      s0_#tmp389 := Order_Line_OL_AMOUNT[s0_w_id][9][s0_no_o_id][5];
      s0_#tmp390 := real(s0_#tmp389);
      s0_#tmp391 := s0_ol_total + s0_#tmp390;
      s0_ol_total := s0_#tmp391;
    ...
    s0_block243__ab:
      ...
      s0_#tmp389 := Order_Line_OL_AMOUNT[s0_w_id][9][s0_no_o_id][6];
      s0_#tmp390 := real(s0_#tmp389);
      s0_#tmp391 := s0_ol_total + s0_#tmp390;
      s0_ol_total := s0_#tmp391;
    ...
    s0_block244__ab:
      ...
      s0_#tmp389 := Order_Line_OL_AMOUNT[s0_w_id][9][s0_no_o_id][7];
      s0_#tmp390 := real(s0_#tmp389);
      s0_#tmp391 := s0_ol_total + s0_#tmp390;
      s0_ol_total := s0_#tmp391;
    ...
    s0_block245__ab:
      ...
      s0_#tmp389 := Order_Line_OL_AMOUNT[s0_w_id][9][s0_no_o_id][8];
      s0_#tmp390 := real(s0_#tmp389);
      s0_#tmp391 := s0_ol_total + s0_#tmp390;
      s0_ol_total := s0_#tmp391;
    ...
    s0_block246__ab:
      ...
      s0_#tmp389 := Order_Line_OL_AMOUNT[s0_w_id][9][s0_no_o_id][9];
      s0_#tmp390 := real(s0_#tmp389);
      s0_#tmp391 := s0_ol_total + s0_#tmp390;
      s0_ol_total := s0_#tmp391;
      goto s0_block131__ab;
