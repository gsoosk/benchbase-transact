...
modifies Customer_C_BALANCE, Customer_C_CITY, Customer_C_CREDIT, Customer_C_CREDIT_LIMIT, Customer_C_DATA, Customer_C_DELIVERY_CNT, Customer_C_DISCOUNT, Customer_C_D_ID, Customer_C_FIRST, Customer_C_ID, Customer_C_LAST, Customer_C_MIDDLE, Customer_C_PAYMENT_CNT, Customer_C_PHONE, Customer_C_SINCE, Customer_C_STATE, Customer_C_STREET_1, Customer_C_STREET_2, Customer_C_W_ID, Customer_C_YTD_PAYMENT, Customer_C_ZIP, District_D_YTD, Warehouse_W_YTD;
{
  ...
  var s43_c_d_id : int;
  var s43_c_id : int;
  var s43_c#C_CITY : String;
  var s43_c#C_CREDIT : String;
  var s43_c#C_CREDIT_LIMIT : real;
  var s43_c#C_DATA : String;
  var s43_c#C_DELIVERY_CNT : real;
  var s43_c#C_DISCOUNT : real;
  var s43_c#C_D_ID : int;
  var s43_c#C_FIRST : String;
  var s43_c#C_ID : int;
  var s43_c#C_LAST : String;
  var s43_c#C_MIDDLE : String;
  var s43_c#C_PAYMENT_CNT : real;
  var s43_c#C_PHONE : String;
  var s43_c#C_SINCE : int;
  var s43_c#C_STATE : String;
  var s43_c#C_STREET_1 : String;
  var s43_c#C_STREET_2 : String;
