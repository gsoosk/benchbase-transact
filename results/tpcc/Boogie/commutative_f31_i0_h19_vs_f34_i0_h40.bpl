...
procedure Check_SliceCommut_Hop19_vs_Hop40()
modifies Item_I_PRICE, Stock_S_DATA, Stock_S_I_ID, Stock_S_ORDER_CNT, Stock_S_QUANTITY, Stock_S_REMOTE_CNT, Stock_S_W_ID, Stock_S_YTD;
{
  ...
  // Slice commutativity verification: hop 19 vs hop 40
  ...
  // Executing A then B:
    ...
    if (s1_active) {
    s1_block142__ab:
      s1_s#S_QUANTITY := Stock_S_QUANTITY[s1_w_id][s1_rep_i_id];
      s1_#tmp421 := s1_s#S_QUANTITY < s1_threshold;
      s1_low_stock := s1_#tmp421;
      s1_#tmp422 := to_unit(s1_low_stock);
      s1_active := false;
  ...
  // Verifying A->B === B->A equivalence:
    assert {:msg "(SpecialInterleavingNonEquivalence (node_1 (function_id . 31) (instance . 0) (hop_id . 19)) (node_2 (function_id . 34) (instance . 0) (hop_id . 40)))"} (((((((((((((((((Stock_S_DATA_a_then_b == Stock_S_DATA_b_then_a) && (Stock_S_I_ID_a_then_b == Stock_S_I_ID_b_then_a)) && (Stock_S_ORDER_CNT_a_then_b == Stock_S_ORDER_CNT_b_then_a)) && (Stock_S_QUANTITY_a_then_b == Stock_S_QUANTITY_b_then_a)) && (Stock_S_REMOTE_CNT_a_then_b == Stock_S_REMOTE_CNT_b_then_a)) && (Stock_S_W_ID_a_then_b == Stock_S_W_ID_b_then_a)) && (Stock_S_YTD_a_then_b == Stock_S_YTD_b_then_a)) && (s0_w_id_a_then_b == s0_w_id_b_then_a)) && (s0_d_id_a_then_b == s0_d_id_b_then_a)) && (s0_c_id_a_then_b == s0_c_id_b_then_a)) && (s0_o_all_local_a_then_b == s0_o_all_local_b_then_a)) && (s0_date_a_then_b == s0_date_b_then_a)) && (s0_itemIDs_a_then_b == s0_itemIDs_b_then_a)) && (s0_supplierWarehouseIDs_a_then_b == s0_supplierWarehouseIDs_b_then_a)) && (s0_orderQuantities_a_then_b == s0_orderQuantities_b_then_a)) && (s0_w_tax_a_then_b == s0_w_tax_b_then_a)) && (s0_prices_a_then_b == s0_prices_b_then_a));
}
