...
procedure Check_SliceCommut_Hop27_vs_Hop29()
modifies Customer_C_BALANCE, Customer_C_DELIVERY_CNT, District_D_NEXT_NO_ID, District_D_NEXT_O_ID, Order_Line_OL_AMOUNT, Order_Line_OL_DELIVERY_DATE, Order_Line_OL_I_ID, Order_Line_OL_QUANTITY, Order_Line_OL_SUPPLY_W_ID, Order_O_ALL_LOCAL, Order_O_CARRIER_ID, Order_O_C_ID, Order_O_ENTRY_DATE, Order_O_OL_CNT;
{
  ...
  // Slice commutativity verification: hop 27 vs hop 29
  ...
  // Executing A then B:
    ...
    if (s1_active) {
    s1_block87__ab:
      s1_#tmp281 := District_D_NEXT_NO_ID[s1_w_id][1];
      s1_no_o_id := s1_#tmp281;
      s1_#tmp282 := s1_no_o_id + 1;
      District_D_NEXT_NO_ID := District_D_NEXT_NO_ID[s1_w_id := District_D_NEXT_NO_ID[s1_w_id][1 := s1_#tmp282]];
      s1_#tmp283 := Order_O_C_ID[s1_w_id][1][s1_no_o_id];
      s1_c_id := s1_#tmp283;
      s1_#tmp284 := Order_O_OL_CNT[s1_w_id][1][s1_no_o_id];
      s1_ol_cnt := s1_#tmp284;
      s1_#tmp285 := to_unit(s1_ol_cnt);
      Order_O_CARRIER_ID := Order_O_CARRIER_ID[s1_w_id := Order_O_CARRIER_ID[s1_w_id][1 := Order_O_CARRIER_ID[s1_w_id][1][s1_no_o_id := s1_o_carrier_id]]];
      goto s1_block89__ab;
    s1_block88__ab:
      s1_#tmp286 := s1_ol_number < O_OL_CNT;
      if (s1_#tmp286) {
      goto s1_block89__ab;
    } else {
      goto s1_block91__ab;
    ...
    s1_block89__ab:
      Order_Line_OL_DELIVERY_DATE := Order_Line_OL_DELIVERY_DATE[s1_w_id := Order_Line_OL_DELIVERY_DATE[s1_w_id][1 := Order_Line_OL_DELIVERY_DATE[s1_w_id][1][s1_no_o_id := Order_Line_OL_DELIVERY_DATE[s1_w_id][1][s1_no_o_id][0 := s1_date]]]];
      s1_#tmp287 := Order_Line_OL_AMOUNT[s1_w_id][1][s1_no_o_id][0];
      s1_#tmp288 := real(s1_#tmp287);
      s1_#tmp289 := 0.0000000 + s1_#tmp288;
      s1_ol_total := s1_#tmp289;
      goto s1_block166__ab;
    s1_block91__ab:
      s1_#tmp291 := Customer_C_BALANCE[s1_w_id][1][s1_c_id];
      s1_#tmp292 := s1_#tmp291 + s1_ol_total;
      Customer_C_BALANCE := Customer_C_BALANCE[s1_w_id := Customer_C_BALANCE[s1_w_id][1 := Customer_C_BALANCE[s1_w_id][1][s1_c_id := s1_#tmp292]]];
      s1_#tmp293 := Customer_C_DELIVERY_CNT[s1_w_id][1][s1_c_id];
      s1_#tmp294 := s1_#tmp293 + 1.0000000;
      Customer_C_DELIVERY_CNT := Customer_C_DELIVERY_CNT[s1_w_id := Customer_C_DELIVERY_CNT[s1_w_id][1 := Customer_C_DELIVERY_CNT[s1_w_id][1][s1_c_id := s1_#tmp294]]];
      goto s1_hop_exit__ab;
    s1_block166__ab:
      Order_Line_OL_DELIVERY_DATE := Order_Line_OL_DELIVERY_DATE[s1_w_id := Order_Line_OL_DELIVERY_DATE[s1_w_id][1 := Order_Line_OL_DELIVERY_DATE[s1_w_id][1][s1_no_o_id := Order_Line_OL_DELIVERY_DATE[s1_w_id][1][s1_no_o_id][1 := s1_date]]]];
      s1_#tmp287 := Order_Line_OL_AMOUNT[s1_w_id][1][s1_no_o_id][1];
      s1_#tmp288 := real(s1_#tmp287);
      s1_#tmp289 := s1_ol_total + s1_#tmp288;
      s1_ol_total := s1_#tmp289;
      goto s1_block167__ab;
    s1_block167__ab:
      Order_Line_OL_DELIVERY_DATE := Order_Line_OL_DELIVERY_DATE[s1_w_id := Order_Line_OL_DELIVERY_DATE[s1_w_id][1 := Order_Line_OL_DELIVERY_DATE[s1_w_id][1][s1_no_o_id := Order_Line_OL_DELIVERY_DATE[s1_w_id][1][s1_no_o_id][2 := s1_date]]]];
      s1_#tmp287 := Order_Line_OL_AMOUNT[s1_w_id][1][s1_no_o_id][2];
      s1_#tmp288 := real(s1_#tmp287);
      s1_#tmp289 := s1_ol_total + s1_#tmp288;
      s1_ol_total := s1_#tmp289;
      goto s1_block168__ab;
    s1_block168__ab:
      Order_Line_OL_DELIVERY_DATE := Order_Line_OL_DELIVERY_DATE[s1_w_id := Order_Line_OL_DELIVERY_DATE[s1_w_id][1 := Order_Line_OL_DELIVERY_DATE[s1_w_id][1][s1_no_o_id := Order_Line_OL_DELIVERY_DATE[s1_w_id][1][s1_no_o_id][3 := s1_date]]]];
      s1_#tmp287 := Order_Line_OL_AMOUNT[s1_w_id][1][s1_no_o_id][3];
      s1_#tmp288 := real(s1_#tmp287);
      s1_#tmp289 := s1_ol_total + s1_#tmp288;
      s1_ol_total := s1_#tmp289;
      goto s1_block169__ab;
    s1_block169__ab:
      Order_Line_OL_DELIVERY_DATE := Order_Line_OL_DELIVERY_DATE[s1_w_id := Order_Line_OL_DELIVERY_DATE[s1_w_id][1 := Order_Line_OL_DELIVERY_DATE[s1_w_id][1][s1_no_o_id := Order_Line_OL_DELIVERY_DATE[s1_w_id][1][s1_no_o_id][4 := s1_date]]]];
      s1_#tmp287 := Order_Line_OL_AMOUNT[s1_w_id][1][s1_no_o_id][4];
      s1_#tmp288 := real(s1_#tmp287);
      s1_#tmp289 := s1_ol_total + s1_#tmp288;
      s1_ol_total := s1_#tmp289;
      goto s1_block170__ab;
    s1_block170__ab:
      Order_Line_OL_DELIVERY_DATE := Order_Line_OL_DELIVERY_DATE[s1_w_id := Order_Line_OL_DELIVERY_DATE[s1_w_id][1 := Order_Line_OL_DELIVERY_DATE[s1_w_id][1][s1_no_o_id := Order_Line_OL_DELIVERY_DATE[s1_w_id][1][s1_no_o_id][5 := s1_date]]]];
      s1_#tmp287 := Order_Line_OL_AMOUNT[s1_w_id][1][s1_no_o_id][5];
      s1_#tmp288 := real(s1_#tmp287);
      s1_#tmp289 := s1_ol_total + s1_#tmp288;
      s1_ol_total := s1_#tmp289;
      goto s1_block171__ab;
    s1_block171__ab:
      Order_Line_OL_DELIVERY_DATE := Order_Line_OL_DELIVERY_DATE[s1_w_id := Order_Line_OL_DELIVERY_DATE[s1_w_id][1 := Order_Line_OL_DELIVERY_DATE[s1_w_id][1][s1_no_o_id := Order_Line_OL_DELIVERY_DATE[s1_w_id][1][s1_no_o_id][6 := s1_date]]]];
      s1_#tmp287 := Order_Line_OL_AMOUNT[s1_w_id][1][s1_no_o_id][6];
      s1_#tmp288 := real(s1_#tmp287);
      s1_#tmp289 := s1_ol_total + s1_#tmp288;
      s1_ol_total := s1_#tmp289;
      goto s1_block172__ab;
    s1_block172__ab:
      Order_Line_OL_DELIVERY_DATE := Order_Line_OL_DELIVERY_DATE[s1_w_id := Order_Line_OL_DELIVERY_DATE[s1_w_id][1 := Order_Line_OL_DELIVERY_DATE[s1_w_id][1][s1_no_o_id := Order_Line_OL_DELIVERY_DATE[s1_w_id][1][s1_no_o_id][7 := s1_date]]]];
      s1_#tmp287 := Order_Line_OL_AMOUNT[s1_w_id][1][s1_no_o_id][7];
      s1_#tmp288 := real(s1_#tmp287);
      s1_#tmp289 := s1_ol_total + s1_#tmp288;
      s1_ol_total := s1_#tmp289;
      goto s1_block173__ab;
    s1_block173__ab:
      Order_Line_OL_DELIVERY_DATE := Order_Line_OL_DELIVERY_DATE[s1_w_id := Order_Line_OL_DELIVERY_DATE[s1_w_id][1 := Order_Line_OL_DELIVERY_DATE[s1_w_id][1][s1_no_o_id := Order_Line_OL_DELIVERY_DATE[s1_w_id][1][s1_no_o_id][8 := s1_date]]]];
      s1_#tmp287 := Order_Line_OL_AMOUNT[s1_w_id][1][s1_no_o_id][8];
      s1_#tmp288 := real(s1_#tmp287);
      s1_#tmp289 := s1_ol_total + s1_#tmp288;
      s1_ol_total := s1_#tmp289;
      goto s1_block174__ab;
    s1_block174__ab:
      Order_Line_OL_DELIVERY_DATE := Order_Line_OL_DELIVERY_DATE[s1_w_id := Order_Line_OL_DELIVERY_DATE[s1_w_id][1 := Order_Line_OL_DELIVERY_DATE[s1_w_id][1][s1_no_o_id := Order_Line_OL_DELIVERY_DATE[s1_w_id][1][s1_no_o_id][9 := s1_date]]]];
      s1_#tmp287 := Order_Line_OL_AMOUNT[s1_w_id][1][s1_no_o_id][9];
      s1_#tmp288 := real(s1_#tmp287);
      s1_#tmp289 := s1_ol_total + s1_#tmp288;
      s1_ol_total := s1_#tmp289;
      goto s1_block91__ab;
