...
modifies Customer_C_BALANCE, Customer_C_DELIVERY_CNT, District_D_NEXT_NO_ID, Order_Line_OL_AMOUNT, Order_Line_OL_DELIVERY_DATE, Order_O_CARRIER_ID, Order_O_C_ID;
{
  ...
  // Executing A then B:
    if (s0_active) {
    s0_block107__ab:
      s0_#tmp332 := District_D_NEXT_NO_ID[s0_w_id][5];
      s0_no_o_id := s0_#tmp332;
      s0_#tmp333 := s0_no_o_id + 1;
      District_D_NEXT_NO_ID := District_D_NEXT_NO_ID[s0_w_id := District_D_NEXT_NO_ID[s0_w_id][5 := s0_#tmp333]];
      s0_#tmp334 := Order_O_C_ID[s0_w_id][5][s0_no_o_id];
      s0_c_id := s0_#tmp334;
    ...
    s0_block108__ab:
      s0_#tmp336 := s0_ol_number < O_OL_CNT;
      if (s0_#tmp336) {
      goto s0_block109__ab;
    } else {
    ...
    s0_block109__ab:
      ...
      s0_#tmp337 := Order_Line_OL_AMOUNT[s0_w_id][5][s0_no_o_id][0];
      s0_#tmp338 := real(s0_#tmp337);
      s0_#tmp339 := 0.0000000 + s0_#tmp338;
      s0_ol_total := s0_#tmp339;
      goto s0_block202__ab;
    s0_block111__ab:
      s0_#tmp341 := Customer_C_BALANCE[s0_w_id][5][s0_c_id];
      s0_#tmp342 := s0_#tmp341 + s0_ol_total;
      Customer_C_BALANCE := Customer_C_BALANCE[s0_w_id := Customer_C_BALANCE[s0_w_id][5 := Customer_C_BALANCE[s0_w_id][5][s0_c_id := s0_#tmp342]]];
      s0_#tmp343 := Customer_C_DELIVERY_CNT[s0_w_id][5][s0_c_id];
      s0_#tmp344 := s0_#tmp343 + 1.0000000;
      Customer_C_DELIVERY_CNT := Customer_C_DELIVERY_CNT[s0_w_id := Customer_C_DELIVERY_CNT[s0_w_id][5 := Customer_C_DELIVERY_CNT[s0_w_id][5][s0_c_id := s0_#tmp344]]];
    ...
    s0_block202__ab:
      ...
      s0_#tmp337 := Order_Line_OL_AMOUNT[s0_w_id][5][s0_no_o_id][1];
      s0_#tmp338 := real(s0_#tmp337);
      s0_#tmp339 := s0_ol_total + s0_#tmp338;
      s0_ol_total := s0_#tmp339;
    ...
    s0_block203__ab:
      ...
      s0_#tmp337 := Order_Line_OL_AMOUNT[s0_w_id][5][s0_no_o_id][2];
      s0_#tmp338 := real(s0_#tmp337);
      s0_#tmp339 := s0_ol_total + s0_#tmp338;
      s0_ol_total := s0_#tmp339;
    ...
    s0_block204__ab:
      ...
      s0_#tmp337 := Order_Line_OL_AMOUNT[s0_w_id][5][s0_no_o_id][3];
      s0_#tmp338 := real(s0_#tmp337);
      s0_#tmp339 := s0_ol_total + s0_#tmp338;
      s0_ol_total := s0_#tmp339;
    ...
    s0_block205__ab:
      ...
      s0_#tmp337 := Order_Line_OL_AMOUNT[s0_w_id][5][s0_no_o_id][4];
      s0_#tmp338 := real(s0_#tmp337);
      s0_#tmp339 := s0_ol_total + s0_#tmp338;
      s0_ol_total := s0_#tmp339;
    ...
    s0_block206__ab:
      ...
      s0_#tmp337 := Order_Line_OL_AMOUNT[s0_w_id][5][s0_no_o_id][5];
      s0_#tmp338 := real(s0_#tmp337);
      s0_#tmp339 := s0_ol_total + s0_#tmp338;
      s0_ol_total := s0_#tmp339;
    ...
    s0_block207__ab:
      ...
      s0_#tmp337 := Order_Line_OL_AMOUNT[s0_w_id][5][s0_no_o_id][6];
      s0_#tmp338 := real(s0_#tmp337);
      s0_#tmp339 := s0_ol_total + s0_#tmp338;
      s0_ol_total := s0_#tmp339;
    ...
    s0_block208__ab:
      ...
      s0_#tmp337 := Order_Line_OL_AMOUNT[s0_w_id][5][s0_no_o_id][7];
      s0_#tmp338 := real(s0_#tmp337);
      s0_#tmp339 := s0_ol_total + s0_#tmp338;
      s0_ol_total := s0_#tmp339;
    ...
    s0_block209__ab:
      ...
      s0_#tmp337 := Order_Line_OL_AMOUNT[s0_w_id][5][s0_no_o_id][8];
      s0_#tmp338 := real(s0_#tmp337);
      s0_#tmp339 := s0_ol_total + s0_#tmp338;
      s0_ol_total := s0_#tmp339;
    ...
    s0_block210__ab:
      ...
      s0_#tmp337 := Order_Line_OL_AMOUNT[s0_w_id][5][s0_no_o_id][9];
      s0_#tmp338 := real(s0_#tmp337);
      s0_#tmp339 := s0_ol_total + s0_#tmp338;
      s0_ol_total := s0_#tmp339;
      goto s0_block111__ab;
