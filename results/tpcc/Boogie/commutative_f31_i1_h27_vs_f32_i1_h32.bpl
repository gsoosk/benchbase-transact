...
procedure Check_SliceCommut_Hop27_vs_Hop32()
modifies Customer_C_BALANCE, Customer_C_DELIVERY_CNT, District_D_NEXT_NO_ID, District_D_NEXT_O_ID, Order_Line_OL_AMOUNT, Order_Line_OL_DELIVERY_DATE, Order_Line_OL_I_ID, Order_Line_OL_QUANTITY, Order_Line_OL_SUPPLY_W_ID, Order_O_ALL_LOCAL, Order_O_CARRIER_ID, Order_O_C_ID, Order_O_ENTRY_DATE, Order_O_OL_CNT;
{
  ...
  // Slice commutativity verification: hop 27 vs hop 32
  ...
  // Executing A then B:
    ...
    if (s1_active) {
    s1_block102__ab:
      s1_#tmp323 := District_D_NEXT_NO_ID[s1_w_id][4];
      s1_no_o_id := s1_#tmp323;
      s1_#tmp324 := s1_no_o_id + 1;
      District_D_NEXT_NO_ID := District_D_NEXT_NO_ID[s1_w_id := District_D_NEXT_NO_ID[s1_w_id][4 := s1_#tmp324]];
      s1_#tmp325 := Order_O_C_ID[s1_w_id][4][s1_no_o_id];
      s1_c_id := s1_#tmp325;
      s1_#tmp326 := Order_O_OL_CNT[s1_w_id][4][s1_no_o_id];
      s1_ol_cnt := s1_#tmp326;
      s1_#tmp327 := to_unit(s1_ol_cnt);
      Order_O_CARRIER_ID := Order_O_CARRIER_ID[s1_w_id := Order_O_CARRIER_ID[s1_w_id][4 := Order_O_CARRIER_ID[s1_w_id][4][s1_no_o_id := s1_o_carrier_id]]];
      goto s1_block104__ab;
    s1_block103__ab:
      s1_#tmp328 := s1_ol_number < O_OL_CNT;
      if (s1_#tmp328) {
      goto s1_block104__ab;
    } else {
      goto s1_block106__ab;
    }
    s1_block104__ab:
      Order_Line_OL_DELIVERY_DATE := Order_Line_OL_DELIVERY_DATE[s1_w_id := Order_Line_OL_DELIVERY_DATE[s1_w_id][4 := Order_Line_OL_DELIVERY_DATE[s1_w_id][4][s1_no_o_id := Order_Line_OL_DELIVERY_DATE[s1_w_id][4][s1_no_o_id][0 := s1_date]]]];
      s1_#tmp329 := Order_Line_OL_AMOUNT[s1_w_id][4][s1_no_o_id][0];
      s1_#tmp330 := real(s1_#tmp329);
      s1_#tmp331 := 0.0000000 + s1_#tmp330;
      s1_ol_total := s1_#tmp331;
      goto s1_block193__ab;
    s1_block106__ab:
      s1_#tmp333 := Customer_C_BALANCE[s1_w_id][4][s1_c_id];
      s1_#tmp334 := s1_#tmp333 + s1_ol_total;
      Customer_C_BALANCE := Customer_C_BALANCE[s1_w_id := Customer_C_BALANCE[s1_w_id][4 := Customer_C_BALANCE[s1_w_id][4][s1_c_id := s1_#tmp334]]];
      s1_#tmp335 := Customer_C_DELIVERY_CNT[s1_w_id][4][s1_c_id];
      s1_#tmp336 := s1_#tmp335 + 1.0000000;
      Customer_C_DELIVERY_CNT := Customer_C_DELIVERY_CNT[s1_w_id := Customer_C_DELIVERY_CNT[s1_w_id][4 := Customer_C_DELIVERY_CNT[s1_w_id][4][s1_c_id := s1_#tmp336]]];
      goto s1_hop_exit__ab;
    s1_block193__ab:
      Order_Line_OL_DELIVERY_DATE := Order_Line_OL_DELIVERY_DATE[s1_w_id := Order_Line_OL_DELIVERY_DATE[s1_w_id][4 := Order_Line_OL_DELIVERY_DATE[s1_w_id][4][s1_no_o_id := Order_Line_OL_DELIVERY_DATE[s1_w_id][4][s1_no_o_id][1 := s1_date]]]];
      s1_#tmp329 := Order_Line_OL_AMOUNT[s1_w_id][4][s1_no_o_id][1];
      s1_#tmp330 := real(s1_#tmp329);
      s1_#tmp331 := s1_ol_total + s1_#tmp330;
      s1_ol_total := s1_#tmp331;
      goto s1_block194__ab;
    s1_block194__ab:
      Order_Line_OL_DELIVERY_DATE := Order_Line_OL_DELIVERY_DATE[s1_w_id := Order_Line_OL_DELIVERY_DATE[s1_w_id][4 := Order_Line_OL_DELIVERY_DATE[s1_w_id][4][s1_no_o_id := Order_Line_OL_DELIVERY_DATE[s1_w_id][4][s1_no_o_id][2 := s1_date]]]];
      s1_#tmp329 := Order_Line_OL_AMOUNT[s1_w_id][4][s1_no_o_id][2];
      s1_#tmp330 := real(s1_#tmp329);
      s1_#tmp331 := s1_ol_total + s1_#tmp330;
      s1_ol_total := s1_#tmp331;
      goto s1_block195__ab;
    s1_block195__ab:
      Order_Line_OL_DELIVERY_DATE := Order_Line_OL_DELIVERY_DATE[s1_w_id := Order_Line_OL_DELIVERY_DATE[s1_w_id][4 := Order_Line_OL_DELIVERY_DATE[s1_w_id][4][s1_no_o_id := Order_Line_OL_DELIVERY_DATE[s1_w_id][4][s1_no_o_id][3 := s1_date]]]];
      s1_#tmp329 := Order_Line_OL_AMOUNT[s1_w_id][4][s1_no_o_id][3];
      s1_#tmp330 := real(s1_#tmp329);
      s1_#tmp331 := s1_ol_total + s1_#tmp330;
      s1_ol_total := s1_#tmp331;
      goto s1_block196__ab;
    s1_block196__ab:
      Order_Line_OL_DELIVERY_DATE := Order_Line_OL_DELIVERY_DATE[s1_w_id := Order_Line_OL_DELIVERY_DATE[s1_w_id][4 := Order_Line_OL_DELIVERY_DATE[s1_w_id][4][s1_no_o_id := Order_Line_OL_DELIVERY_DATE[s1_w_id][4][s1_no_o_id][4 := s1_date]]]];
      s1_#tmp329 := Order_Line_OL_AMOUNT[s1_w_id][4][s1_no_o_id][4];
      s1_#tmp330 := real(s1_#tmp329);
      s1_#tmp331 := s1_ol_total + s1_#tmp330;
      s1_ol_total := s1_#tmp331;
      goto s1_block197__ab;
    s1_block197__ab:
      Order_Line_OL_DELIVERY_DATE := Order_Line_OL_DELIVERY_DATE[s1_w_id := Order_Line_OL_DELIVERY_DATE[s1_w_id][4 := Order_Line_OL_DELIVERY_DATE[s1_w_id][4][s1_no_o_id := Order_Line_OL_DELIVERY_DATE[s1_w_id][4][s1_no_o_id][5 := s1_date]]]];
      s1_#tmp329 := Order_Line_OL_AMOUNT[s1_w_id][4][s1_no_o_id][5];
      s1_#tmp330 := real(s1_#tmp329);
      s1_#tmp331 := s1_ol_total + s1_#tmp330;
      s1_ol_total := s1_#tmp331;
      goto s1_block198__ab;
    s1_block198__ab:
      Order_Line_OL_DELIVERY_DATE := Order_Line_OL_DELIVERY_DATE[s1_w_id := Order_Line_OL_DELIVERY_DATE[s1_w_id][4 := Order_Line_OL_DELIVERY_DATE[s1_w_id][4][s1_no_o_id := Order_Line_OL_DELIVERY_DATE[s1_w_id][4][s1_no_o_id][6 := s1_date]]]];
      s1_#tmp329 := Order_Line_OL_AMOUNT[s1_w_id][4][s1_no_o_id][6];
      s1_#tmp330 := real(s1_#tmp329);
      s1_#tmp331 := s1_ol_total + s1_#tmp330;
      s1_ol_total := s1_#tmp331;
      goto s1_block199__ab;
    s1_block199__ab:
      Order_Line_OL_DELIVERY_DATE := Order_Line_OL_DELIVERY_DATE[s1_w_id := Order_Line_OL_DELIVERY_DATE[s1_w_id][4 := Order_Line_OL_DELIVERY_DATE[s1_w_id][4][s1_no_o_id := Order_Line_OL_DELIVERY_DATE[s1_w_id][4][s1_no_o_id][7 := s1_date]]]];
      s1_#tmp329 := Order_Line_OL_AMOUNT[s1_w_id][4][s1_no_o_id][7];
      s1_#tmp330 := real(s1_#tmp329);
      s1_#tmp331 := s1_ol_total + s1_#tmp330;
      s1_ol_total := s1_#tmp331;
      goto s1_block200__ab;
    s1_block200__ab:
      Order_Line_OL_DELIVERY_DATE := Order_Line_OL_DELIVERY_DATE[s1_w_id := Order_Line_OL_DELIVERY_DATE[s1_w_id][4 := Order_Line_OL_DELIVERY_DATE[s1_w_id][4][s1_no_o_id := Order_Line_OL_DELIVERY_DATE[s1_w_id][4][s1_no_o_id][8 := s1_date]]]];
      s1_#tmp329 := Order_Line_OL_AMOUNT[s1_w_id][4][s1_no_o_id][8];
      s1_#tmp330 := real(s1_#tmp329);
      s1_#tmp331 := s1_ol_total + s1_#tmp330;
      s1_ol_total := s1_#tmp331;
      goto s1_block201__ab;
    s1_block201__ab:
      Order_Line_OL_DELIVERY_DATE := Order_Line_OL_DELIVERY_DATE[s1_w_id := Order_Line_OL_DELIVERY_DATE[s1_w_id][4 := Order_Line_OL_DELIVERY_DATE[s1_w_id][4][s1_no_o_id := Order_Line_OL_DELIVERY_DATE[s1_w_id][4][s1_no_o_id][9 := s1_date]]]];
      s1_#tmp329 := Order_Line_OL_AMOUNT[s1_w_id][4][s1_no_o_id][9];
      s1_#tmp330 := real(s1_#tmp329);
      s1_#tmp331 := s1_ol_total + s1_#tmp330;
      s1_ol_total := s1_#tmp331;
      goto s1_block106__ab;
  ...
  // Executing B then A:
    ...
    s1_block102__ba:
      ...
      s1_#tmp327 := to_unit(s1_ol_cnt);
      Order_O_CARRIER_ID := Order_O_CARRIER_ID[s1_w_id := Order_O_CARRIER_ID[s1_w_id][4 := Order_O_CARRIER_ID[s1_w_id][4][s1_no_o_id := s1_o_carrier_id]]];
      goto s1_block104__ba;
    s1_block103__ba:
      s1_#tmp328 := s1_ol_number < O_OL_CNT;
      if (s1_#tmp328) {
      goto s1_block104__ba;
    } else {
      goto s1_block106__ba;
    }
    s1_block104__ba:
      Order_Line_OL_DELIVERY_DATE := Order_Line_OL_DELIVERY_DATE[s1_w_id := Order_Line_OL_DELIVERY_DATE[s1_w_id][4 := Order_Line_OL_DELIVERY_DATE[s1_w_id][4][s1_no_o_id := Order_Line_OL_DELIVERY_DATE[s1_w_id][4][s1_no_o_id][0 := s1_date]]]];
      s1_#tmp329 := Order_Line_OL_AMOUNT[s1_w_id][4][s1_no_o_id][0];
