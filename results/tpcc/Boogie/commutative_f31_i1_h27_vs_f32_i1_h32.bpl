...
modifies Customer_C_BALANCE, Customer_C_DELIVERY_CNT, District_D_NEXT_NO_ID, District_D_NEXT_O_ID, Order_Line_OL_AMOUNT, Order_Line_OL_DELIVERY_DATE, Order_Line_OL_I_ID, Order_Line_OL_QUANTITY, Order_Line_OL_SUPPLY_W_ID, Order_O_ALL_LOCAL, Order_O_CARRIER_ID, Order_O_C_ID, Order_O_ENTRY_DATE, Order_O_OL_CNT;
{
  ...
  // Executing A then B:
    ...
    if (s1_active) {
    s1_block102__ab:
      s1_#tmp319 := District_D_NEXT_NO_ID[s1_w_id][4];
      s1_no_o_id := s1_#tmp319;
      s1_#tmp320 := s1_no_o_id + 1;
      District_D_NEXT_NO_ID := District_D_NEXT_NO_ID[s1_w_id := District_D_NEXT_NO_ID[s1_w_id][4 := s1_#tmp320]];
      s1_#tmp321 := Order_O_C_ID[s1_w_id][4][s1_no_o_id];
      s1_c_id := s1_#tmp321;
    ...
    s1_block103__ab:
      s1_#tmp323 := s1_ol_number < O_OL_CNT;
      if (s1_#tmp323) {
      goto s1_block104__ab;
    } else {
    ...
    s1_block104__ab:
      ...
      s1_#tmp324 := Order_Line_OL_AMOUNT[s1_w_id][4][s1_no_o_id][0];
      s1_#tmp325 := real(s1_#tmp324);
      s1_#tmp326 := 0.0000000 + s1_#tmp325;
      s1_ol_total := s1_#tmp326;
      goto s1_block193__ab;
    s1_block106__ab:
      s1_#tmp328 := Customer_C_BALANCE[s1_w_id][4][s1_c_id];
      s1_#tmp329 := s1_#tmp328 + s1_ol_total;
      Customer_C_BALANCE := Customer_C_BALANCE[s1_w_id := Customer_C_BALANCE[s1_w_id][4 := Customer_C_BALANCE[s1_w_id][4][s1_c_id := s1_#tmp329]]];
      s1_#tmp330 := Customer_C_DELIVERY_CNT[s1_w_id][4][s1_c_id];
      s1_#tmp331 := s1_#tmp330 + 1.0000000;
      Customer_C_DELIVERY_CNT := Customer_C_DELIVERY_CNT[s1_w_id := Customer_C_DELIVERY_CNT[s1_w_id][4 := Customer_C_DELIVERY_CNT[s1_w_id][4][s1_c_id := s1_#tmp331]]];
    ...
    s1_block193__ab:
      ...
      s1_#tmp324 := Order_Line_OL_AMOUNT[s1_w_id][4][s1_no_o_id][1];
      s1_#tmp325 := real(s1_#tmp324);
      s1_#tmp326 := s1_ol_total + s1_#tmp325;
      s1_ol_total := s1_#tmp326;
    ...
    s1_block194__ab:
      ...
      s1_#tmp324 := Order_Line_OL_AMOUNT[s1_w_id][4][s1_no_o_id][2];
      s1_#tmp325 := real(s1_#tmp324);
      s1_#tmp326 := s1_ol_total + s1_#tmp325;
      s1_ol_total := s1_#tmp326;
    ...
    s1_block195__ab:
      ...
      s1_#tmp324 := Order_Line_OL_AMOUNT[s1_w_id][4][s1_no_o_id][3];
      s1_#tmp325 := real(s1_#tmp324);
      s1_#tmp326 := s1_ol_total + s1_#tmp325;
      s1_ol_total := s1_#tmp326;
    ...
    s1_block196__ab:
      ...
      s1_#tmp324 := Order_Line_OL_AMOUNT[s1_w_id][4][s1_no_o_id][4];
      s1_#tmp325 := real(s1_#tmp324);
      s1_#tmp326 := s1_ol_total + s1_#tmp325;
      s1_ol_total := s1_#tmp326;
    ...
    s1_block197__ab:
      ...
      s1_#tmp324 := Order_Line_OL_AMOUNT[s1_w_id][4][s1_no_o_id][5];
      s1_#tmp325 := real(s1_#tmp324);
      s1_#tmp326 := s1_ol_total + s1_#tmp325;
      s1_ol_total := s1_#tmp326;
    ...
    s1_block198__ab:
      ...
      s1_#tmp324 := Order_Line_OL_AMOUNT[s1_w_id][4][s1_no_o_id][6];
      s1_#tmp325 := real(s1_#tmp324);
      s1_#tmp326 := s1_ol_total + s1_#tmp325;
      s1_ol_total := s1_#tmp326;
    ...
    s1_block199__ab:
      ...
      s1_#tmp324 := Order_Line_OL_AMOUNT[s1_w_id][4][s1_no_o_id][7];
      s1_#tmp325 := real(s1_#tmp324);
      s1_#tmp326 := s1_ol_total + s1_#tmp325;
      s1_ol_total := s1_#tmp326;
    ...
    s1_block200__ab:
      ...
      s1_#tmp324 := Order_Line_OL_AMOUNT[s1_w_id][4][s1_no_o_id][8];
      s1_#tmp325 := real(s1_#tmp324);
      s1_#tmp326 := s1_ol_total + s1_#tmp325;
      s1_ol_total := s1_#tmp326;
    ...
    s1_block201__ab:
      ...
      s1_#tmp324 := Order_Line_OL_AMOUNT[s1_w_id][4][s1_no_o_id][9];
      s1_#tmp325 := real(s1_#tmp324);
      s1_#tmp326 := s1_ol_total + s1_#tmp325;
      s1_ol_total := s1_#tmp326;
      goto s1_block106__ab;
