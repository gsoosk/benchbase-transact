...
const L_BC : String;
procedure Check_SliceCommut_Hop43_vs_Hop43()
modifies Customer_C_BALANCE, Customer_C_CITY, Customer_C_CREDIT, Customer_C_CREDIT_LIMIT, Customer_C_DATA, Customer_C_DELIVERY_CNT, Customer_C_DISCOUNT, Customer_C_D_ID, Customer_C_FIRST, Customer_C_ID, Customer_C_LAST, Customer_C_MIDDLE, Customer_C_PAYMENT_CNT, Customer_C_PHONE, Customer_C_SINCE, Customer_C_STATE, Customer_C_STREET_1, Customer_C_STREET_2, Customer_C_W_ID, Customer_C_YTD_PAYMENT, Customer_C_ZIP;
{
  var s0_w_id : int;
  var s0_d_id : int;
  var s0_c_w_id : int;
  ...
  var s0_c_w_id_init : int;
  var s0_c_d_id_init : int;
  ...
  var s0_c#C_BALANCE : real;
  var s0_c#C_CITY : String;
  var s0_c#C_CREDIT : String;
  var s0_c#C_CREDIT_LIMIT : real;
  var s0_c#C_DATA : String;
  var s0_c#C_DELIVERY_CNT : real;
  var s0_c#C_DISCOUNT : real;
  var s0_c#C_D_ID : int;
  var s0_c#C_FIRST : String;
  var s0_c#C_ID : int;
  var s0_c#C_LAST : String;
  var s0_c#C_MIDDLE : String;
  var s0_c#C_PAYMENT_CNT : real;
  var s0_c#C_PHONE : String;
  var s0_c#C_SINCE : int;
  var s0_c#C_STATE : String;
  var s0_c#C_STREET_1 : String;
  var s0_c#C_STREET_2 : String;
  var s0_c#C_W_ID : int;
  var s0_c#C_YTD_PAYMENT : real;
  var s0_c#C_ZIP : String;
  var s0_#tmp413 : real;
  var s0_#tmp414 : real;
  var s0_#tmp415 : real;
  var s0_#tmp416 : bool;
  var s0_#tmp417 : String;
  var s0_#tmp418 : String;
  var s0_#tmp419 : String;
  var s0_#tmp420 : String;
  var s0_#tmp421 : String;
  var s0_#tmp422 : String;
  var s0_#tmp423 : String;
  var s0_#tmp424 : String;
  var s0_#tmp425 : String;
  var s0_#tmp426 : String;
  var s0_#tmp427 : String;
  var s0_#tmp428 : String;
  var s0_#tmp429 : String;
  var s0_#tmp430 : String;
  var s0_#tmp431 : String;
  var s0_#tmp432 : String;
  var s0_#tmp433 : String;
  var s0_#tmp434 : String;
  ...
  var s1_#tmp415 : real;
  var s1_#tmp416 : bool;
  var s1_#tmp417 : String;
  var s1_#tmp418 : String;
  var s1_#tmp419 : String;
  var s1_#tmp420 : String;
  var s1_#tmp421 : String;
  var s1_#tmp422 : String;
  var s1_#tmp423 : String;
  var s1_#tmp424 : String;
  var s1_#tmp425 : String;
  var s1_#tmp426 : String;
  var s1_#tmp427 : String;
  var s1_#tmp428 : String;
  var s1_#tmp429 : String;
  var s1_#tmp430 : String;
  var s1_#tmp431 : String;
  ...
  // Slice commutativity verification: hop 43 vs hop 43
  ...
  // --- Step 2: Save initial state ---
    ...
    s0_c_w_id_init := s0_c_w_id;
    s0_c_d_id_init := s0_c_d_id;
  ...
  // Executing A then B:
    if (s0_active) {
    s0_block145__ab:
      s0_c#C_BALANCE := Customer_C_BALANCE[s0_c_w_id][s0_c_d_id][s0_c_id];
      s0_c#C_CITY := Customer_C_CITY[s0_c_w_id][s0_c_d_id][s0_c_id];
      s0_c#C_CREDIT := Customer_C_CREDIT[s0_c_w_id][s0_c_d_id][s0_c_id];
      s0_c#C_CREDIT_LIMIT := Customer_C_CREDIT_LIMIT[s0_c_w_id][s0_c_d_id][s0_c_id];
      s0_c#C_DATA := Customer_C_DATA[s0_c_w_id][s0_c_d_id][s0_c_id];
      s0_c#C_DELIVERY_CNT := Customer_C_DELIVERY_CNT[s0_c_w_id][s0_c_d_id][s0_c_id];
      s0_c#C_DISCOUNT := Customer_C_DISCOUNT[s0_c_w_id][s0_c_d_id][s0_c_id];
      s0_c#C_D_ID := Customer_C_D_ID[s0_c_w_id][s0_c_d_id][s0_c_id];
      s0_c#C_FIRST := Customer_C_FIRST[s0_c_w_id][s0_c_d_id][s0_c_id];
      s0_c#C_ID := Customer_C_ID[s0_c_w_id][s0_c_d_id][s0_c_id];
      s0_c#C_LAST := Customer_C_LAST[s0_c_w_id][s0_c_d_id][s0_c_id];
      s0_c#C_MIDDLE := Customer_C_MIDDLE[s0_c_w_id][s0_c_d_id][s0_c_id];
      s0_c#C_PAYMENT_CNT := Customer_C_PAYMENT_CNT[s0_c_w_id][s0_c_d_id][s0_c_id];
      s0_c#C_PHONE := Customer_C_PHONE[s0_c_w_id][s0_c_d_id][s0_c_id];
      s0_c#C_SINCE := Customer_C_SINCE[s0_c_w_id][s0_c_d_id][s0_c_id];
      s0_c#C_STATE := Customer_C_STATE[s0_c_w_id][s0_c_d_id][s0_c_id];
      s0_c#C_STREET_1 := Customer_C_STREET_1[s0_c_w_id][s0_c_d_id][s0_c_id];
      s0_c#C_STREET_2 := Customer_C_STREET_2[s0_c_w_id][s0_c_d_id][s0_c_id];
      s0_c#C_W_ID := Customer_C_W_ID[s0_c_w_id][s0_c_d_id][s0_c_id];
      s0_c#C_YTD_PAYMENT := Customer_C_YTD_PAYMENT[s0_c_w_id][s0_c_d_id][s0_c_id];
      s0_c#C_ZIP := Customer_C_ZIP[s0_c_w_id][s0_c_d_id][s0_c_id];
      s0_#tmp413 := s0_c#C_BALANCE - s0_amount;
      s0_c#C_BALANCE := s0_#tmp413;
      s0_#tmp414 := s0_c#C_YTD_PAYMENT + s0_amount;
      s0_c#C_YTD_PAYMENT := s0_#tmp414;
      s0_#tmp415 := s0_c#C_PAYMENT_CNT + 1.0000000;
      s0_c#C_PAYMENT_CNT := s0_#tmp415;
      s0_#tmp416 := s0_c#C_CREDIT == L_BC;
      if (s0_#tmp416) {
      goto s0_block146__ab;
    } else {
      goto s0_block147__ab;
    }
    s0_block146__ab:
      s0_#tmp417 := str(s0_c#C_ID);
      s0_#tmp418 := concat(s0_#tmp417, L_$u0020);
      s0_#tmp419 := str(s0_c#C_D_ID);
      s0_#tmp420 := concat(s0_#tmp418, s0_#tmp419);
      s0_#tmp421 := concat(s0_#tmp420, L_$u0020);
      s0_#tmp422 := str(s0_c#C_W_ID);
      s0_#tmp423 := concat(s0_#tmp421, s0_#tmp422);
      s0_#tmp424 := concat(s0_#tmp423, L_$u0020);
      s0_#tmp425 := str(s0_d_id);
      s0_#tmp426 := concat(s0_#tmp424, s0_#tmp425);
      s0_#tmp427 := concat(s0_#tmp426, L_$u0020);
      s0_#tmp428 := str(s0_w_id);
      s0_#tmp429 := concat(s0_#tmp427, s0_#tmp428);
      s0_#tmp430 := concat(s0_#tmp429, L_$u0020);
      s0_#tmp431 := str(s0_amount);
      s0_#tmp432 := concat(s0_#tmp430, s0_#tmp431);
      s0_#tmp433 := concat(s0_#tmp432, L_$u0020$u007C$u0020);
      s0_#tmp434 := concat(s0_#tmp433, s0_c#C_DATA);
      s0_c#C_DATA := s0_#tmp434;
      goto s0_block147__ab;
    s0_block147__ab:
      Customer_C_BALANCE := Customer_C_BALANCE[s0_c_w_id := Customer_C_BALANCE[s0_c_w_id][s0_c_d_id := Customer_C_BALANCE[s0_c_w_id][s0_c_d_id][s0_c_id := s0_c#C_BALANCE]]];
      Customer_C_CITY := Customer_C_CITY[s0_c_w_id := Customer_C_CITY[s0_c_w_id][s0_c_d_id := Customer_C_CITY[s0_c_w_id][s0_c_d_id][s0_c_id := s0_c#C_CITY]]];
      Customer_C_CREDIT := Customer_C_CREDIT[s0_c_w_id := Customer_C_CREDIT[s0_c_w_id][s0_c_d_id := Customer_C_CREDIT[s0_c_w_id][s0_c_d_id][s0_c_id := s0_c#C_CREDIT]]];
      Customer_C_CREDIT_LIMIT := Customer_C_CREDIT_LIMIT[s0_c_w_id := Customer_C_CREDIT_LIMIT[s0_c_w_id][s0_c_d_id := Customer_C_CREDIT_LIMIT[s0_c_w_id][s0_c_d_id][s0_c_id := s0_c#C_CREDIT_LIMIT]]];
      Customer_C_DATA := Customer_C_DATA[s0_c_w_id := Customer_C_DATA[s0_c_w_id][s0_c_d_id := Customer_C_DATA[s0_c_w_id][s0_c_d_id][s0_c_id := s0_c#C_DATA]]];
      Customer_C_DELIVERY_CNT := Customer_C_DELIVERY_CNT[s0_c_w_id := Customer_C_DELIVERY_CNT[s0_c_w_id][s0_c_d_id := Customer_C_DELIVERY_CNT[s0_c_w_id][s0_c_d_id][s0_c_id := s0_c#C_DELIVERY_CNT]]];
      Customer_C_DISCOUNT := Customer_C_DISCOUNT[s0_c_w_id := Customer_C_DISCOUNT[s0_c_w_id][s0_c_d_id := Customer_C_DISCOUNT[s0_c_w_id][s0_c_d_id][s0_c_id := s0_c#C_DISCOUNT]]];
      Customer_C_D_ID := Customer_C_D_ID[s0_c_w_id := Customer_C_D_ID[s0_c_w_id][s0_c_d_id := Customer_C_D_ID[s0_c_w_id][s0_c_d_id][s0_c_id := s0_c#C_D_ID]]];
      Customer_C_FIRST := Customer_C_FIRST[s0_c_w_id := Customer_C_FIRST[s0_c_w_id][s0_c_d_id := Customer_C_FIRST[s0_c_w_id][s0_c_d_id][s0_c_id := s0_c#C_FIRST]]];
      Customer_C_ID := Customer_C_ID[s0_c_w_id := Customer_C_ID[s0_c_w_id][s0_c_d_id := Customer_C_ID[s0_c_w_id][s0_c_d_id][s0_c_id := s0_c#C_ID]]];
      Customer_C_LAST := Customer_C_LAST[s0_c_w_id := Customer_C_LAST[s0_c_w_id][s0_c_d_id := Customer_C_LAST[s0_c_w_id][s0_c_d_id][s0_c_id := s0_c#C_LAST]]];
      Customer_C_MIDDLE := Customer_C_MIDDLE[s0_c_w_id := Customer_C_MIDDLE[s0_c_w_id][s0_c_d_id := Customer_C_MIDDLE[s0_c_w_id][s0_c_d_id][s0_c_id := s0_c#C_MIDDLE]]];
      Customer_C_PAYMENT_CNT := Customer_C_PAYMENT_CNT[s0_c_w_id := Customer_C_PAYMENT_CNT[s0_c_w_id][s0_c_d_id := Customer_C_PAYMENT_CNT[s0_c_w_id][s0_c_d_id][s0_c_id := s0_c#C_PAYMENT_CNT]]];
      Customer_C_PHONE := Customer_C_PHONE[s0_c_w_id := Customer_C_PHONE[s0_c_w_id][s0_c_d_id := Customer_C_PHONE[s0_c_w_id][s0_c_d_id][s0_c_id := s0_c#C_PHONE]]];
      Customer_C_SINCE := Customer_C_SINCE[s0_c_w_id := Customer_C_SINCE[s0_c_w_id][s0_c_d_id := Customer_C_SINCE[s0_c_w_id][s0_c_d_id][s0_c_id := s0_c#C_SINCE]]];
      Customer_C_STATE := Customer_C_STATE[s0_c_w_id := Customer_C_STATE[s0_c_w_id][s0_c_d_id := Customer_C_STATE[s0_c_w_id][s0_c_d_id][s0_c_id := s0_c#C_STATE]]];
      Customer_C_STREET_1 := Customer_C_STREET_1[s0_c_w_id := Customer_C_STREET_1[s0_c_w_id][s0_c_d_id := Customer_C_STREET_1[s0_c_w_id][s0_c_d_id][s0_c_id := s0_c#C_STREET_1]]];
      Customer_C_STREET_2 := Customer_C_STREET_2[s0_c_w_id := Customer_C_STREET_2[s0_c_w_id][s0_c_d_id := Customer_C_STREET_2[s0_c_w_id][s0_c_d_id][s0_c_id := s0_c#C_STREET_2]]];
      Customer_C_W_ID := Customer_C_W_ID[s0_c_w_id := Customer_C_W_ID[s0_c_w_id][s0_c_d_id := Customer_C_W_ID[s0_c_w_id][s0_c_d_id][s0_c_id := s0_c#C_W_ID]]];
      Customer_C_YTD_PAYMENT := Customer_C_YTD_PAYMENT[s0_c_w_id := Customer_C_YTD_PAYMENT[s0_c_w_id][s0_c_d_id := Customer_C_YTD_PAYMENT[s0_c_w_id][s0_c_d_id][s0_c_id := s0_c#C_YTD_PAYMENT]]];
      Customer_C_ZIP := Customer_C_ZIP[s0_c_w_id := Customer_C_ZIP[s0_c_w_id][s0_c_d_id := Customer_C_ZIP[s0_c_w_id][s0_c_d_id][s0_c_id := s0_c#C_ZIP]]];
      s0_active := false;
    ...
    s1_block145__ab:
      ...
      s1_#tmp413 := s1_c#C_BALANCE - s1_amount;
      s1_c#C_BALANCE := s1_#tmp413;
      s1_#tmp414 := s1_c#C_YTD_PAYMENT + s1_amount;
      s1_c#C_YTD_PAYMENT := s1_#tmp414;
      s1_#tmp415 := s1_c#C_PAYMENT_CNT + 1.0000000;
      s1_c#C_PAYMENT_CNT := s1_#tmp415;
      s1_#tmp416 := s1_c#C_CREDIT == L_BC;
      if (s1_#tmp416) {
    ...
    s1_block146__ab:
      s1_#tmp417 := str(s1_c#C_ID);
      s1_#tmp418 := concat(s1_#tmp417, L_$u0020);
      s1_#tmp419 := str(s1_c#C_D_ID);
      s1_#tmp420 := concat(s1_#tmp418, s1_#tmp419);
      s1_#tmp421 := concat(s1_#tmp420, L_$u0020);
      s1_#tmp422 := str(s1_c#C_W_ID);
      s1_#tmp423 := concat(s1_#tmp421, s1_#tmp422);
      s1_#tmp424 := concat(s1_#tmp423, L_$u0020);
      s1_#tmp425 := str(s1_d_id);
      s1_#tmp426 := concat(s1_#tmp424, s1_#tmp425);
      s1_#tmp427 := concat(s1_#tmp426, L_$u0020);
      s1_#tmp428 := str(s1_w_id);
      s1_#tmp429 := concat(s1_#tmp427, s1_#tmp428);
      s1_#tmp430 := concat(s1_#tmp429, L_$u0020);
      s1_#tmp431 := str(s1_amount);
      s1_#tmp432 := concat(s1_#tmp430, s1_#tmp431);
      s1_#tmp433 := concat(s1_#tmp432, L_$u0020$u007C$u0020);
      s1_#tmp434 := concat(s1_#tmp433, s1_c#C_DATA);
      s1_c#C_DATA := s1_#tmp434;
      goto s1_block147__ab;
    s1_block147__ab:
  ...
  // Restoring initial state:
    ...
    s0_c_w_id := s0_c_w_id_init;
    s0_c_d_id := s0_c_d_id_init;
  ...
  // Executing B then A:
    ...
    s0_block145__ba:
      ...
      s0_#tmp416 := s0_c#C_CREDIT == L_BC;
      if (s0_#tmp416) {
      goto s0_block146__ba;
    } else {
      goto s0_block147__ba;
    }
    s0_block146__ba:
      s0_#tmp417 := str(s0_c#C_ID);
      s0_#tmp418 := concat(s0_#tmp417, L_$u0020);
