...
modifies Customer_C_BALANCE, Customer_C_CITY, Customer_C_CREDIT, Customer_C_CREDIT_LIMIT, Customer_C_DATA, Customer_C_DELIVERY_CNT, Customer_C_DISCOUNT, Customer_C_D_ID, Customer_C_FIRST, Customer_C_ID, Customer_C_LAST, Customer_C_MIDDLE, Customer_C_PAYMENT_CNT, Customer_C_PHONE, Customer_C_SINCE, Customer_C_STATE, Customer_C_STREET_1, Customer_C_STREET_2, Customer_C_W_ID, Customer_C_YTD_PAYMENT, Customer_C_ZIP;
{
  ...
  var s0_#tmp435 : String;
  var s0_#tmp436 : String;
  var s0_#tmp437 : String;
  var s0_#tmp438 : String;
  var s0_#tmp439 : String;
  var s0_#tmp440 : String;
  var s0_#tmp441 : String;
  var s0_#tmp442 : String;
  var s0_#tmp443 : String;
  var s0_#tmp444 : String;
  var s0_#tmp445 : String;
  var s0_#tmp446 : String;
  var s0_#tmp447 : String;
  var s0_#tmp448 : String;
  var s0_#tmp449 : String;
  ...
  // Executing A then B:
    ...
    s0_block145__ab:
      ...
      s0_#tmp428 := s0_c#C_BALANCE - s0_amount;
      s0_c#C_BALANCE := s0_#tmp428;
      s0_#tmp429 := s0_c#C_YTD_PAYMENT + s0_amount;
      s0_c#C_YTD_PAYMENT := s0_#tmp429;
      s0_#tmp430 := s0_c#C_PAYMENT_CNT + 1.0000000;
      s0_c#C_PAYMENT_CNT := s0_#tmp430;
      s0_#tmp431 := s0_c#C_CREDIT == L_BC;
      if (s0_#tmp431) {
    ...
    s0_block146__ab:
      s0_#tmp432 := str(s0_c#C_ID);
      s0_#tmp433 := concat(s0_#tmp432, L_$u0020);
      s0_#tmp434 := str(s0_c#C_D_ID);
      s0_#tmp435 := concat(s0_#tmp433, s0_#tmp434);
      s0_#tmp436 := concat(s0_#tmp435, L_$u0020);
      s0_#tmp437 := str(s0_c#C_W_ID);
      s0_#tmp438 := concat(s0_#tmp436, s0_#tmp437);
      s0_#tmp439 := concat(s0_#tmp438, L_$u0020);
      s0_#tmp440 := str(s0_d_id);
      s0_#tmp441 := concat(s0_#tmp439, s0_#tmp440);
      s0_#tmp442 := concat(s0_#tmp441, L_$u0020);
      s0_#tmp443 := str(s0_w_id);
      s0_#tmp444 := concat(s0_#tmp442, s0_#tmp443);
      s0_#tmp445 := concat(s0_#tmp444, L_$u0020);
      s0_#tmp446 := str(s0_amount);
      s0_#tmp447 := concat(s0_#tmp445, s0_#tmp446);
      s0_#tmp448 := concat(s0_#tmp447, L_$u0020$u007C$u0020);
      s0_#tmp449 := concat(s0_#tmp448, s0_c#C_DATA);
      s0_c#C_DATA := s0_#tmp449;
      goto s0_block147__ab;
    s0_block147__ab:
