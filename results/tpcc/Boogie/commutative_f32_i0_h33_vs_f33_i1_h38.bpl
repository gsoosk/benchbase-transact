...
procedure Check_SliceCommut_Hop33_vs_Hop38()
modifies Customer_C_BALANCE, Customer_C_CITY, Customer_C_CREDIT, Customer_C_CREDIT_LIMIT, Customer_C_DATA, Customer_C_DELIVERY_CNT, Customer_C_DISCOUNT, Customer_C_FIRST, Customer_C_LAST, Customer_C_MIDDLE, Customer_C_PAYMENT_CNT, Customer_C_PHONE, Customer_C_SINCE, Customer_C_STATE, Customer_C_STREET_1, Customer_C_STREET_2, Customer_C_YTD_PAYMENT, Customer_C_ZIP, District_D_NEXT_NO_ID, Order_Line_OL_AMOUNT, Order_Line_OL_DELIVERY_DATE, Order_Line_OL_DIST_INTO, Order_Line_OL_I_ID, Order_Line_OL_QUANTITY, Order_Line_OL_SUPPLY_W_ID, Order_O_ALL_LOCAL, Order_O_CARRIER_ID, Order_O_C_ID, Order_O_ENTRY_DATE, Order_O_OL_CNT;
{
  ...
  // Slice commutativity verification: hop 33 vs hop 38
  ...
  // Executing A then B:
    if (s0_active) {
    s0_block107__ab:
      s0_#tmp337 := District_D_NEXT_NO_ID[s0_w_id][5];
      s0_no_o_id := s0_#tmp337;
      s0_#tmp338 := s0_no_o_id + 1;
      District_D_NEXT_NO_ID := District_D_NEXT_NO_ID[s0_w_id := District_D_NEXT_NO_ID[s0_w_id][5 := s0_#tmp338]];
      s0_#tmp339 := Order_O_C_ID[s0_w_id][5][s0_no_o_id];
      s0_c_id := s0_#tmp339;
      s0_#tmp340 := Order_O_OL_CNT[s0_w_id][5][s0_no_o_id];
      s0_ol_cnt := s0_#tmp340;
      s0_#tmp341 := to_unit(s0_ol_cnt);
      Order_O_CARRIER_ID := Order_O_CARRIER_ID[s0_w_id := Order_O_CARRIER_ID[s0_w_id][5 := Order_O_CARRIER_ID[s0_w_id][5][s0_no_o_id := s0_o_carrier_id]]];
      goto s0_block109__ab;
    s0_block108__ab:
      s0_#tmp342 := s0_ol_number < O_OL_CNT;
      if (s0_#tmp342) {
      goto s0_block109__ab;
    } else {
      goto s0_block111__ab;
    }
    s0_block109__ab:
      Order_Line_OL_DELIVERY_DATE := Order_Line_OL_DELIVERY_DATE[s0_w_id := Order_Line_OL_DELIVERY_DATE[s0_w_id][5 := Order_Line_OL_DELIVERY_DATE[s0_w_id][5][s0_no_o_id := Order_Line_OL_DELIVERY_DATE[s0_w_id][5][s0_no_o_id][0 := s0_date]]]];
      s0_#tmp343 := Order_Line_OL_AMOUNT[s0_w_id][5][s0_no_o_id][0];
      s0_#tmp344 := real(s0_#tmp343);
      s0_#tmp345 := 0.0000000 + s0_#tmp344;
      s0_ol_total := s0_#tmp345;
      goto s0_block202__ab;
    s0_block111__ab:
      s0_#tmp347 := Customer_C_BALANCE[s0_w_id][5][s0_c_id];
      s0_#tmp348 := s0_#tmp347 + s0_ol_total;
      Customer_C_BALANCE := Customer_C_BALANCE[s0_w_id := Customer_C_BALANCE[s0_w_id][5 := Customer_C_BALANCE[s0_w_id][5][s0_c_id := s0_#tmp348]]];
      s0_#tmp349 := Customer_C_DELIVERY_CNT[s0_w_id][5][s0_c_id];
      s0_#tmp350 := s0_#tmp349 + 1.0000000;
      Customer_C_DELIVERY_CNT := Customer_C_DELIVERY_CNT[s0_w_id := Customer_C_DELIVERY_CNT[s0_w_id][5 := Customer_C_DELIVERY_CNT[s0_w_id][5][s0_c_id := s0_#tmp350]]];
      goto s0_hop_exit__ab;
    s0_block202__ab:
      Order_Line_OL_DELIVERY_DATE := Order_Line_OL_DELIVERY_DATE[s0_w_id := Order_Line_OL_DELIVERY_DATE[s0_w_id][5 := Order_Line_OL_DELIVERY_DATE[s0_w_id][5][s0_no_o_id := Order_Line_OL_DELIVERY_DATE[s0_w_id][5][s0_no_o_id][1 := s0_date]]]];
      s0_#tmp343 := Order_Line_OL_AMOUNT[s0_w_id][5][s0_no_o_id][1];
      s0_#tmp344 := real(s0_#tmp343);
      s0_#tmp345 := s0_ol_total + s0_#tmp344;
      s0_ol_total := s0_#tmp345;
      goto s0_block203__ab;
    s0_block203__ab:
      Order_Line_OL_DELIVERY_DATE := Order_Line_OL_DELIVERY_DATE[s0_w_id := Order_Line_OL_DELIVERY_DATE[s0_w_id][5 := Order_Line_OL_DELIVERY_DATE[s0_w_id][5][s0_no_o_id := Order_Line_OL_DELIVERY_DATE[s0_w_id][5][s0_no_o_id][2 := s0_date]]]];
      s0_#tmp343 := Order_Line_OL_AMOUNT[s0_w_id][5][s0_no_o_id][2];
      s0_#tmp344 := real(s0_#tmp343);
      s0_#tmp345 := s0_ol_total + s0_#tmp344;
      s0_ol_total := s0_#tmp345;
      goto s0_block204__ab;
    s0_block204__ab:
      Order_Line_OL_DELIVERY_DATE := Order_Line_OL_DELIVERY_DATE[s0_w_id := Order_Line_OL_DELIVERY_DATE[s0_w_id][5 := Order_Line_OL_DELIVERY_DATE[s0_w_id][5][s0_no_o_id := Order_Line_OL_DELIVERY_DATE[s0_w_id][5][s0_no_o_id][3 := s0_date]]]];
      s0_#tmp343 := Order_Line_OL_AMOUNT[s0_w_id][5][s0_no_o_id][3];
      s0_#tmp344 := real(s0_#tmp343);
      s0_#tmp345 := s0_ol_total + s0_#tmp344;
      s0_ol_total := s0_#tmp345;
      goto s0_block205__ab;
    s0_block205__ab:
      Order_Line_OL_DELIVERY_DATE := Order_Line_OL_DELIVERY_DATE[s0_w_id := Order_Line_OL_DELIVERY_DATE[s0_w_id][5 := Order_Line_OL_DELIVERY_DATE[s0_w_id][5][s0_no_o_id := Order_Line_OL_DELIVERY_DATE[s0_w_id][5][s0_no_o_id][4 := s0_date]]]];
      s0_#tmp343 := Order_Line_OL_AMOUNT[s0_w_id][5][s0_no_o_id][4];
      s0_#tmp344 := real(s0_#tmp343);
      s0_#tmp345 := s0_ol_total + s0_#tmp344;
      s0_ol_total := s0_#tmp345;
      goto s0_block206__ab;
    s0_block206__ab:
      Order_Line_OL_DELIVERY_DATE := Order_Line_OL_DELIVERY_DATE[s0_w_id := Order_Line_OL_DELIVERY_DATE[s0_w_id][5 := Order_Line_OL_DELIVERY_DATE[s0_w_id][5][s0_no_o_id := Order_Line_OL_DELIVERY_DATE[s0_w_id][5][s0_no_o_id][5 := s0_date]]]];
      s0_#tmp343 := Order_Line_OL_AMOUNT[s0_w_id][5][s0_no_o_id][5];
      s0_#tmp344 := real(s0_#tmp343);
      s0_#tmp345 := s0_ol_total + s0_#tmp344;
      s0_ol_total := s0_#tmp345;
      goto s0_block207__ab;
    s0_block207__ab:
      Order_Line_OL_DELIVERY_DATE := Order_Line_OL_DELIVERY_DATE[s0_w_id := Order_Line_OL_DELIVERY_DATE[s0_w_id][5 := Order_Line_OL_DELIVERY_DATE[s0_w_id][5][s0_no_o_id := Order_Line_OL_DELIVERY_DATE[s0_w_id][5][s0_no_o_id][6 := s0_date]]]];
      s0_#tmp343 := Order_Line_OL_AMOUNT[s0_w_id][5][s0_no_o_id][6];
      s0_#tmp344 := real(s0_#tmp343);
      s0_#tmp345 := s0_ol_total + s0_#tmp344;
      s0_ol_total := s0_#tmp345;
      goto s0_block208__ab;
    s0_block208__ab:
      Order_Line_OL_DELIVERY_DATE := Order_Line_OL_DELIVERY_DATE[s0_w_id := Order_Line_OL_DELIVERY_DATE[s0_w_id][5 := Order_Line_OL_DELIVERY_DATE[s0_w_id][5][s0_no_o_id := Order_Line_OL_DELIVERY_DATE[s0_w_id][5][s0_no_o_id][7 := s0_date]]]];
      s0_#tmp343 := Order_Line_OL_AMOUNT[s0_w_id][5][s0_no_o_id][7];
      s0_#tmp344 := real(s0_#tmp343);
      s0_#tmp345 := s0_ol_total + s0_#tmp344;
      s0_ol_total := s0_#tmp345;
      goto s0_block209__ab;
    s0_block209__ab:
      Order_Line_OL_DELIVERY_DATE := Order_Line_OL_DELIVERY_DATE[s0_w_id := Order_Line_OL_DELIVERY_DATE[s0_w_id][5 := Order_Line_OL_DELIVERY_DATE[s0_w_id][5][s0_no_o_id := Order_Line_OL_DELIVERY_DATE[s0_w_id][5][s0_no_o_id][8 := s0_date]]]];
      s0_#tmp343 := Order_Line_OL_AMOUNT[s0_w_id][5][s0_no_o_id][8];
      s0_#tmp344 := real(s0_#tmp343);
      s0_#tmp345 := s0_ol_total + s0_#tmp344;
      s0_ol_total := s0_#tmp345;
      goto s0_block210__ab;
    s0_block210__ab:
      Order_Line_OL_DELIVERY_DATE := Order_Line_OL_DELIVERY_DATE[s0_w_id := Order_Line_OL_DELIVERY_DATE[s0_w_id][5 := Order_Line_OL_DELIVERY_DATE[s0_w_id][5][s0_no_o_id := Order_Line_OL_DELIVERY_DATE[s0_w_id][5][s0_no_o_id][9 := s0_date]]]];
      s0_#tmp343 := Order_Line_OL_AMOUNT[s0_w_id][5][s0_no_o_id][9];
      s0_#tmp344 := real(s0_#tmp343);
      s0_#tmp345 := s0_ol_total + s0_#tmp344;
      s0_ol_total := s0_#tmp345;
      goto s0_block111__ab;
  ...
  // Executing B then A:
    ...
    s0_block107__ba:
      ...
      s0_#tmp341 := to_unit(s0_ol_cnt);
      Order_O_CARRIER_ID := Order_O_CARRIER_ID[s0_w_id := Order_O_CARRIER_ID[s0_w_id][5 := Order_O_CARRIER_ID[s0_w_id][5][s0_no_o_id := s0_o_carrier_id]]];
      goto s0_block109__ba;
    s0_block108__ba:
      s0_#tmp342 := s0_ol_number < O_OL_CNT;
      if (s0_#tmp342) {
      goto s0_block109__ba;
    } else {
      goto s0_block111__ba;
    }
    s0_block109__ba:
      Order_Line_OL_DELIVERY_DATE := Order_Line_OL_DELIVERY_DATE[s0_w_id := Order_Line_OL_DELIVERY_DATE[s0_w_id][5 := Order_Line_OL_DELIVERY_DATE[s0_w_id][5][s0_no_o_id := Order_Line_OL_DELIVERY_DATE[s0_w_id][5][s0_no_o_id][0 := s0_date]]]];
      s0_#tmp343 := Order_Line_OL_AMOUNT[s0_w_id][5][s0_no_o_id][0];
