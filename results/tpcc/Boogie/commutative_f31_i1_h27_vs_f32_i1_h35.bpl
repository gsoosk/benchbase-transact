...
modifies Customer_C_BALANCE, Customer_C_DELIVERY_CNT, District_D_NEXT_NO_ID, District_D_NEXT_O_ID, Order_Line_OL_AMOUNT, Order_Line_OL_DELIVERY_DATE, Order_Line_OL_I_ID, Order_Line_OL_QUANTITY, Order_Line_OL_SUPPLY_W_ID, Order_O_ALL_LOCAL, Order_O_CARRIER_ID, Order_O_C_ID, Order_O_ENTRY_DATE, Order_O_OL_CNT;
{
  ...
  // Executing A then B:
    ...
    if (s1_active) {
    s1_block117__ab:
      s1_#tmp358 := District_D_NEXT_NO_ID[s1_w_id][7];
      s1_no_o_id := s1_#tmp358;
      s1_#tmp359 := s1_no_o_id + 1;
      District_D_NEXT_NO_ID := District_D_NEXT_NO_ID[s1_w_id := District_D_NEXT_NO_ID[s1_w_id][7 := s1_#tmp359]];
      s1_#tmp360 := Order_O_C_ID[s1_w_id][7][s1_no_o_id];
      s1_c_id := s1_#tmp360;
    ...
    s1_block118__ab:
      s1_#tmp362 := s1_ol_number < O_OL_CNT;
      if (s1_#tmp362) {
      goto s1_block119__ab;
    } else {
    ...
    s1_block119__ab:
      ...
      s1_#tmp363 := Order_Line_OL_AMOUNT[s1_w_id][7][s1_no_o_id][0];
      s1_#tmp364 := real(s1_#tmp363);
      s1_#tmp365 := 0.0000000 + s1_#tmp364;
      s1_ol_total := s1_#tmp365;
      goto s1_block220__ab;
    s1_block121__ab:
      s1_#tmp367 := Customer_C_BALANCE[s1_w_id][7][s1_c_id];
      s1_#tmp368 := s1_#tmp367 + s1_ol_total;
      Customer_C_BALANCE := Customer_C_BALANCE[s1_w_id := Customer_C_BALANCE[s1_w_id][7 := Customer_C_BALANCE[s1_w_id][7][s1_c_id := s1_#tmp368]]];
      s1_#tmp369 := Customer_C_DELIVERY_CNT[s1_w_id][7][s1_c_id];
      s1_#tmp370 := s1_#tmp369 + 1.0000000;
      Customer_C_DELIVERY_CNT := Customer_C_DELIVERY_CNT[s1_w_id := Customer_C_DELIVERY_CNT[s1_w_id][7 := Customer_C_DELIVERY_CNT[s1_w_id][7][s1_c_id := s1_#tmp370]]];
    ...
    s1_block220__ab:
      ...
      s1_#tmp363 := Order_Line_OL_AMOUNT[s1_w_id][7][s1_no_o_id][1];
      s1_#tmp364 := real(s1_#tmp363);
      s1_#tmp365 := s1_ol_total + s1_#tmp364;
      s1_ol_total := s1_#tmp365;
    ...
    s1_block221__ab:
      ...
      s1_#tmp363 := Order_Line_OL_AMOUNT[s1_w_id][7][s1_no_o_id][2];
      s1_#tmp364 := real(s1_#tmp363);
      s1_#tmp365 := s1_ol_total + s1_#tmp364;
      s1_ol_total := s1_#tmp365;
    ...
    s1_block222__ab:
      ...
      s1_#tmp363 := Order_Line_OL_AMOUNT[s1_w_id][7][s1_no_o_id][3];
      s1_#tmp364 := real(s1_#tmp363);
      s1_#tmp365 := s1_ol_total + s1_#tmp364;
      s1_ol_total := s1_#tmp365;
    ...
    s1_block223__ab:
      ...
      s1_#tmp363 := Order_Line_OL_AMOUNT[s1_w_id][7][s1_no_o_id][4];
      s1_#tmp364 := real(s1_#tmp363);
      s1_#tmp365 := s1_ol_total + s1_#tmp364;
      s1_ol_total := s1_#tmp365;
    ...
    s1_block224__ab:
      ...
      s1_#tmp363 := Order_Line_OL_AMOUNT[s1_w_id][7][s1_no_o_id][5];
      s1_#tmp364 := real(s1_#tmp363);
      s1_#tmp365 := s1_ol_total + s1_#tmp364;
      s1_ol_total := s1_#tmp365;
    ...
    s1_block225__ab:
      ...
      s1_#tmp363 := Order_Line_OL_AMOUNT[s1_w_id][7][s1_no_o_id][6];
      s1_#tmp364 := real(s1_#tmp363);
      s1_#tmp365 := s1_ol_total + s1_#tmp364;
      s1_ol_total := s1_#tmp365;
    ...
    s1_block226__ab:
      ...
      s1_#tmp363 := Order_Line_OL_AMOUNT[s1_w_id][7][s1_no_o_id][7];
      s1_#tmp364 := real(s1_#tmp363);
      s1_#tmp365 := s1_ol_total + s1_#tmp364;
      s1_ol_total := s1_#tmp365;
    ...
    s1_block227__ab:
      ...
      s1_#tmp363 := Order_Line_OL_AMOUNT[s1_w_id][7][s1_no_o_id][8];
      s1_#tmp364 := real(s1_#tmp363);
      s1_#tmp365 := s1_ol_total + s1_#tmp364;
      s1_ol_total := s1_#tmp365;
    ...
    s1_block228__ab:
      ...
      s1_#tmp363 := Order_Line_OL_AMOUNT[s1_w_id][7][s1_no_o_id][9];
      s1_#tmp364 := real(s1_#tmp363);
      s1_#tmp365 := s1_ol_total + s1_#tmp364;
      s1_ol_total := s1_#tmp365;
      goto s1_block121__ab;
