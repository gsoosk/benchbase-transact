...
procedure Check_SliceCommut_Hop35_vs_Hop37()
modifies Customer_C_BALANCE, Customer_C_DELIVERY_CNT, District_D_NEXT_NO_ID, Order_Line_OL_AMOUNT, Order_Line_OL_DELIVERY_DATE, Order_O_CARRIER_ID, Order_O_C_ID;
{
  ...
  // Slice commutativity verification: hop 35 vs hop 37
  ...
  // Executing A then B:
    if (s0_active) {
    s0_block117__ab:
      s0_#tmp358 := District_D_NEXT_NO_ID[s0_w_id][7];
      s0_no_o_id := s0_#tmp358;
      s0_#tmp359 := s0_no_o_id + 1;
      District_D_NEXT_NO_ID := District_D_NEXT_NO_ID[s0_w_id := District_D_NEXT_NO_ID[s0_w_id][7 := s0_#tmp359]];
      s0_#tmp360 := Order_O_C_ID[s0_w_id][7][s0_no_o_id];
      s0_c_id := s0_#tmp360;
    ...
    s0_block118__ab:
      s0_#tmp362 := s0_ol_number < O_OL_CNT;
      if (s0_#tmp362) {
      goto s0_block119__ab;
    } else {
    ...
    s0_block119__ab:
      ...
      s0_#tmp363 := Order_Line_OL_AMOUNT[s0_w_id][7][s0_no_o_id][0];
      s0_#tmp364 := real(s0_#tmp363);
      s0_#tmp365 := 0.0000000 + s0_#tmp364;
      s0_ol_total := s0_#tmp365;
      goto s0_block220__ab;
    s0_block121__ab:
      s0_#tmp367 := Customer_C_BALANCE[s0_w_id][7][s0_c_id];
      s0_#tmp368 := s0_#tmp367 + s0_ol_total;
      Customer_C_BALANCE := Customer_C_BALANCE[s0_w_id := Customer_C_BALANCE[s0_w_id][7 := Customer_C_BALANCE[s0_w_id][7][s0_c_id := s0_#tmp368]]];
      s0_#tmp369 := Customer_C_DELIVERY_CNT[s0_w_id][7][s0_c_id];
      s0_#tmp370 := s0_#tmp369 + 1.0000000;
      Customer_C_DELIVERY_CNT := Customer_C_DELIVERY_CNT[s0_w_id := Customer_C_DELIVERY_CNT[s0_w_id][7 := Customer_C_DELIVERY_CNT[s0_w_id][7][s0_c_id := s0_#tmp370]]];
    ...
    s0_block220__ab:
      ...
      s0_#tmp363 := Order_Line_OL_AMOUNT[s0_w_id][7][s0_no_o_id][1];
      s0_#tmp364 := real(s0_#tmp363);
      s0_#tmp365 := s0_ol_total + s0_#tmp364;
      s0_ol_total := s0_#tmp365;
    ...
    s0_block221__ab:
      ...
      s0_#tmp363 := Order_Line_OL_AMOUNT[s0_w_id][7][s0_no_o_id][2];
      s0_#tmp364 := real(s0_#tmp363);
      s0_#tmp365 := s0_ol_total + s0_#tmp364;
      s0_ol_total := s0_#tmp365;
    ...
    s0_block222__ab:
      ...
      s0_#tmp363 := Order_Line_OL_AMOUNT[s0_w_id][7][s0_no_o_id][3];
      s0_#tmp364 := real(s0_#tmp363);
      s0_#tmp365 := s0_ol_total + s0_#tmp364;
      s0_ol_total := s0_#tmp365;
    ...
    s0_block223__ab:
      ...
      s0_#tmp363 := Order_Line_OL_AMOUNT[s0_w_id][7][s0_no_o_id][4];
      s0_#tmp364 := real(s0_#tmp363);
      s0_#tmp365 := s0_ol_total + s0_#tmp364;
      s0_ol_total := s0_#tmp365;
    ...
    s0_block224__ab:
      ...
      s0_#tmp363 := Order_Line_OL_AMOUNT[s0_w_id][7][s0_no_o_id][5];
      s0_#tmp364 := real(s0_#tmp363);
      s0_#tmp365 := s0_ol_total + s0_#tmp364;
      s0_ol_total := s0_#tmp365;
    ...
    s0_block225__ab:
      ...
      s0_#tmp363 := Order_Line_OL_AMOUNT[s0_w_id][7][s0_no_o_id][6];
      s0_#tmp364 := real(s0_#tmp363);
      s0_#tmp365 := s0_ol_total + s0_#tmp364;
      s0_ol_total := s0_#tmp365;
    ...
    s0_block226__ab:
      ...
      s0_#tmp363 := Order_Line_OL_AMOUNT[s0_w_id][7][s0_no_o_id][7];
      s0_#tmp364 := real(s0_#tmp363);
      s0_#tmp365 := s0_ol_total + s0_#tmp364;
      s0_ol_total := s0_#tmp365;
    ...
    s0_block227__ab:
      ...
      s0_#tmp363 := Order_Line_OL_AMOUNT[s0_w_id][7][s0_no_o_id][8];
      s0_#tmp364 := real(s0_#tmp363);
      s0_#tmp365 := s0_ol_total + s0_#tmp364;
      s0_ol_total := s0_#tmp365;
    ...
    s0_block228__ab:
      ...
      s0_#tmp363 := Order_Line_OL_AMOUNT[s0_w_id][7][s0_no_o_id][9];
      s0_#tmp364 := real(s0_#tmp363);
      s0_#tmp365 := s0_ol_total + s0_#tmp364;
      s0_ol_total := s0_#tmp365;
      goto s0_block121__ab;
