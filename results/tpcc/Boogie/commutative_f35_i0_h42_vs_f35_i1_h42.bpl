...
modifies District_D_YTD;
{
  ...
  // Executing A then B:
    if (s0_active) {
    s0_block144__ab:
      s0_#tmp410 := District_D_YTD[s0_w_id][s0_d_id];
      s0_#tmp411 := s0_#tmp410 + s0_amount;
      District_D_YTD := District_D_YTD[s0_w_id := District_D_YTD[s0_w_id][s0_d_id := s0_#tmp411]];
      goto s0_hop_exit__ab;
    s0_hop_exit__ab:
    }
    if (s1_active) {
    s1_block144__ab:
      s1_#tmp410 := District_D_YTD[s1_w_id][s1_d_id];
      s1_#tmp411 := s1_#tmp410 + s1_amount;
      District_D_YTD := District_D_YTD[s1_w_id := District_D_YTD[s1_w_id][s1_d_id := s1_#tmp411]];
