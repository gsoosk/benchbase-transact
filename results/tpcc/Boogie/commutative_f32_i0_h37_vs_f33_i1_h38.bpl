...
procedure Check_SliceCommut_Hop37_vs_Hop38()
modifies Customer_C_BALANCE, Customer_C_CITY, Customer_C_CREDIT, Customer_C_CREDIT_LIMIT, Customer_C_DATA, Customer_C_DELIVERY_CNT, Customer_C_DISCOUNT, Customer_C_FIRST, Customer_C_LAST, Customer_C_MIDDLE, Customer_C_PAYMENT_CNT, Customer_C_PHONE, Customer_C_SINCE, Customer_C_STATE, Customer_C_STREET_1, Customer_C_STREET_2, Customer_C_YTD_PAYMENT, Customer_C_ZIP, District_D_NEXT_NO_ID, Order_Line_OL_AMOUNT, Order_Line_OL_DELIVERY_DATE, Order_Line_OL_DIST_INTO, Order_Line_OL_I_ID, Order_Line_OL_QUANTITY, Order_Line_OL_SUPPLY_W_ID, Order_O_ALL_LOCAL, Order_O_CARRIER_ID, Order_O_C_ID, Order_O_ENTRY_DATE, Order_O_OL_CNT;
{
  ...
  // Slice commutativity verification: hop 37 vs hop 38
  ...
  // Executing A then B:
    if (s0_active) {
    s0_block127__ab:
      s0_#tmp393 := District_D_NEXT_NO_ID[s0_w_id][9];
      s0_no_o_id := s0_#tmp393;
      s0_#tmp394 := s0_no_o_id + 1;
      District_D_NEXT_NO_ID := District_D_NEXT_NO_ID[s0_w_id := District_D_NEXT_NO_ID[s0_w_id][9 := s0_#tmp394]];
      s0_#tmp395 := Order_O_C_ID[s0_w_id][9][s0_no_o_id];
      s0_c_id := s0_#tmp395;
      s0_#tmp396 := Order_O_OL_CNT[s0_w_id][9][s0_no_o_id];
      s0_ol_cnt := s0_#tmp396;
      s0_#tmp397 := to_unit(s0_ol_cnt);
      Order_O_CARRIER_ID := Order_O_CARRIER_ID[s0_w_id := Order_O_CARRIER_ID[s0_w_id][9 := Order_O_CARRIER_ID[s0_w_id][9][s0_no_o_id := s0_o_carrier_id]]];
      goto s0_block129__ab;
    s0_block128__ab:
      s0_#tmp398 := s0_ol_number < O_OL_CNT;
      if (s0_#tmp398) {
      goto s0_block129__ab;
    } else {
      goto s0_block131__ab;
    }
    s0_block129__ab:
      Order_Line_OL_DELIVERY_DATE := Order_Line_OL_DELIVERY_DATE[s0_w_id := Order_Line_OL_DELIVERY_DATE[s0_w_id][9 := Order_Line_OL_DELIVERY_DATE[s0_w_id][9][s0_no_o_id := Order_Line_OL_DELIVERY_DATE[s0_w_id][9][s0_no_o_id][0 := s0_date]]]];
      s0_#tmp399 := Order_Line_OL_AMOUNT[s0_w_id][9][s0_no_o_id][0];
      s0_#tmp400 := real(s0_#tmp399);
      s0_#tmp401 := 0.0000000 + s0_#tmp400;
      s0_ol_total := s0_#tmp401;
      goto s0_block238__ab;
    s0_block131__ab:
      s0_#tmp403 := Customer_C_BALANCE[s0_w_id][9][s0_c_id];
      s0_#tmp404 := s0_#tmp403 + s0_ol_total;
      Customer_C_BALANCE := Customer_C_BALANCE[s0_w_id := Customer_C_BALANCE[s0_w_id][9 := Customer_C_BALANCE[s0_w_id][9][s0_c_id := s0_#tmp404]]];
      s0_#tmp405 := Customer_C_DELIVERY_CNT[s0_w_id][9][s0_c_id];
      s0_#tmp406 := s0_#tmp405 + 1.0000000;
      Customer_C_DELIVERY_CNT := Customer_C_DELIVERY_CNT[s0_w_id := Customer_C_DELIVERY_CNT[s0_w_id][9 := Customer_C_DELIVERY_CNT[s0_w_id][9][s0_c_id := s0_#tmp406]]];
      s0_active := false;
      goto s0_hop_exit__ab;
    s0_block238__ab:
      Order_Line_OL_DELIVERY_DATE := Order_Line_OL_DELIVERY_DATE[s0_w_id := Order_Line_OL_DELIVERY_DATE[s0_w_id][9 := Order_Line_OL_DELIVERY_DATE[s0_w_id][9][s0_no_o_id := Order_Line_OL_DELIVERY_DATE[s0_w_id][9][s0_no_o_id][1 := s0_date]]]];
      s0_#tmp399 := Order_Line_OL_AMOUNT[s0_w_id][9][s0_no_o_id][1];
      s0_#tmp400 := real(s0_#tmp399);
      s0_#tmp401 := s0_ol_total + s0_#tmp400;
      s0_ol_total := s0_#tmp401;
      goto s0_block239__ab;
    s0_block239__ab:
      Order_Line_OL_DELIVERY_DATE := Order_Line_OL_DELIVERY_DATE[s0_w_id := Order_Line_OL_DELIVERY_DATE[s0_w_id][9 := Order_Line_OL_DELIVERY_DATE[s0_w_id][9][s0_no_o_id := Order_Line_OL_DELIVERY_DATE[s0_w_id][9][s0_no_o_id][2 := s0_date]]]];
      s0_#tmp399 := Order_Line_OL_AMOUNT[s0_w_id][9][s0_no_o_id][2];
      s0_#tmp400 := real(s0_#tmp399);
      s0_#tmp401 := s0_ol_total + s0_#tmp400;
      s0_ol_total := s0_#tmp401;
      goto s0_block240__ab;
    s0_block240__ab:
      Order_Line_OL_DELIVERY_DATE := Order_Line_OL_DELIVERY_DATE[s0_w_id := Order_Line_OL_DELIVERY_DATE[s0_w_id][9 := Order_Line_OL_DELIVERY_DATE[s0_w_id][9][s0_no_o_id := Order_Line_OL_DELIVERY_DATE[s0_w_id][9][s0_no_o_id][3 := s0_date]]]];
      s0_#tmp399 := Order_Line_OL_AMOUNT[s0_w_id][9][s0_no_o_id][3];
      s0_#tmp400 := real(s0_#tmp399);
      s0_#tmp401 := s0_ol_total + s0_#tmp400;
      s0_ol_total := s0_#tmp401;
      goto s0_block241__ab;
    s0_block241__ab:
      Order_Line_OL_DELIVERY_DATE := Order_Line_OL_DELIVERY_DATE[s0_w_id := Order_Line_OL_DELIVERY_DATE[s0_w_id][9 := Order_Line_OL_DELIVERY_DATE[s0_w_id][9][s0_no_o_id := Order_Line_OL_DELIVERY_DATE[s0_w_id][9][s0_no_o_id][4 := s0_date]]]];
      s0_#tmp399 := Order_Line_OL_AMOUNT[s0_w_id][9][s0_no_o_id][4];
      s0_#tmp400 := real(s0_#tmp399);
      s0_#tmp401 := s0_ol_total + s0_#tmp400;
      s0_ol_total := s0_#tmp401;
      goto s0_block242__ab;
    s0_block242__ab:
      Order_Line_OL_DELIVERY_DATE := Order_Line_OL_DELIVERY_DATE[s0_w_id := Order_Line_OL_DELIVERY_DATE[s0_w_id][9 := Order_Line_OL_DELIVERY_DATE[s0_w_id][9][s0_no_o_id := Order_Line_OL_DELIVERY_DATE[s0_w_id][9][s0_no_o_id][5 := s0_date]]]];
      s0_#tmp399 := Order_Line_OL_AMOUNT[s0_w_id][9][s0_no_o_id][5];
      s0_#tmp400 := real(s0_#tmp399);
      s0_#tmp401 := s0_ol_total + s0_#tmp400;
      s0_ol_total := s0_#tmp401;
      goto s0_block243__ab;
    s0_block243__ab:
      Order_Line_OL_DELIVERY_DATE := Order_Line_OL_DELIVERY_DATE[s0_w_id := Order_Line_OL_DELIVERY_DATE[s0_w_id][9 := Order_Line_OL_DELIVERY_DATE[s0_w_id][9][s0_no_o_id := Order_Line_OL_DELIVERY_DATE[s0_w_id][9][s0_no_o_id][6 := s0_date]]]];
      s0_#tmp399 := Order_Line_OL_AMOUNT[s0_w_id][9][s0_no_o_id][6];
      s0_#tmp400 := real(s0_#tmp399);
      s0_#tmp401 := s0_ol_total + s0_#tmp400;
      s0_ol_total := s0_#tmp401;
      goto s0_block244__ab;
    s0_block244__ab:
      Order_Line_OL_DELIVERY_DATE := Order_Line_OL_DELIVERY_DATE[s0_w_id := Order_Line_OL_DELIVERY_DATE[s0_w_id][9 := Order_Line_OL_DELIVERY_DATE[s0_w_id][9][s0_no_o_id := Order_Line_OL_DELIVERY_DATE[s0_w_id][9][s0_no_o_id][7 := s0_date]]]];
      s0_#tmp399 := Order_Line_OL_AMOUNT[s0_w_id][9][s0_no_o_id][7];
      s0_#tmp400 := real(s0_#tmp399);
      s0_#tmp401 := s0_ol_total + s0_#tmp400;
      s0_ol_total := s0_#tmp401;
      goto s0_block245__ab;
    s0_block245__ab:
      Order_Line_OL_DELIVERY_DATE := Order_Line_OL_DELIVERY_DATE[s0_w_id := Order_Line_OL_DELIVERY_DATE[s0_w_id][9 := Order_Line_OL_DELIVERY_DATE[s0_w_id][9][s0_no_o_id := Order_Line_OL_DELIVERY_DATE[s0_w_id][9][s0_no_o_id][8 := s0_date]]]];
      s0_#tmp399 := Order_Line_OL_AMOUNT[s0_w_id][9][s0_no_o_id][8];
      s0_#tmp400 := real(s0_#tmp399);
      s0_#tmp401 := s0_ol_total + s0_#tmp400;
      s0_ol_total := s0_#tmp401;
      goto s0_block246__ab;
    s0_block246__ab:
      Order_Line_OL_DELIVERY_DATE := Order_Line_OL_DELIVERY_DATE[s0_w_id := Order_Line_OL_DELIVERY_DATE[s0_w_id][9 := Order_Line_OL_DELIVERY_DATE[s0_w_id][9][s0_no_o_id := Order_Line_OL_DELIVERY_DATE[s0_w_id][9][s0_no_o_id][9 := s0_date]]]];
      s0_#tmp399 := Order_Line_OL_AMOUNT[s0_w_id][9][s0_no_o_id][9];
      s0_#tmp400 := real(s0_#tmp399);
      s0_#tmp401 := s0_ol_total + s0_#tmp400;
      s0_ol_total := s0_#tmp401;
      goto s0_block131__ab;
  ...
  // Executing B then A:
    ...
    s0_block127__ba:
      ...
      s0_#tmp397 := to_unit(s0_ol_cnt);
      Order_O_CARRIER_ID := Order_O_CARRIER_ID[s0_w_id := Order_O_CARRIER_ID[s0_w_id][9 := Order_O_CARRIER_ID[s0_w_id][9][s0_no_o_id := s0_o_carrier_id]]];
      goto s0_block129__ba;
    s0_block128__ba:
      s0_#tmp398 := s0_ol_number < O_OL_CNT;
      if (s0_#tmp398) {
      goto s0_block129__ba;
    } else {
      goto s0_block131__ba;
    }
    s0_block129__ba:
      Order_Line_OL_DELIVERY_DATE := Order_Line_OL_DELIVERY_DATE[s0_w_id := Order_Line_OL_DELIVERY_DATE[s0_w_id][9 := Order_Line_OL_DELIVERY_DATE[s0_w_id][9][s0_no_o_id := Order_Line_OL_DELIVERY_DATE[s0_w_id][9][s0_no_o_id][0 := s0_date]]]];
      s0_#tmp399 := Order_Line_OL_AMOUNT[s0_w_id][9][s0_no_o_id][0];
