...
procedure Check_SliceCommut_Hop36_vs_Hop38()
modifies Customer_C_BALANCE, Customer_C_CITY, Customer_C_CREDIT, Customer_C_CREDIT_LIMIT, Customer_C_DATA, Customer_C_DELIVERY_CNT, Customer_C_DISCOUNT, Customer_C_FIRST, Customer_C_LAST, Customer_C_MIDDLE, Customer_C_PAYMENT_CNT, Customer_C_PHONE, Customer_C_SINCE, Customer_C_STATE, Customer_C_STREET_1, Customer_C_STREET_2, Customer_C_YTD_PAYMENT, Customer_C_ZIP, District_D_NEXT_NO_ID, Order_Line_OL_AMOUNT, Order_Line_OL_DELIVERY_DATE, Order_Line_OL_DIST_INTO, Order_Line_OL_I_ID, Order_Line_OL_QUANTITY, Order_Line_OL_SUPPLY_W_ID, Order_O_ALL_LOCAL, Order_O_CARRIER_ID, Order_O_C_ID, Order_O_ENTRY_DATE, Order_O_OL_CNT;
{
  var s0_w_id : int;
  ...
  // Slice commutativity verification: hop 36 vs hop 38
  ...
  // Executing A then B:
    if (s0_active) {
    s0_block122__ab:
      s0_#tmp379 := District_D_NEXT_NO_ID[s0_w_id][8];
      s0_no_o_id := s0_#tmp379;
      s0_#tmp380 := s0_no_o_id + 1;
      District_D_NEXT_NO_ID := District_D_NEXT_NO_ID[s0_w_id := District_D_NEXT_NO_ID[s0_w_id][8 := s0_#tmp380]];
      s0_#tmp381 := Order_O_C_ID[s0_w_id][8][s0_no_o_id];
      s0_c_id := s0_#tmp381;
      s0_#tmp382 := Order_O_OL_CNT[s0_w_id][8][s0_no_o_id];
      s0_ol_cnt := s0_#tmp382;
      s0_#tmp383 := to_unit(s0_ol_cnt);
      Order_O_CARRIER_ID := Order_O_CARRIER_ID[s0_w_id := Order_O_CARRIER_ID[s0_w_id][8 := Order_O_CARRIER_ID[s0_w_id][8][s0_no_o_id := s0_o_carrier_id]]];
      goto s0_block124__ab;
    s0_block123__ab:
      s0_#tmp384 := s0_ol_number < O_OL_CNT;
      if (s0_#tmp384) {
      goto s0_block124__ab;
    } else {
      goto s0_block126__ab;
    }
    s0_block124__ab:
      Order_Line_OL_DELIVERY_DATE := Order_Line_OL_DELIVERY_DATE[s0_w_id := Order_Line_OL_DELIVERY_DATE[s0_w_id][8 := Order_Line_OL_DELIVERY_DATE[s0_w_id][8][s0_no_o_id := Order_Line_OL_DELIVERY_DATE[s0_w_id][8][s0_no_o_id][0 := s0_date]]]];
      s0_#tmp385 := Order_Line_OL_AMOUNT[s0_w_id][8][s0_no_o_id][0];
      s0_#tmp386 := real(s0_#tmp385);
      s0_#tmp387 := 0.0000000 + s0_#tmp386;
      s0_ol_total := s0_#tmp387;
      goto s0_block229__ab;
    s0_block126__ab:
      s0_#tmp389 := Customer_C_BALANCE[s0_w_id][8][s0_c_id];
      s0_#tmp390 := s0_#tmp389 + s0_ol_total;
      Customer_C_BALANCE := Customer_C_BALANCE[s0_w_id := Customer_C_BALANCE[s0_w_id][8 := Customer_C_BALANCE[s0_w_id][8][s0_c_id := s0_#tmp390]]];
      s0_#tmp391 := Customer_C_DELIVERY_CNT[s0_w_id][8][s0_c_id];
      s0_#tmp392 := s0_#tmp391 + 1.0000000;
      Customer_C_DELIVERY_CNT := Customer_C_DELIVERY_CNT[s0_w_id := Customer_C_DELIVERY_CNT[s0_w_id][8 := Customer_C_DELIVERY_CNT[s0_w_id][8][s0_c_id := s0_#tmp392]]];
      goto s0_hop_exit__ab;
    s0_block229__ab:
      Order_Line_OL_DELIVERY_DATE := Order_Line_OL_DELIVERY_DATE[s0_w_id := Order_Line_OL_DELIVERY_DATE[s0_w_id][8 := Order_Line_OL_DELIVERY_DATE[s0_w_id][8][s0_no_o_id := Order_Line_OL_DELIVERY_DATE[s0_w_id][8][s0_no_o_id][1 := s0_date]]]];
      s0_#tmp385 := Order_Line_OL_AMOUNT[s0_w_id][8][s0_no_o_id][1];
      s0_#tmp386 := real(s0_#tmp385);
      s0_#tmp387 := s0_ol_total + s0_#tmp386;
      s0_ol_total := s0_#tmp387;
      goto s0_block230__ab;
    s0_block230__ab:
      Order_Line_OL_DELIVERY_DATE := Order_Line_OL_DELIVERY_DATE[s0_w_id := Order_Line_OL_DELIVERY_DATE[s0_w_id][8 := Order_Line_OL_DELIVERY_DATE[s0_w_id][8][s0_no_o_id := Order_Line_OL_DELIVERY_DATE[s0_w_id][8][s0_no_o_id][2 := s0_date]]]];
      s0_#tmp385 := Order_Line_OL_AMOUNT[s0_w_id][8][s0_no_o_id][2];
      s0_#tmp386 := real(s0_#tmp385);
      s0_#tmp387 := s0_ol_total + s0_#tmp386;
      s0_ol_total := s0_#tmp387;
      goto s0_block231__ab;
    s0_block231__ab:
      Order_Line_OL_DELIVERY_DATE := Order_Line_OL_DELIVERY_DATE[s0_w_id := Order_Line_OL_DELIVERY_DATE[s0_w_id][8 := Order_Line_OL_DELIVERY_DATE[s0_w_id][8][s0_no_o_id := Order_Line_OL_DELIVERY_DATE[s0_w_id][8][s0_no_o_id][3 := s0_date]]]];
      s0_#tmp385 := Order_Line_OL_AMOUNT[s0_w_id][8][s0_no_o_id][3];
      s0_#tmp386 := real(s0_#tmp385);
      s0_#tmp387 := s0_ol_total + s0_#tmp386;
      s0_ol_total := s0_#tmp387;
      goto s0_block232__ab;
    s0_block232__ab:
      Order_Line_OL_DELIVERY_DATE := Order_Line_OL_DELIVERY_DATE[s0_w_id := Order_Line_OL_DELIVERY_DATE[s0_w_id][8 := Order_Line_OL_DELIVERY_DATE[s0_w_id][8][s0_no_o_id := Order_Line_OL_DELIVERY_DATE[s0_w_id][8][s0_no_o_id][4 := s0_date]]]];
      s0_#tmp385 := Order_Line_OL_AMOUNT[s0_w_id][8][s0_no_o_id][4];
      s0_#tmp386 := real(s0_#tmp385);
      s0_#tmp387 := s0_ol_total + s0_#tmp386;
      s0_ol_total := s0_#tmp387;
      goto s0_block233__ab;
    s0_block233__ab:
      Order_Line_OL_DELIVERY_DATE := Order_Line_OL_DELIVERY_DATE[s0_w_id := Order_Line_OL_DELIVERY_DATE[s0_w_id][8 := Order_Line_OL_DELIVERY_DATE[s0_w_id][8][s0_no_o_id := Order_Line_OL_DELIVERY_DATE[s0_w_id][8][s0_no_o_id][5 := s0_date]]]];
      s0_#tmp385 := Order_Line_OL_AMOUNT[s0_w_id][8][s0_no_o_id][5];
      s0_#tmp386 := real(s0_#tmp385);
      s0_#tmp387 := s0_ol_total + s0_#tmp386;
      s0_ol_total := s0_#tmp387;
      goto s0_block234__ab;
    s0_block234__ab:
      Order_Line_OL_DELIVERY_DATE := Order_Line_OL_DELIVERY_DATE[s0_w_id := Order_Line_OL_DELIVERY_DATE[s0_w_id][8 := Order_Line_OL_DELIVERY_DATE[s0_w_id][8][s0_no_o_id := Order_Line_OL_DELIVERY_DATE[s0_w_id][8][s0_no_o_id][6 := s0_date]]]];
      s0_#tmp385 := Order_Line_OL_AMOUNT[s0_w_id][8][s0_no_o_id][6];
      s0_#tmp386 := real(s0_#tmp385);
      s0_#tmp387 := s0_ol_total + s0_#tmp386;
      s0_ol_total := s0_#tmp387;
      goto s0_block235__ab;
    s0_block235__ab:
      Order_Line_OL_DELIVERY_DATE := Order_Line_OL_DELIVERY_DATE[s0_w_id := Order_Line_OL_DELIVERY_DATE[s0_w_id][8 := Order_Line_OL_DELIVERY_DATE[s0_w_id][8][s0_no_o_id := Order_Line_OL_DELIVERY_DATE[s0_w_id][8][s0_no_o_id][7 := s0_date]]]];
      s0_#tmp385 := Order_Line_OL_AMOUNT[s0_w_id][8][s0_no_o_id][7];
      s0_#tmp386 := real(s0_#tmp385);
      s0_#tmp387 := s0_ol_total + s0_#tmp386;
      s0_ol_total := s0_#tmp387;
      goto s0_block236__ab;
    s0_block236__ab:
      Order_Line_OL_DELIVERY_DATE := Order_Line_OL_DELIVERY_DATE[s0_w_id := Order_Line_OL_DELIVERY_DATE[s0_w_id][8 := Order_Line_OL_DELIVERY_DATE[s0_w_id][8][s0_no_o_id := Order_Line_OL_DELIVERY_DATE[s0_w_id][8][s0_no_o_id][8 := s0_date]]]];
      s0_#tmp385 := Order_Line_OL_AMOUNT[s0_w_id][8][s0_no_o_id][8];
      s0_#tmp386 := real(s0_#tmp385);
      s0_#tmp387 := s0_ol_total + s0_#tmp386;
      s0_ol_total := s0_#tmp387;
      goto s0_block237__ab;
    s0_block237__ab:
      Order_Line_OL_DELIVERY_DATE := Order_Line_OL_DELIVERY_DATE[s0_w_id := Order_Line_OL_DELIVERY_DATE[s0_w_id][8 := Order_Line_OL_DELIVERY_DATE[s0_w_id][8][s0_no_o_id := Order_Line_OL_DELIVERY_DATE[s0_w_id][8][s0_no_o_id][9 := s0_date]]]];
      s0_#tmp385 := Order_Line_OL_AMOUNT[s0_w_id][8][s0_no_o_id][9];
      s0_#tmp386 := real(s0_#tmp385);
      s0_#tmp387 := s0_ol_total + s0_#tmp386;
      s0_ol_total := s0_#tmp387;
      goto s0_block126__ab;
  ...
  // Executing B then A:
    ...
    s0_block122__ba:
      ...
      s0_#tmp383 := to_unit(s0_ol_cnt);
      Order_O_CARRIER_ID := Order_O_CARRIER_ID[s0_w_id := Order_O_CARRIER_ID[s0_w_id][8 := Order_O_CARRIER_ID[s0_w_id][8][s0_no_o_id := s0_o_carrier_id]]];
      goto s0_block124__ba;
    s0_block123__ba:
      s0_#tmp384 := s0_ol_number < O_OL_CNT;
      if (s0_#tmp384) {
      goto s0_block124__ba;
    } else {
      goto s0_block126__ba;
    }
    s0_block124__ba:
      Order_Line_OL_DELIVERY_DATE := Order_Line_OL_DELIVERY_DATE[s0_w_id := Order_Line_OL_DELIVERY_DATE[s0_w_id][8 := Order_Line_OL_DELIVERY_DATE[s0_w_id][8][s0_no_o_id := Order_Line_OL_DELIVERY_DATE[s0_w_id][8][s0_no_o_id][0 := s0_date]]]];
      s0_#tmp385 := Order_Line_OL_AMOUNT[s0_w_id][8][s0_no_o_id][0];
