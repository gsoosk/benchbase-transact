...
procedure Check_SliceCommut_Hop27_vs_Hop39()
modifies District_D_NEXT_O_ID, Order_Line_OL_AMOUNT, Order_Line_OL_DELIVERY_DATE, Order_Line_OL_DIST_INTO, Order_Line_OL_I_ID, Order_Line_OL_QUANTITY, Order_Line_OL_SUPPLY_W_ID, Order_O_ALL_LOCAL, Order_O_C_ID, Order_O_ENTRY_DATE, Order_O_OL_CNT;
{
  var s0_w_id : int;
  var s0_d_id : int;
  var s0_c_id : int;
  ...
  // Slice commutativity verification: hop 27 vs hop 39
  ...
  // Verifying A->B === B->A equivalence:
    assert {:msg "(SpecialInterleavingNonEquivalence (node_1 (function_id . 31) (instance . 1) (hop_id . 27)) (node_2 (function_id . 34) (instance . 0) (hop_id . 39)))"} ((((((((((((District_D_NEXT_O_ID_a_then_b == District_D_NEXT_O_ID_b_then_a) && (Order_Line_OL_AMOUNT_a_then_b == Order_Line_OL_AMOUNT_b_then_a)) && (Order_Line_OL_I_ID_a_then_b == Order_Line_OL_I_ID_b_then_a)) && (Order_Line_OL_QUANTITY_a_then_b == Order_Line_OL_QUANTITY_b_then_a)) && (Order_Line_OL_SUPPLY_W_ID_a_then_b == Order_Line_OL_SUPPLY_W_ID_b_then_a)) && (Order_O_ALL_LOCAL_a_then_b == Order_O_ALL_LOCAL_b_then_a)) && (Order_O_C_ID_a_then_b == Order_O_C_ID_b_then_a)) && (Order_O_ENTRY_DATE_a_then_b == Order_O_ENTRY_DATE_b_then_a)) && (Order_O_OL_CNT_a_then_b == Order_O_OL_CNT_b_then_a)) && (s1_w_id_a_then_b == s1_w_id_b_then_a)) && (s1_threshold_a_then_b == s1_threshold_b_then_a)) && (s1_rep_i_id_a_then_b == s1_rep_i_id_b_then_a));
}
