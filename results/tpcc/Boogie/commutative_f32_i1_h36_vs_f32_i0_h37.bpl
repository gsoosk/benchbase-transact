...
modifies Customer_C_BALANCE, Customer_C_DELIVERY_CNT, District_D_NEXT_NO_ID, Order_Line_OL_AMOUNT, Order_Line_OL_DELIVERY_DATE, Order_O_CARRIER_ID, Order_O_C_ID;
{
  ...
  // Executing A then B:
    if (s0_active) {
    s0_block122__ab:
      s0_#tmp371 := District_D_NEXT_NO_ID[s0_w_id][8];
      s0_no_o_id := s0_#tmp371;
      s0_#tmp372 := s0_no_o_id + 1;
      District_D_NEXT_NO_ID := District_D_NEXT_NO_ID[s0_w_id := District_D_NEXT_NO_ID[s0_w_id][8 := s0_#tmp372]];
      s0_#tmp373 := Order_O_C_ID[s0_w_id][8][s0_no_o_id];
      s0_c_id := s0_#tmp373;
    ...
    s0_block123__ab:
      s0_#tmp375 := s0_ol_number < O_OL_CNT;
      if (s0_#tmp375) {
      goto s0_block124__ab;
    } else {
    ...
    s0_block124__ab:
      ...
      s0_#tmp376 := Order_Line_OL_AMOUNT[s0_w_id][8][s0_no_o_id][0];
      s0_#tmp377 := real(s0_#tmp376);
      s0_#tmp378 := 0.0000000 + s0_#tmp377;
      s0_ol_total := s0_#tmp378;
      goto s0_block229__ab;
    s0_block126__ab:
      s0_#tmp380 := Customer_C_BALANCE[s0_w_id][8][s0_c_id];
      s0_#tmp381 := s0_#tmp380 + s0_ol_total;
      Customer_C_BALANCE := Customer_C_BALANCE[s0_w_id := Customer_C_BALANCE[s0_w_id][8 := Customer_C_BALANCE[s0_w_id][8][s0_c_id := s0_#tmp381]]];
      s0_#tmp382 := Customer_C_DELIVERY_CNT[s0_w_id][8][s0_c_id];
      s0_#tmp383 := s0_#tmp382 + 1.0000000;
      Customer_C_DELIVERY_CNT := Customer_C_DELIVERY_CNT[s0_w_id := Customer_C_DELIVERY_CNT[s0_w_id][8 := Customer_C_DELIVERY_CNT[s0_w_id][8][s0_c_id := s0_#tmp383]]];
    ...
    s0_block229__ab:
      ...
      s0_#tmp376 := Order_Line_OL_AMOUNT[s0_w_id][8][s0_no_o_id][1];
      s0_#tmp377 := real(s0_#tmp376);
      s0_#tmp378 := s0_ol_total + s0_#tmp377;
      s0_ol_total := s0_#tmp378;
    ...
    s0_block230__ab:
      ...
      s0_#tmp376 := Order_Line_OL_AMOUNT[s0_w_id][8][s0_no_o_id][2];
      s0_#tmp377 := real(s0_#tmp376);
      s0_#tmp378 := s0_ol_total + s0_#tmp377;
      s0_ol_total := s0_#tmp378;
    ...
    s0_block231__ab:
      ...
      s0_#tmp376 := Order_Line_OL_AMOUNT[s0_w_id][8][s0_no_o_id][3];
      s0_#tmp377 := real(s0_#tmp376);
      s0_#tmp378 := s0_ol_total + s0_#tmp377;
      s0_ol_total := s0_#tmp378;
    ...
    s0_block232__ab:
      ...
      s0_#tmp376 := Order_Line_OL_AMOUNT[s0_w_id][8][s0_no_o_id][4];
      s0_#tmp377 := real(s0_#tmp376);
      s0_#tmp378 := s0_ol_total + s0_#tmp377;
      s0_ol_total := s0_#tmp378;
    ...
    s0_block233__ab:
      ...
      s0_#tmp376 := Order_Line_OL_AMOUNT[s0_w_id][8][s0_no_o_id][5];
      s0_#tmp377 := real(s0_#tmp376);
      s0_#tmp378 := s0_ol_total + s0_#tmp377;
      s0_ol_total := s0_#tmp378;
    ...
    s0_block234__ab:
      ...
      s0_#tmp376 := Order_Line_OL_AMOUNT[s0_w_id][8][s0_no_o_id][6];
      s0_#tmp377 := real(s0_#tmp376);
      s0_#tmp378 := s0_ol_total + s0_#tmp377;
      s0_ol_total := s0_#tmp378;
    ...
    s0_block235__ab:
      ...
      s0_#tmp376 := Order_Line_OL_AMOUNT[s0_w_id][8][s0_no_o_id][7];
      s0_#tmp377 := real(s0_#tmp376);
      s0_#tmp378 := s0_ol_total + s0_#tmp377;
      s0_ol_total := s0_#tmp378;
    ...
    s0_block236__ab:
      ...
      s0_#tmp376 := Order_Line_OL_AMOUNT[s0_w_id][8][s0_no_o_id][8];
      s0_#tmp377 := real(s0_#tmp376);
      s0_#tmp378 := s0_ol_total + s0_#tmp377;
      s0_ol_total := s0_#tmp378;
    ...
    s0_block237__ab:
      ...
      s0_#tmp376 := Order_Line_OL_AMOUNT[s0_w_id][8][s0_no_o_id][9];
      s0_#tmp377 := real(s0_#tmp376);
      s0_#tmp378 := s0_ol_total + s0_#tmp377;
      s0_ol_total := s0_#tmp378;
      goto s0_block126__ab;
