...
modifies Warehouse_W_YTD;
{
  ...
  var s0_active : bool;
  var s1_active : bool;
  var Warehouse_W_YTD_init : [int]real;
  ...
  var Warehouse_W_YTD_b_then_a : [int]real;
  ...
  // Slice commutativity verification: hop 41 vs hop 41
  // --- Step 1: Havoc initial state ---
    havoc Warehouse_W_YTD;
    havoc s0_w_id;
    havoc s0_d_id;
    havoc s0_c_w_id;
    havoc s0_c_d_id;
  ...
  // --- Step 2: Save initial state ---
    Warehouse_W_YTD_init := Warehouse_W_YTD;
  ...
  // Snapshotting final state for a_then_b
    Warehouse_W_YTD_a_then_b := Warehouse_W_YTD;
  ...
  // Restoring initial state:
    Warehouse_W_YTD := Warehouse_W_YTD_init;
  ...
  // Snapshotting final state for b_then_a
    Warehouse_W_YTD_b_then_a := Warehouse_W_YTD;
