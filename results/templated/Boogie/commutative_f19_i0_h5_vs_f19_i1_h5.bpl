...
modifies TEMPLATED_TABLE_T_FLOAT_VAL, TEMPLATED_TABLE_T_ID, TEMPLATED_TABLE_T_INT_VAL, TEMPLATED_TABLE_T_STRING_VAL;
{
  ...
  var s0_r2#T_FLOAT_VAL : real;
  var s0_r2#T_ID : int;
  var s0_r2#T_INT_VAL : int;
  var s0_r2#T_STRING_VAL : String;
  var s0_#tmp7 : real;
  ...
  // Executing A then B:
    if (s0_active) {
    s0_block5__ab:
      s0_r2#T_FLOAT_VAL := TEMPLATED_TABLE_T_FLOAT_VAL[s0_key2];
      s0_r2#T_ID := TEMPLATED_TABLE_T_ID[s0_key2];
      s0_r2#T_INT_VAL := TEMPLATED_TABLE_T_INT_VAL[s0_key2];
      s0_r2#T_STRING_VAL := TEMPLATED_TABLE_T_STRING_VAL[s0_key2];
      s0_#tmp7 := s0_r2#T_FLOAT_VAL + s0_amount;
      s0_r2#T_FLOAT_VAL := s0_#tmp7;
      TEMPLATED_TABLE_T_FLOAT_VAL := TEMPLATED_TABLE_T_FLOAT_VAL[s0_key2 := s0_r2#T_FLOAT_VAL];
      TEMPLATED_TABLE_T_ID := TEMPLATED_TABLE_T_ID[s0_key2 := s0_r2#T_ID];
      TEMPLATED_TABLE_T_INT_VAL := TEMPLATED_TABLE_T_INT_VAL[s0_key2 := s0_r2#T_INT_VAL];
      TEMPLATED_TABLE_T_STRING_VAL := TEMPLATED_TABLE_T_STRING_VAL[s0_key2 := s0_r2#T_STRING_VAL];
      s0_active := false;
  ...
  // Verifying A->B === B->A equivalence:
    assert {:msg "(SpecialInterleavingNonEquivalence (node_1 (function_id . 19) (instance . 0) (hop_id . 5)) (node_2 (function_id . 19) (instance . 1) (hop_id . 5)))"} ((((TEMPLATED_TABLE_T_FLOAT_VAL_a_then_b == TEMPLATED_TABLE_T_FLOAT_VAL_b_then_a) && (TEMPLATED_TABLE_T_ID_a_then_b == TEMPLATED_TABLE_T_ID_b_then_a)) && (TEMPLATED_TABLE_T_INT_VAL_a_then_b == TEMPLATED_TABLE_T_INT_VAL_b_then_a)) && (TEMPLATED_TABLE_T_STRING_VAL_a_then_b == TEMPLATED_TABLE_T_STRING_VAL_b_then_a));
}
