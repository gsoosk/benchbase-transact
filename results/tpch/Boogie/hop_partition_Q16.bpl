...
procedure verify_hop_partitions_Q16(partkey: int, suppkey: int)
{
  var s26_#tmp76 : Row (Table (Part));
  var s26_partkey : int;
  var s26_p : Row (Table (Part));
  var s26_#tmp77 : unit;
  var s26_#tmp78 : Row (Table (Partsupp));
  var s26_suppkey : int;
  var s26_ps : Row (Table (Partsupp));
  var s26_#tmp79 : unit;
  var s27_#tmp80 : Row (Table (Supplier));
  var s27_suppkey : int;
  var s27_s : Row (Table (Supplier));
  var s27_#tmp81 : unit;

  // Hop partition verification for function 'Q16'
  s26_block26:
    s26_#tmp76 := construct_Row_Part(Part_p_partkey[s26_partkey], Part_p_name[s26_partkey], Part_p_mfgr[s26_partkey], Part_p_brand[s26_partkey], Part_p_type[s26_partkey], Part_p_size[s26_partkey], Part_p_container[s26_partkey], Part_p_retailprice[s26_partkey], Part_p_comment[s26_partkey]);
    s26_p := s26_#tmp76;
    s26_#tmp77 := to_unit(s26_p);
    s26_#tmp78 := construct_Row_Partsupp(Partsupp_ps_partkey[s26_partkey][s26_suppkey], Partsupp_ps_suppkey[s26_partkey][s26_suppkey], Partsupp_ps_availqty[s26_partkey][s26_suppkey], Partsupp_ps_supplycost[s26_partkey][s26_suppkey], Partsupp_ps_comment[s26_partkey][s26_suppkey]);
  // Partition check hop 26 func 'f' tables 'Part'=>'Partsupp' keys [k0=partkey] first_span Span { start: 10025, end: 10049, filename: "/Users/farzad/Desktop/Research/benchbase-transact/tpch.transact" } current_span Span { start: 10103, end: 10153, filename: "/Users/farzad/Desktop/Research/benchbase-transact/tpch.transact" }
    assert {:msg "(PartitionFunctionInconsistency (partition_function_id . 15) (function_id . 28) (hop_id . 26) (table_id . 4) (span ((start . 10103) (end . 10153) (filename . \"/Users/farzad/Desktop/Research/benchbase-transact/tpch.transact\"))))"} (s26_partkey == s26_partkey);
    s26_ps := s26_#tmp78;
    s26_#tmp79 := to_unit(s26_ps);
    goto s26_hop_exit;
  s26_hop_exit:
  s27_block27:
    s27_#tmp80 := construct_Row_Supplier(Supplier_s_suppkey[s27_suppkey], Supplier_s_name[s27_suppkey], Supplier_s_address[s27_suppkey], Supplier_s_nationkey[s27_suppkey], Supplier_s_phone[s27_suppkey], Supplier_s_acctbal[s27_suppkey], Supplier_s_comment[s27_suppkey]);
    s27_s := s27_#tmp80;
    s27_#tmp81 := to_unit(s27_s);
    goto s27_epilogue;
  s27_hop_exit:
  s26_epilogue:
  s27_epilogue:
