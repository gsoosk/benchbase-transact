...
procedure verify_hop_partitions_Q14(orderkey: int, linenumber: int, partkey: int)
{
  var s22_l#l_extendedprice : real;
  var s22_orderkey : int;
  var s22_linenumber : int;
  var s22_ep : real;
  var s22_#tmp67 : unit;
  var s23_p#p_type : String;
  var s23_partkey : int;
  var s23_ptype : String;
  var s23_#tmp69 : unit;

  // Hop partition verification for function 'Q14'
  s22_block22:
    s22_l#l_extendedprice := Lineitem_l_extendedprice[s22_orderkey][s22_linenumber];
    s22_ep := s22_l#l_extendedprice;
    s22_#tmp67 := to_unit(s22_ep);
    goto s22_hop_exit;
  s22_hop_exit:
  s23_block23:
    s23_p#p_type := Part_p_type[s23_partkey];
    s23_ptype := s23_p#p_type;
    s23_#tmp69 := to_unit(s23_ptype);
    goto s23_epilogue;
  s23_hop_exit:
  s22_epilogue:
  s23_epilogue:
