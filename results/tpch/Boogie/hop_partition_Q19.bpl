...
procedure verify_hop_partitions_Q19(orderkey: int, linenumber: int, partkey: int)
{
  var s32_l#l_discount : real;
  var s32_orderkey : int;
  var s32_linenumber : int;
  var s32_l#l_extendedprice : real;
  var s32_#tmp93 : real;
  var s32_#tmp94 : real;
  var s32_revenue : real;
  var s32_#tmp95 : unit;
  var s33_#tmp96 : Row (Table (Part));
  var s33_partkey : int;
  var s33_p : Row (Table (Part));
  var s33_#tmp97 : unit;

  // Hop partition verification for function 'Q19'
  s32_block32:
    s32_l#l_discount := Lineitem_l_discount[s32_orderkey][s32_linenumber];
    s32_l#l_extendedprice := Lineitem_l_extendedprice[s32_orderkey][s32_linenumber];
  // Partition check hop 32 func 'f' tables 'Lineitem'=>'Lineitem' keys [k0=orderkey] first_span Span { start: 11442, end: 11498, filename: "/Users/farzad/Desktop/Research/benchbase-transact/tpch.transact" } current_span Span { start: 11442, end: 11498, filename: "/Users/farzad/Desktop/Research/benchbase-transact/tpch.transact" }
    assert {:msg "(PartitionFunctionInconsistency (partition_function_id . 15) (function_id . 31) (hop_id . 32) (table_id . 7) (span ((start . 11442) (end . 11498) (filename . \"/Users/farzad/Desktop/Research/benchbase-transact/tpch.transact\"))))"} (s32_orderkey == s32_orderkey);
    s32_#tmp93 := 1.0000000 - s32_l#l_discount;
    s32_#tmp94 := s32_l#l_extendedprice * s32_#tmp93;
    s32_revenue := s32_#tmp94;
    s32_#tmp95 := to_unit(s32_revenue);
    goto s32_hop_exit;
  s32_hop_exit:
  s33_block33:
    s33_#tmp96 := construct_Row_Part(Part_p_partkey[s33_partkey], Part_p_name[s33_partkey], Part_p_mfgr[s33_partkey], Part_p_brand[s33_partkey], Part_p_type[s33_partkey], Part_p_size[s33_partkey], Part_p_container[s33_partkey], Part_p_retailprice[s33_partkey], Part_p_comment[s33_partkey]);
    s33_p := s33_#tmp96;
    s33_#tmp97 := to_unit(s33_p);
    goto s33_epilogue;
  s33_hop_exit:
  s32_epilogue:
  s33_epilogue:
