...
procedure verify_hop_partitions_Q5(custkey: int, orderkey: int, linenumber: int, suppkey: int, nationkey: int, regionkey: int)
{
  var s9_#tmp26 : Row (Table (Customer));
  var s9_custkey : int;
  var s9_c : Row (Table (Customer));
  var s9_#tmp27 : unit;
  var s10_#tmp28 : Row (Table (Orders));
  var s10_orderkey : int;
  var s10_o : Row (Table (Orders));
  var s10_#tmp29 : unit;
  var s10_l#l_discount : real;
  var s10_linenumber : int;
  var s10_l#l_extendedprice : real;
  var s10_#tmp31 : real;
  var s10_#tmp32 : real;
  var s10_revenue : real;
  var s10_#tmp33 : unit;
  var s11_#tmp34 : Row (Table (Supplier));
  var s11_suppkey : int;
  var s11_s : Row (Table (Supplier));
  var s11_#tmp35 : unit;
  var s12_#tmp36 : Row (Table (Nation));
  var s12_nationkey : int;
  var s12_n : Row (Table (Nation));
  var s12_#tmp37 : unit;
  var s12_#tmp38 : Row (Table (Region));
  var s12_regionkey : int;
  var s12_r : Row (Table (Region));
  var s12_#tmp39 : unit;

  // Hop partition verification for function 'Q5'
  s9_block9:
    s9_#tmp26 := construct_Row_Customer(Customer_c_custkey[s9_custkey], Customer_c_name[s9_custkey], Customer_c_address[s9_custkey], Customer_c_nationkey[s9_custkey], Customer_c_phone[s9_custkey], Customer_c_acctbal[s9_custkey], Customer_c_mktsegment[s9_custkey], Customer_c_comment[s9_custkey]);
    s9_c := s9_#tmp26;
    s9_#tmp27 := to_unit(s9_c);
    goto s9_hop_exit;
  s9_hop_exit:
  s10_block10:
    s10_#tmp28 := construct_Row_Orders(Orders_o_orderkey[s10_orderkey], Orders_o_custkey[s10_orderkey], Orders_o_orderstatus[s10_orderkey], Orders_o_totalprice[s10_orderkey], Orders_o_orderdate[s10_orderkey], Orders_o_orderpriority[s10_orderkey], Orders_o_clerk[s10_orderkey], Orders_o_shippriority[s10_orderkey], Orders_o_comment[s10_orderkey]);
    s10_o := s10_#tmp28;
    s10_#tmp29 := to_unit(s10_o);
    s10_l#l_discount := Lineitem_l_discount[s10_orderkey][s10_linenumber];
  // Partition check hop 10 func 'f' tables 'Orders'=>'Lineitem' keys [k0=orderkey] first_span Span { start: 6241, end: 6269, filename: "/Users/farzad/Desktop/Research/benchbase-transact/tpch.transact" } current_span Span { start: 6322, end: 6378, filename: "/Users/farzad/Desktop/Research/benchbase-transact/tpch.transact" }
    assert {:msg "(PartitionFunctionInconsistency (partition_function_id . 15) (function_id . 21) (hop_id . 10) (table_id . 7) (span ((start . 6322) (end . 6378) (filename . \"/Users/farzad/Desktop/Research/benchbase-transact/tpch.transact\"))))"} (s10_orderkey == s10_orderkey);
    s10_l#l_extendedprice := Lineitem_l_extendedprice[s10_orderkey][s10_linenumber];
  // Partition check hop 10 func 'f' tables 'Orders'=>'Lineitem' keys [k0=orderkey] first_span Span { start: 6241, end: 6269, filename: "/Users/farzad/Desktop/Research/benchbase-transact/tpch.transact" } current_span Span { start: 6322, end: 6378, filename: "/Users/farzad/Desktop/Research/benchbase-transact/tpch.transact" }
    assert {:msg "(PartitionFunctionInconsistency (partition_function_id . 15) (function_id . 21) (hop_id . 10) (table_id . 7) (span ((start . 6322) (end . 6378) (filename . \"/Users/farzad/Desktop/Research/benchbase-transact/tpch.transact\"))))"} (s10_orderkey == s10_orderkey);
    s10_#tmp31 := 1.0000000 - s10_l#l_discount;
    s10_#tmp32 := s10_l#l_extendedprice * s10_#tmp31;
    s10_revenue := s10_#tmp32;
    s10_#tmp33 := to_unit(s10_revenue);
    goto s10_hop_exit;
  s10_hop_exit:
  s11_block11:
    s11_#tmp34 := construct_Row_Supplier(Supplier_s_suppkey[s11_suppkey], Supplier_s_name[s11_suppkey], Supplier_s_address[s11_suppkey], Supplier_s_nationkey[s11_suppkey], Supplier_s_phone[s11_suppkey], Supplier_s_acctbal[s11_suppkey], Supplier_s_comment[s11_suppkey]);
    s11_s := s11_#tmp34;
    s11_#tmp35 := to_unit(s11_s);
    goto s11_hop_exit;
  s11_hop_exit:
  s12_block12:
    s12_#tmp36 := construct_Row_Nation(Nation_n_nationkey[s12_nationkey], Nation_n_name[s12_nationkey], Nation_n_regionkey[s12_nationkey], Nation_n_comment[s12_nationkey]);
    s12_n := s12_#tmp36;
    s12_#tmp37 := to_unit(s12_n);
    s12_#tmp38 := construct_Row_Region(Region_r_regionkey[s12_regionkey], Region_r_name[s12_regionkey], Region_r_comment[s12_regionkey]);
  // Partition check hop 12 func 'g' tables 'Nation'=>'Region' keys [k0=nationkey] first_span Span { start: 6619, end: 6649, filename: "/Users/farzad/Desktop/Research/benchbase-transact/tpch.transact" } current_span Span { start: 6700, end: 6730, filename: "/Users/farzad/Desktop/Research/benchbase-transact/tpch.transact" }
    assert {:msg "(PartitionFunctionInconsistency (partition_function_id . 16) (function_id . 21) (hop_id . 12) (table_id . 0) (span ((start . 6700) (end . 6730) (filename . \"/Users/farzad/Desktop/Research/benchbase-transact/tpch.transact\"))))"} (s12_nationkey == s12_regionkey);
    s12_r := s12_#tmp38;
    s12_#tmp39 := to_unit(s12_r);
    goto s12_epilogue;
  s12_hop_exit:
  s9_epilogue:
  s10_epilogue:
