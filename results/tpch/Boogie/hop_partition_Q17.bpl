...
procedure verify_hop_partitions_Q17(partkey: int, orderkey: int, linenumber: int)
{
  var s28_p#p_brand : String;
  var s28_partkey : int;
  var s28_brand : String;
  var s28_#tmp83 : unit;
  var s29_l#l_quantity : real;
  var s29_orderkey : int;
  var s29_linenumber : int;
  var s29_qty : real;
  var s29_#tmp85 : unit;

  // Hop partition verification for function 'Q17'
  s28_block28:
    s28_p#p_brand := Part_p_brand[s28_partkey];
    s28_brand := s28_p#p_brand;
    s28_#tmp83 := to_unit(s28_brand);
    goto s28_hop_exit;
  s28_hop_exit:
  s29_block29:
    s29_l#l_quantity := Lineitem_l_quantity[s29_orderkey][s29_linenumber];
    s29_qty := s29_l#l_quantity;
    s29_#tmp85 := to_unit(s29_qty);
    goto s29_epilogue;
  s29_hop_exit:
  s28_epilogue:
  s29_epilogue:
