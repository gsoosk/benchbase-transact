...
procedure verify_hop_partitions_Q15(orderkey: int, linenumber: int, suppkey: int)
{
  var s24_l#l_discount : real;
  var s24_orderkey : int;
  var s24_linenumber : int;
  var s24_l#l_extendedprice : real;
  var s24_#tmp71 : real;
  var s24_#tmp72 : real;
  var s24_revenue : real;
  var s24_#tmp73 : unit;
  var s25_s#s_name : String;
  var s25_suppkey : int;
  var s25_sname : String;
  var s25_#tmp75 : unit;

  // Hop partition verification for function 'Q15'
  s24_block24:
    s24_l#l_discount := Lineitem_l_discount[s24_orderkey][s24_linenumber];
    s24_l#l_extendedprice := Lineitem_l_extendedprice[s24_orderkey][s24_linenumber];
  // Partition check hop 24 func 'f' tables 'Lineitem'=>'Lineitem' keys [k0=orderkey] first_span Span { start: 9524, end: 9580, filename: "/Users/farzad/Desktop/Research/benchbase-transact/tpch.transact" } current_span Span { start: 9524, end: 9580, filename: "/Users/farzad/Desktop/Research/benchbase-transact/tpch.transact" }
    assert {:msg "(PartitionFunctionInconsistency (partition_function_id . 15) (function_id . 27) (hop_id . 24) (table_id . 7) (span ((start . 9524) (end . 9580) (filename . \"/Users/farzad/Desktop/Research/benchbase-transact/tpch.transact\"))))"} (s24_orderkey == s24_orderkey);
    s24_#tmp71 := 1.0000000 - s24_l#l_discount;
    s24_#tmp72 := s24_l#l_extendedprice * s24_#tmp71;
    s24_revenue := s24_#tmp72;
    s24_#tmp73 := to_unit(s24_revenue);
    goto s24_hop_exit;
  s24_hop_exit:
  s25_block25:
    s25_s#s_name := Supplier_s_name[s25_suppkey];
    s25_sname := s25_s#s_name;
    s25_#tmp75 := to_unit(s25_sname);
    goto s25_epilogue;
  s25_hop_exit:
  s24_epilogue:
  s25_epilogue:
