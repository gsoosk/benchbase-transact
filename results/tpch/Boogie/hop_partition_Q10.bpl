...
procedure verify_hop_partitions_Q10(custkey: int, orderkey: int, linenumber: int, nationkey: int)
{
  var s13_#tmp40 : Row (Table (Customer));
  var s13_custkey : int;
  var s13_c : Row (Table (Customer));
  var s13_#tmp41 : unit;
  var s14_#tmp42 : Row (Table (Orders));
  var s14_orderkey : int;
  var s14_o : Row (Table (Orders));
  var s14_#tmp43 : unit;
  var s14_l#l_discount : real;
  var s14_linenumber : int;
  var s14_l#l_extendedprice : real;
  var s14_#tmp45 : real;
  var s14_#tmp46 : real;
  var s14_revenue : real;
  var s14_#tmp47 : unit;
  var s15_#tmp48 : Row (Table (Nation));
  var s15_nationkey : int;
  var s15_n : Row (Table (Nation));
  var s15_#tmp49 : unit;

  // Hop partition verification for function 'Q10'
  s13_block13:
    s13_#tmp40 := construct_Row_Customer(Customer_c_custkey[s13_custkey], Customer_c_name[s13_custkey], Customer_c_address[s13_custkey], Customer_c_nationkey[s13_custkey], Customer_c_phone[s13_custkey], Customer_c_acctbal[s13_custkey], Customer_c_mktsegment[s13_custkey], Customer_c_comment[s13_custkey]);
    s13_c := s13_#tmp40;
    s13_#tmp41 := to_unit(s13_c);
    goto s13_hop_exit;
  s13_hop_exit:
  s14_block14:
    s14_#tmp42 := construct_Row_Orders(Orders_o_orderkey[s14_orderkey], Orders_o_custkey[s14_orderkey], Orders_o_orderstatus[s14_orderkey], Orders_o_totalprice[s14_orderkey], Orders_o_orderdate[s14_orderkey], Orders_o_orderpriority[s14_orderkey], Orders_o_clerk[s14_orderkey], Orders_o_shippriority[s14_orderkey], Orders_o_comment[s14_orderkey]);
    s14_o := s14_#tmp42;
    s14_#tmp43 := to_unit(s14_o);
    s14_l#l_discount := Lineitem_l_discount[s14_orderkey][s14_linenumber];
  // Partition check hop 14 func 'f' tables 'Orders'=>'Lineitem' keys [k0=orderkey] first_span Span { start: 7133, end: 7161, filename: "/Users/farzad/Desktop/Research/benchbase-transact/tpch.transact" } current_span Span { start: 7214, end: 7270, filename: "/Users/farzad/Desktop/Research/benchbase-transact/tpch.transact" }
    assert {:msg "(PartitionFunctionInconsistency (partition_function_id . 15) (function_id . 22) (hop_id . 14) (table_id . 7) (span ((start . 7214) (end . 7270) (filename . \"/Users/farzad/Desktop/Research/benchbase-transact/tpch.transact\"))))"} (s14_orderkey == s14_orderkey);
    s14_l#l_extendedprice := Lineitem_l_extendedprice[s14_orderkey][s14_linenumber];
  // Partition check hop 14 func 'f' tables 'Orders'=>'Lineitem' keys [k0=orderkey] first_span Span { start: 7133, end: 7161, filename: "/Users/farzad/Desktop/Research/benchbase-transact/tpch.transact" } current_span Span { start: 7214, end: 7270, filename: "/Users/farzad/Desktop/Research/benchbase-transact/tpch.transact" }
    assert {:msg "(PartitionFunctionInconsistency (partition_function_id . 15) (function_id . 22) (hop_id . 14) (table_id . 7) (span ((start . 7214) (end . 7270) (filename . \"/Users/farzad/Desktop/Research/benchbase-transact/tpch.transact\"))))"} (s14_orderkey == s14_orderkey);
    s14_#tmp45 := 1.0000000 - s14_l#l_discount;
    s14_#tmp46 := s14_l#l_extendedprice * s14_#tmp45;
    s14_revenue := s14_#tmp46;
    s14_#tmp47 := to_unit(s14_revenue);
    goto s14_hop_exit;
  s14_hop_exit:
  s15_block15:
    s15_#tmp48 := construct_Row_Nation(Nation_n_nationkey[s15_nationkey], Nation_n_name[s15_nationkey], Nation_n_regionkey[s15_nationkey], Nation_n_comment[s15_nationkey]);
    s15_n := s15_#tmp48;
    s15_#tmp49 := to_unit(s15_n);
    goto s15_epilogue;
  s15_hop_exit:
  s13_epilogue:
  s14_epilogue:
