...
// Q4Hop0 lowers hop 0 containing 1 basic block(s).
func Q4Hop0(tx *bolt.Tx, in *proto.TrxReq) (*proto.TrxRes, error) {
...
func Q4NextReq(in *proto.TrxRes, params map[string]string, shards int) (*proto.TrxReq, map[string]string, int) {
	hopId := in.Info.Hopid
	...
	case 0:
		...
		nextShard = int(Q4Hop0Par(paramsCopy))
	default:
		return nil, params, 0
	}
...
func Q4ChainImpl(db *bolt.DB) *Chain {
	...
	// add field names
	return &Chain{db: db, hops: hops, NextReq: Q4NextReq}
}

// legacy: use json package to avoid unused import error
func Q4ToJSON(v interface{}) ([]byte, error) {
