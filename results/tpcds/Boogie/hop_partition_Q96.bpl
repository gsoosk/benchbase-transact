...
procedure verify_hop_partitions_Q96(item_sk: int, order_num: int, warehouse_sk: int, time_sk: int, date_sk: int)
{
  var s25_ws#ws_quantity : int;
  var s25_item_sk : int;
  var s25_order_num : int;
  var s25_qty : int;
  var s25_#tmp50 : unit;
  var s26_w#w_warehouse_name : String;
  var s26_warehouse_sk : int;
  var s26_wname : String;
  var s26_#tmp52 : unit;
  var s27_t#t_hour : int;
  var s27_time_sk : int;
  var s27_hr : int;
  var s27_#tmp54 : unit;
  var s28_d#d_year : int;
  var s28_date_sk : int;
  var s28_yr : int;
  var s28_#tmp56 : unit;

  // Hop partition verification for function 'Q96'
  s25_block25:
    s25_ws#ws_quantity := web_sales_ws_quantity[s25_item_sk][s25_order_num];
    s25_qty := s25_ws#ws_quantity;
    s25_#tmp50 := to_unit(s25_qty);
    goto s25_hop_exit;
  s25_hop_exit:
  s26_block26:
    s26_w#w_warehouse_name := warehouse_w_warehouse_name[s26_warehouse_sk];
    s26_wname := s26_w#w_warehouse_name;
    s26_#tmp52 := to_unit(s26_wname);
    goto s26_hop_exit;
  s26_hop_exit:
  s27_block27:
    s27_t#t_hour := time_dim_t_hour[s27_time_sk];
    s27_hr := s27_t#t_hour;
    s27_#tmp54 := to_unit(s27_hr);
    goto s27_hop_exit;
  s27_hop_exit:
  s28_block28:
    s28_d#d_year := date_dim_d_year[s28_date_sk];
    s28_yr := s28_d#d_year;
    s28_#tmp56 := to_unit(s28_yr);
    goto s28_epilogue;
  s28_hop_exit:
  s25_epilogue:
  s26_epilogue:
