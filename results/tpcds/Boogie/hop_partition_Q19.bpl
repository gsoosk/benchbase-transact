...
procedure verify_hop_partitions_Q19(item_sk: int, order_num: int, cust_sk: int, addr_sk: int, date_sk: int)
{
  var s12_cs#cs_ext_sales_price : real;
  var s12_item_sk : int;
  var s12_order_num : int;
  var s12_revenue : real;
  var s12_#tmp22 : unit;
  var s13_i#i_manufact : String;
  var s13_item_sk : int;
  var s13_brand : String;
  var s13_#tmp24 : unit;
  var s14_#tmp25 : Row (Table (customer));
  var s14_cust_sk : int;
  var s14_c : Row (Table (customer));
  var s14_#tmp26 : unit;
  var s15_ca#ca_state : String;
  var s15_addr_sk : int;
  var s15_state : String;
  var s15_#tmp28 : unit;
  var s16_#tmp29 : Row (Table (date_dim));
  var s16_date_sk : int;
  var s16_d : Row (Table (date_dim));
  var s16_#tmp30 : unit;

  // Hop partition verification for function 'Q19'
  s12_block12:
    s12_cs#cs_ext_sales_price := catalog_sales_cs_ext_sales_price[s12_item_sk][s12_order_num];
    s12_revenue := s12_cs#cs_ext_sales_price;
    s12_#tmp22 := to_unit(s12_revenue);
    goto s12_hop_exit;
  s12_hop_exit:
  s13_block13:
    s13_i#i_manufact := item_i_manufact[s13_item_sk];
    s13_brand := s13_i#i_manufact;
    s13_#tmp24 := to_unit(s13_brand);
    goto s13_hop_exit;
  s13_hop_exit:
  s14_block14:
    s14_#tmp25 := construct_Row_customer(customer_c_customer_sk[s14_cust_sk], customer_c_customer_id[s14_cust_sk], customer_c_first_name[s14_cust_sk], customer_c_last_name[s14_cust_sk], customer_c_birth_year[s14_cust_sk], customer_c_email_address[s14_cust_sk]);
    s14_c := s14_#tmp25;
    s14_#tmp26 := to_unit(s14_c);
    goto s14_hop_exit;
  s14_hop_exit:
  s15_block15:
    s15_ca#ca_state := customer_address_ca_state[s15_addr_sk];
    s15_state := s15_ca#ca_state;
    s15_#tmp28 := to_unit(s15_state);
    goto s15_hop_exit;
  s15_hop_exit:
  s16_block16:
    s16_#tmp29 := construct_Row_date_dim(date_dim_d_date_sk[s16_date_sk], date_dim_d_date[s16_date_sk], date_dim_d_year[s16_date_sk], date_dim_d_month_seq[s16_date_sk], date_dim_d_qoy[s16_date_sk], date_dim_d_moy[s16_date_sk], date_dim_d_day_name[s16_date_sk]);
    s16_d := s16_#tmp29;
    s16_#tmp30 := to_unit(s16_d);
    goto s16_epilogue;
  s16_hop_exit:
  s12_epilogue:
  s13_epilogue:
