...
procedure verify_hop_partitions_Q12(item_sk: int, order_num: int, date_sk: int)
{
  var s10_ws#ws_ext_sales_price : real;
  var s10_item_sk : int;
  var s10_order_num : int;
  var s10_#tmp16 : Row (Table (item));
  var s10_i : Row (Table (item));
  var s10_#tmp17 : unit;
  var s10_revenue : real;
  var s10_#tmp18 : unit;
  var s11_d#d_year : int;
  var s11_date_sk : int;
  var s11_yr : int;
  var s11_#tmp20 : unit;
  ...
  s10_block10:
    s10_ws#ws_ext_sales_price := web_sales_ws_ext_sales_price[s10_item_sk][s10_order_num];
    s10_#tmp16 := construct_Row_item(item_i_item_sk[s10_item_sk], item_i_item_id[s10_item_sk], item_i_item_desc[s10_item_sk], item_i_current_price[s10_item_sk], item_i_class[s10_item_sk], item_i_category[s10_item_sk], item_i_manufact[s10_item_sk]);
  // Partition check hop 10 func 'f_item' tables 'web_sales'=>'item' keys [k0=item_sk] first_span Span { start: 7462, end: 7520, filename: "/Users/farzad/Desktop/Research/benchbase-transact/tpcds.transact" } current_span Span { start: 7549, end: 7573, filename: "/Users/farzad/Desktop/Research/benchbase-transact/tpcds.transact" }
    assert {:msg "(PartitionFunctionInconsistency (partition_function_id . 15) (function_id . 21) (hop_id . 10) (table_id . 3) (span ((start . 7549) (end . 7573) (filename . \"/Users/farzad/Desktop/Research/benchbase-transact/tpcds.transact\"))))"} (s10_item_sk == s10_item_sk);
    s10_i := s10_#tmp16;
    s10_#tmp17 := to_unit(s10_i);
    s10_revenue := s10_ws#ws_ext_sales_price;
    s10_#tmp18 := to_unit(s10_revenue);
    goto s10_hop_exit;
  s10_hop_exit:
  s11_block11:
    s11_d#d_year := date_dim_d_year[s11_date_sk];
    s11_yr := s11_d#d_year;
    s11_#tmp20 := to_unit(s11_yr);
    goto s11_epilogue;
  s11_hop_exit:
  s10_epilogue:
  s11_epilogue:
