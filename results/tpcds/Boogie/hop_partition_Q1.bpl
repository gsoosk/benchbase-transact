...
procedure verify_hop_partitions_Q1(item_sk: int, ticket_num: int, store_sk: int, cust_sk: int)
{
  var s4_sr#sr_net_loss : real;
  var s4_item_sk : int;
  var s4_ticket_num : int;
  var s4_net_loss : real;
  var s4_#tmp1 : unit;
  var s5_s#s_store_name : String;
  var s5_store_sk : int;
  var s5_sname : String;
  var s5_#tmp3 : unit;
  var s6_c#c_first_name : String;
  var s6_cust_sk : int;
  var s6_cname : String;
  var s6_#tmp5 : unit;
  ...
  s4_block4:
    s4_sr#sr_net_loss := store_returns_sr_net_loss[s4_item_sk][s4_ticket_num];
    s4_net_loss := s4_sr#sr_net_loss;
    s4_#tmp1 := to_unit(s4_net_loss);
    goto s4_hop_exit;
  s4_hop_exit:
  s5_block5:
    s5_s#s_store_name := store_s_store_name[s5_store_sk];
    s5_sname := s5_s#s_store_name;
    s5_#tmp3 := to_unit(s5_sname);
    goto s5_hop_exit;
  s5_hop_exit:
  s6_block6:
    s6_c#c_first_name := customer_c_first_name[s6_cust_sk];
    s6_cname := s6_c#c_first_name;
    s6_#tmp5 := to_unit(s6_cname);
    goto s6_epilogue;
  s6_hop_exit:
  s4_epilogue:
  s5_epilogue:
