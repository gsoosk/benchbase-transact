...
{
  var s17_ss#ss_quantity : int;
  var s17_item_sk : int;
  var s17_ticket_num : int;
  var s17_qty : int;
  var s17_#tmp32 : unit;
  var s18_#tmp33 : Row (Table (customer));
  var s18_cust_sk : int;
  var s18_c : Row (Table (customer));
  var s18_#tmp34 : unit;
  var s19_cd#cd_marital_status : String;
  var s19_cd_sk : int;
  var s19_marital : String;
  var s19_#tmp36 : unit;
  var s20_#tmp37 : Row (Table (store));
  var s20_store_sk : int;
  var s20_s : Row (Table (store));
  var s20_#tmp38 : unit;
  var s21_d#d_year : int;
  var s21_date_sk : int;
  var s21_yr : int;
  var s21_#tmp40 : unit;
  ...
  s17_block17:
    s17_ss#ss_quantity := store_sales_ss_quantity[s17_item_sk][s17_ticket_num];
    s17_qty := s17_ss#ss_quantity;
    s17_#tmp32 := to_unit(s17_qty);
    goto s17_hop_exit;
  s17_hop_exit:
  s18_block18:
    s18_#tmp33 := construct_Row_customer(customer_c_customer_sk[s18_cust_sk], customer_c_customer_id[s18_cust_sk], customer_c_first_name[s18_cust_sk], customer_c_last_name[s18_cust_sk], customer_c_birth_year[s18_cust_sk], customer_c_email_address[s18_cust_sk]);
    s18_c := s18_#tmp33;
    s18_#tmp34 := to_unit(s18_c);
    goto s18_hop_exit;
  s18_hop_exit:
  s19_block19:
    s19_cd#cd_marital_status := customer_demographics_cd_marital_status[s19_cd_sk];
    s19_marital := s19_cd#cd_marital_status;
    s19_#tmp36 := to_unit(s19_marital);
    goto s19_hop_exit;
  s19_hop_exit:
  s20_block20:
    s20_#tmp37 := construct_Row_store(store_s_store_sk[s20_store_sk], store_s_store_id[s20_store_sk], store_s_store_name[s20_store_sk], store_s_number_employees[s20_store_sk], store_s_state[s20_store_sk], store_s_country[s20_store_sk]);
    s20_s := s20_#tmp37;
    s20_#tmp38 := to_unit(s20_s);
    goto s20_hop_exit;
  s20_hop_exit:
  s21_block21:
    s21_d#d_year := date_dim_d_year[s21_date_sk];
    s21_yr := s21_d#d_year;
    s21_#tmp40 := to_unit(s21_yr);
    goto s21_epilogue;
  s21_hop_exit:
  s17_epilogue:
  s18_epilogue:
