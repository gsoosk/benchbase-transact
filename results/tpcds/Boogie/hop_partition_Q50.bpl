...
procedure verify_hop_partitions_Q50(item_sk: int, ticket_num: int, ret_date_sk: int, store_sk: int)
{
  var s22_sr#sr_return_amount : real;
  var s22_item_sk : int;
  var s22_ticket_num : int;
  var s22_ss#ss_net_paid : real;
  var s22_ret_amt : real;
  var s22_#tmp43 : unit;
  var s22_sale_amt : real;
  var s22_#tmp44 : unit;
  var s23_s#s_store_name : String;
  var s23_store_sk : int;
  var s23_sname : String;
  var s23_#tmp46 : unit;
  var s24_d#d_year : int;
  var s24_ret_date_sk : int;
  var s24_yr : int;
  var s24_#tmp48 : unit;

  // Hop partition verification for function 'Q50'
  s22_block22:
    s22_sr#sr_return_amount := store_returns_sr_return_amount[s22_item_sk][s22_ticket_num];
    s22_ss#ss_net_paid := store_sales_ss_net_paid[s22_item_sk][s22_ticket_num];
  // Partition check hop 22 func 'f_item' tables 'store_returns'=>'store_sales' keys [k0=item_sk] first_span Span { start: 10158, end: 10222, filename: "/Users/farzad/Desktop/Research/benchbase-transact/tpcds.transact" } current_span Span { start: 10259, end: 10321, filename: "/Users/farzad/Desktop/Research/benchbase-transact/tpcds.transact" }
    assert {:msg "(PartitionFunctionInconsistency (partition_function_id . 15) (function_id . 24) (hop_id . 22) (table_id . 9) (span ((start . 10259) (end . 10321) (filename . \"/Users/farzad/Desktop/Research/benchbase-transact/tpcds.transact\"))))"} (s22_item_sk == s22_item_sk);
    s22_ret_amt := s22_sr#sr_return_amount;
    s22_#tmp43 := to_unit(s22_ret_amt);
    s22_sale_amt := s22_ss#ss_net_paid;
    s22_#tmp44 := to_unit(s22_sale_amt);
    goto s22_hop_exit;
  s22_hop_exit:
  s23_block23:
    s23_s#s_store_name := store_s_store_name[s23_store_sk];
    s23_sname := s23_s#s_store_name;
    s23_#tmp46 := to_unit(s23_sname);
    goto s23_hop_exit;
  s23_hop_exit:
  s24_block24:
    s24_d#d_year := date_dim_d_year[s24_ret_date_sk];
    s24_yr := s24_d#d_year;
    s24_#tmp48 := to_unit(s24_yr);
    goto s24_epilogue;
  s24_hop_exit:
  s22_epilogue:
  s23_epilogue:
