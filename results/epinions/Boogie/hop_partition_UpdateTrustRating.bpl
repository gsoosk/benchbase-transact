...
{
  var s12_t#source_u_id : int;
  var s12_source_uid : int;
  var s12_target_uid : int;
  var s12_t#target_u_id : int;
  var s12_t#trust : int;
  var s12_trust_val : int;

  // Hop partition verification for function 'UpdateTrustRating'
  s12_block12:
