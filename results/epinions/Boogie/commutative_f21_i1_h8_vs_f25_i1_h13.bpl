...
modifies useracct_name, useracct_u_id;
{
  ...
  // Verifying A->B === B->A equivalence:
    assert {:msg "(SpecialInterleavingNonEquivalence (node_1 (function_id . 21) (instance . 1) (hop_id . 8)) (node_2 (function_id . 25) (instance . 1) (hop_id . 13)))"} ((((useracct_name_a_then_b == useracct_name_b_then_a) && (useracct_u_id_a_then_b == useracct_u_id_b_then_a)) && (s0_uid_a_then_b == s0_uid_b_then_a)) && (s0_iid_a_then_b == s0_iid_b_then_a));
}
