...
modifies item_i_id, item_title, review_creation_date, review_rating;
{
  ...
  // Verifying A->B === B->A equivalence:
    assert {:msg "(SpecialInterleavingNonEquivalence (node_1 (function_id . 20) (instance . 0) (hop_id . 7)) (node_2 (function_id . 22) (instance . 0) (hop_id . 10)))"} ((item_i_id_a_then_b == item_i_id_b_then_a) && (item_title_a_then_b == item_title_b_then_a));
}
