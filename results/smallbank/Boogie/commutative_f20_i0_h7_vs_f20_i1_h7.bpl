...
modifies Accounts_name, Savings_bal, Savings_custid;
{
  var s0_custId : int;
  var s0_amount : real;
  var s1_custId : int;
  ...
  // Verifying A->B === B->A equivalence:
    assert {:msg "(SpecialInterleavingNonEquivalence (node_1 (function_id . 20) (instance . 0) (hop_id . 7)) (node_2 (function_id . 20) (instance . 1) (hop_id . 7)))"} ((Savings_bal_a_then_b == Savings_bal_b_then_a) && (Savings_custid_a_then_b == Savings_custid_b_then_a));
}
