...
modifies Accounts_name, Checking_bal, Checking_custid, Savings_bal;
{
  ...
  // Verifying A->B === B->A equivalence:
    assert {:msg "(SpecialInterleavingNonEquivalence (node_1 (function_id . 18) (instance . 1) (hop_id . 4)) (node_2 (function_id . 21) (instance . 0) (hop_id . 8)))"} ((Checking_bal_a_then_b == Checking_bal_b_then_a) && (Checking_custid_a_then_b == Checking_custid_b_then_a));
}
