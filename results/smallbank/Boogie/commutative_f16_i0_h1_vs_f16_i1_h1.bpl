...
modifies Checking_bal, Checking_custid, Savings_bal, Savings_custid;
{
  ...
  var s1_custId0_init : int;
  var s1_custId1_init : int;
  var s0_s0#bal : real;
  ...
  var s1_custId1_a_then_b : int;
  var s1_total_a_then_b : real;
  ...
  var s1_custId1_b_then_a : int;
  var s1_total_b_then_a : real;
  ...
  // --- Step 2: Save initial state ---
    ...
    s1_custId0_init := s1_custId0;
    s1_custId1_init := s1_custId1;
  ...
  // Snapshotting final state for a_then_b
    ...
    s1_custId1_a_then_b := s1_custId1;
    s1_total_a_then_b := s1_total;
  // Restoring initial state:
    ...
    s1_custId0 := s1_custId0_init;
    s1_custId1 := s1_custId1_init;
    s0_active := true;
    s1_active := true;
  // Executing B then A:
    if (s1_active) {
  ...
  // Snapshotting final state for b_then_a
    ...
    s1_custId1_b_then_a := s1_custId1;
    s1_total_b_then_a := s1_total;
  // --- Step 4: Verify A→B ≡ B→A (Special interleavings equivalence) ---
  // Verifying A->B === B->A equivalence:
    assert {:msg "(SpecialInterleavingNonEquivalence (node_1 (function_id . 16) (instance . 0) (hop_id . 1)) (node_2 (function_id . 16) (instance . 1) (hop_id . 1)))"} ((((((((Checking_bal_a_then_b == Checking_bal_b_then_a) && (Checking_custid_a_then_b == Checking_custid_b_then_a)) && (Savings_bal_a_then_b == Savings_bal_b_then_a)) && (Savings_custid_a_then_b == Savings_custid_b_then_a)) && (s0_custId1_a_then_b == s0_custId1_b_then_a)) && (s0_total_a_then_b == s0_total_b_then_a)) && (s1_custId1_a_then_b == s1_custId1_b_then_a)) && (s1_total_a_then_b == s1_total_b_then_a));
}
