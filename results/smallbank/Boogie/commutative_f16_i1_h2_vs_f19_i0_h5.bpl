...
modifies Checking_bal, Checking_custid;
{
  ...
  // Verifying A->B === B->A equivalence:
    assert {:msg "(SpecialInterleavingNonEquivalence (node_1 (function_id . 16) (instance . 1) (hop_id . 2)) (node_2 (function_id . 19) (instance . 0) (hop_id . 5)))"} ((((Checking_bal_a_then_b == Checking_bal_b_then_a) && (Checking_custid_a_then_b == Checking_custid_b_then_a)) && (s1_destAcct_a_then_b == s1_destAcct_b_then_a)) && (s1_amount_a_then_b == s1_amount_b_then_a));
}
