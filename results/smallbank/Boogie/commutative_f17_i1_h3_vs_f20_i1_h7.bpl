...
modifies Accounts_name, Checking_bal, Savings_bal, Savings_custid;
{
  ...
  // Verifying A->B === B->A equivalence:
    assert {:msg "(SpecialInterleavingNonEquivalence (node_1 (function_id . 17) (instance . 1) (hop_id . 3)) (node_2 (function_id . 20) (instance . 1) (hop_id . 7)))"} ((Savings_bal_a_then_b == Savings_bal_b_then_a) && (Savings_custid_a_then_b == Savings_custid_b_then_a));
}
