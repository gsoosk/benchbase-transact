...
{
  var s10_c#ic_buyer_id : int;
  var s10_comment_id : int;
  var s10_item_id : int;
  var s10_seller_id : int;
  var s10_c#ic_i_id : int;
  var s10_c#ic_id : int;
  var s10_c#ic_question : String;
  var s10_c#ic_u_id : int;
  var s10_c#ic_response : String;
  var s10_response : String;
  var s10_seller#u_balance : real;
  var s10_seller#u_comments : int;
  var s10_seller#u_id : int;
  var s10_seller#u_r_id : int;
  var s10_seller#u_rating : int;
  var s10_seller#u_sattr0 : String;
  var s10_seller#u_sattr1 : String;
