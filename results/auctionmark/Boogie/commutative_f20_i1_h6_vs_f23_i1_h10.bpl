...
modifies ITEM_COMMENT_ic_buyer_id, ITEM_COMMENT_ic_i_id, ITEM_COMMENT_ic_id, ITEM_COMMENT_ic_question, ITEM_COMMENT_ic_response, ITEM_COMMENT_ic_u_id, ITEM_i_c_id, ITEM_i_current_price, ITEM_i_end_date, ITEM_i_initial_price, ITEM_i_name, ITEM_i_num_bids, ITEM_i_num_comments, ITEM_i_start_date, ITEM_i_status, USERACCT_FEEDBACK_uf_rating, USERACCT_u_balance, USERACCT_u_comments, USERACCT_u_id, USERACCT_u_r_id, USERACCT_u_rating, USERACCT_u_sattr0, USERACCT_u_sattr1, USERACCT_u_sattr2, USERACCT_u_sattr3, USERACCT_u_sattr4;
{
  ...
  var s0_#tmp16 : unit;
  var s1_c#ic_buyer_id : int;
  var s1_c#ic_i_id : int;
  var s1_c#ic_id : int;
  var s1_c#ic_question : String;
  var s1_c#ic_u_id : int;
  var s1_c#ic_response : String;
  ...
  // Slice commutativity verification: hop 6 vs hop 10
  ...
  // Executing A then B:
    ...
    if (s1_active) {
    s1_block14__ab:
      s1_c#ic_buyer_id := ITEM_COMMENT_ic_buyer_id[s1_comment_id][s1_item_id][s1_seller_id];
      s1_c#ic_i_id := ITEM_COMMENT_ic_i_id[s1_comment_id][s1_item_id][s1_seller_id];
      s1_c#ic_id := ITEM_COMMENT_ic_id[s1_comment_id][s1_item_id][s1_seller_id];
      s1_c#ic_question := ITEM_COMMENT_ic_question[s1_comment_id][s1_item_id][s1_seller_id];
      s1_c#ic_u_id := ITEM_COMMENT_ic_u_id[s1_comment_id][s1_item_id][s1_seller_id];
      s1_c#ic_response := s1_response;
      ITEM_COMMENT_ic_buyer_id := ITEM_COMMENT_ic_buyer_id[s1_comment_id := ITEM_COMMENT_ic_buyer_id[s1_comment_id][s1_item_id := ITEM_COMMENT_ic_buyer_id[s1_comment_id][s1_item_id][s1_seller_id := s1_c#ic_buyer_id]]];
      ITEM_COMMENT_ic_i_id := ITEM_COMMENT_ic_i_id[s1_comment_id := ITEM_COMMENT_ic_i_id[s1_comment_id][s1_item_id := ITEM_COMMENT_ic_i_id[s1_comment_id][s1_item_id][s1_seller_id := s1_c#ic_i_id]]];
      ITEM_COMMENT_ic_id := ITEM_COMMENT_ic_id[s1_comment_id := ITEM_COMMENT_ic_id[s1_comment_id][s1_item_id := ITEM_COMMENT_ic_id[s1_comment_id][s1_item_id][s1_seller_id := s1_c#ic_id]]];
      ITEM_COMMENT_ic_question := ITEM_COMMENT_ic_question[s1_comment_id := ITEM_COMMENT_ic_question[s1_comment_id][s1_item_id := ITEM_COMMENT_ic_question[s1_comment_id][s1_item_id][s1_seller_id := s1_c#ic_question]]];
      ITEM_COMMENT_ic_response := ITEM_COMMENT_ic_response[s1_comment_id := ITEM_COMMENT_ic_response[s1_comment_id][s1_item_id := ITEM_COMMENT_ic_response[s1_comment_id][s1_item_id][s1_seller_id := s1_c#ic_response]]];
      ITEM_COMMENT_ic_u_id := ITEM_COMMENT_ic_u_id[s1_comment_id := ITEM_COMMENT_ic_u_id[s1_comment_id][s1_item_id := ITEM_COMMENT_ic_u_id[s1_comment_id][s1_item_id][s1_seller_id := s1_c#ic_u_id]]];
      ...
      s1_#tmp31 := s1_seller#u_comments - 1;
      s1_seller#u_comments := s1_#tmp31;
