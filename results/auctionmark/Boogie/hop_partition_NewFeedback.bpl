...
modifies USERACCT_FEEDBACK_uf_rating, USERACCT_u_balance, USERACCT_u_comments, USERACCT_u_id, USERACCT_u_r_id, USERACCT_u_rating, USERACCT_u_sattr0, USERACCT_u_sattr1, USERACCT_u_sattr2, USERACCT_u_sattr3, USERACCT_u_sattr4;
{
  var s11_to_id : int;
  var s11_item_id : int;
  var s11_seller_id : int;
  var s11_from_id : int;
  var s11_rating : int;
  var s11_u#u_balance : real;
  var s11_u#u_comments : int;
  var s11_u#u_id : int;
  var s11_u#u_r_id : int;
  var s11_u#u_rating : int;
  var s11_u#u_sattr0 : String;
  var s11_u#u_sattr1 : String;
