...
procedure Check_SliceCommut_Hop14_vs_Hop14()
modifies USERACCT_u_balance, USERACCT_u_comments, USERACCT_u_id, USERACCT_u_r_id, USERACCT_u_rating, USERACCT_u_sattr0, USERACCT_u_sattr1, USERACCT_u_sattr2, USERACCT_u_sattr3, USERACCT_u_sattr4;
{
  var s0_buyer_id : int;
  ...
  var s0_buyer#u_balance : real;
  var s0_buyer#u_comments : int;
  var s0_buyer#u_id : int;
  var s0_buyer#u_r_id : int;
  var s0_buyer#u_rating : int;
  var s0_buyer#u_sattr0 : String;
  var s0_buyer#u_sattr1 : String;
  var s0_buyer#u_sattr2 : String;
  var s0_buyer#u_sattr3 : String;
  var s0_buyer#u_sattr4 : String;
  var s0_#tmp32 : real;
  ...
  // Slice commutativity verification: hop 14 vs hop 14
  ...
  // Executing A then B:
    if (s0_active) {
    s0_block18__ab:
      s0_buyer#u_balance := USERACCT_u_balance[s0_buyer_id];
      s0_buyer#u_comments := USERACCT_u_comments[s0_buyer_id];
      s0_buyer#u_id := USERACCT_u_id[s0_buyer_id];
      s0_buyer#u_r_id := USERACCT_u_r_id[s0_buyer_id];
      s0_buyer#u_rating := USERACCT_u_rating[s0_buyer_id];
      s0_buyer#u_sattr0 := USERACCT_u_sattr0[s0_buyer_id];
      s0_buyer#u_sattr1 := USERACCT_u_sattr1[s0_buyer_id];
      s0_buyer#u_sattr2 := USERACCT_u_sattr2[s0_buyer_id];
      s0_buyer#u_sattr3 := USERACCT_u_sattr3[s0_buyer_id];
      s0_buyer#u_sattr4 := USERACCT_u_sattr4[s0_buyer_id];
      s0_#tmp32 := s0_buyer#u_balance - s0_buy_now_price;
      s0_buyer#u_balance := s0_#tmp32;
      USERACCT_u_balance := USERACCT_u_balance[s0_buyer_id := s0_buyer#u_balance];
      USERACCT_u_comments := USERACCT_u_comments[s0_buyer_id := s0_buyer#u_comments];
      USERACCT_u_id := USERACCT_u_id[s0_buyer_id := s0_buyer#u_id];
      USERACCT_u_r_id := USERACCT_u_r_id[s0_buyer_id := s0_buyer#u_r_id];
      USERACCT_u_rating := USERACCT_u_rating[s0_buyer_id := s0_buyer#u_rating];
      USERACCT_u_sattr0 := USERACCT_u_sattr0[s0_buyer_id := s0_buyer#u_sattr0];
      USERACCT_u_sattr1 := USERACCT_u_sattr1[s0_buyer_id := s0_buyer#u_sattr1];
      USERACCT_u_sattr2 := USERACCT_u_sattr2[s0_buyer_id := s0_buyer#u_sattr2];
      USERACCT_u_sattr3 := USERACCT_u_sattr3[s0_buyer_id := s0_buyer#u_sattr3];
      USERACCT_u_sattr4 := USERACCT_u_sattr4[s0_buyer_id := s0_buyer#u_sattr4];
      s0_active := false;
