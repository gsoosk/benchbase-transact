...
procedure verify_hop_partitions_GetUserInfo(user_id: int, other_user_id: int, item_id: int, comment_id: int)
{
  var s6_#tmp9 : Row (Table (USERACCT));
  var s6_user_id : int;
  var s6_u : Row (Table (USERACCT));
  var s6_#tmp10 : unit;
  var s6_#tmp11 : Row (Table (USERACCT_FEEDBACK));
  var s6_item_id : int;
  var s6_other_user_id : int;
  var s6_feedback : Row (Table (USERACCT_FEEDBACK));
  var s6_#tmp12 : unit;
  var s6_#tmp13 : Row (Table (ITEM_COMMENT));
  var s6_comment_id : int;
  var s6_comment : Row (Table (ITEM_COMMENT));
  var s6_#tmp14 : unit;
  var s6_#tmp15 : Row (Table (ITEM));
  var s6_item : Row (Table (ITEM));
  var s6_#tmp16 : unit;
  var s7_#tmp17 : Row (Table (USERACCT_ITEM));
  var s7_user_id : int;
  var s7_item_id : int;
  var s7_other_user_id : int;
  var s7_purchase : Row (Table (USERACCT_ITEM));
  var s7_#tmp18 : unit;
  var s7_#tmp19 : Row (Table (USERACCT_WATCH));
  var s7_watch : Row (Table (USERACCT_WATCH));
  var s7_#tmp20 : unit;

  // Hop partition verification for function 'GetUserInfo'
  s6_block6:
    s6_#tmp9 := construct_Row_USERACCT(USERACCT_u_id[s6_user_id], USERACCT_u_rating[s6_user_id], USERACCT_u_balance[s6_user_id], USERACCT_u_comments[s6_user_id], USERACCT_u_r_id[s6_user_id], USERACCT_u_sattr0[s6_user_id], USERACCT_u_sattr1[s6_user_id], USERACCT_u_sattr2[s6_user_id], USERACCT_u_sattr3[s6_user_id], USERACCT_u_sattr4[s6_user_id]);
    s6_u := s6_#tmp9;
    s6_#tmp10 := to_unit(s6_u);
    s6_#tmp11 := construct_Row_USERACCT_FEEDBACK(USERACCT_FEEDBACK_uf_u_id[s6_user_id][s6_item_id][s6_other_user_id][s6_other_user_id], USERACCT_FEEDBACK_uf_i_id[s6_user_id][s6_item_id][s6_other_user_id][s6_other_user_id], USERACCT_FEEDBACK_uf_i_u_id[s6_user_id][s6_item_id][s6_other_user_id][s6_other_user_id], USERACCT_FEEDBACK_uf_from_id[s6_user_id][s6_item_id][s6_other_user_id][s6_other_user_id], USERACCT_FEEDBACK_uf_rating[s6_user_id][s6_item_id][s6_other_user_id][s6_other_user_id]);
  // Partition check hop 6 func 'p_user' tables 'USERACCT'=>'USERACCT_FEEDBACK' keys [k0=user_id] first_span Span { start: 7844, end: 7867, filename: "/Users/farzad/Desktop/Research/benchbase-transact/auctionmark.transact" } current_span Span { start: 7936, end: 8240, filename: "/Users/farzad/Desktop/Research/benchbase-transact/auctionmark.transact" }
    assert {:msg "(PartitionFunctionInconsistency (partition_function_id . 15) (function_id . 20) (hop_id . 6) (table_id . 7) (span ((start . 7936) (end . 8240) (filename . \"/Users/farzad/Desktop/Research/benchbase-transact/auctionmark.transact\"))))"} (s6_user_id == s6_user_id);
    s6_feedback := s6_#tmp11;
    s6_#tmp12 := to_unit(s6_feedback);
    s6_#tmp13 := construct_Row_ITEM_COMMENT(ITEM_COMMENT_ic_id[s6_comment_id][s6_item_id][s6_user_id], ITEM_COMMENT_ic_i_id[s6_comment_id][s6_item_id][s6_user_id], ITEM_COMMENT_ic_u_id[s6_comment_id][s6_item_id][s6_user_id], ITEM_COMMENT_ic_buyer_id[s6_comment_id][s6_item_id][s6_user_id], ITEM_COMMENT_ic_question[s6_comment_id][s6_item_id][s6_user_id], ITEM_COMMENT_ic_response[s6_comment_id][s6_item_id][s6_user_id]);
  // Partition check hop 6 func 'p_user' tables 'USERACCT'=>'ITEM_COMMENT' keys [k0=user_id] first_span Span { start: 7844, end: 7867, filename: "/Users/farzad/Desktop/Research/benchbase-transact/auctionmark.transact" } current_span Span { start: 8310, end: 8487, filename: "/Users/farzad/Desktop/Research/benchbase-transact/auctionmark.transact" }
    assert {:msg "(PartitionFunctionInconsistency (partition_function_id . 15) (function_id . 20) (hop_id . 6) (table_id . 5) (span ((start . 8310) (end . 8487) (filename . \"/Users/farzad/Desktop/Research/benchbase-transact/auctionmark.transact\"))))"} (s6_user_id == s6_user_id);
    s6_comment := s6_#tmp13;
    s6_#tmp14 := to_unit(s6_comment);
    s6_#tmp15 := construct_Row_ITEM(ITEM_i_id[s6_item_id][s6_user_id], ITEM_i_u_id[s6_item_id][s6_user_id], ITEM_i_name[s6_item_id][s6_user_id], ITEM_i_initial_price[s6_item_id][s6_user_id], ITEM_i_current_price[s6_item_id][s6_user_id], ITEM_i_num_bids[s6_item_id][s6_user_id], ITEM_i_end_date[s6_item_id][s6_user_id], ITEM_i_start_date[s6_item_id][s6_user_id], ITEM_i_status[s6_item_id][s6_user_id], ITEM_i_num_comments[s6_item_id][s6_user_id], ITEM_i_c_id[s6_item_id][s6_user_id]);
  // Partition check hop 6 func 'p_user' tables 'USERACCT'=>'ITEM' keys [k0=user_id] first_span Span { start: 7844, end: 7867, filename: "/Users/farzad/Desktop/Research/benchbase-transact/auctionmark.transact" } current_span Span { start: 8545, end: 8581, filename: "/Users/farzad/Desktop/Research/benchbase-transact/auctionmark.transact" }
    assert {:msg "(PartitionFunctionInconsistency (partition_function_id . 15) (function_id . 20) (hop_id . 6) (table_id . 2) (span ((start . 8545) (end . 8581) (filename . \"/Users/farzad/Desktop/Research/benchbase-transact/auctionmark.transact\"))))"} (s6_user_id == s6_user_id);
    s6_item := s6_#tmp15;
    s6_#tmp16 := to_unit(s6_item);
    goto s6_hop_exit;
  s6_hop_exit:
  s7_block7:
    s7_#tmp17 := construct_Row_USERACCT_ITEM(USERACCT_ITEM_ui_u_id[s7_user_id][s7_item_id][s7_other_user_id], USERACCT_ITEM_ui_i_id[s7_user_id][s7_item_id][s7_other_user_id], USERACCT_ITEM_ui_i_u_id[s7_user_id][s7_item_id][s7_other_user_id]);
    s7_purchase := s7_#tmp17;
    s7_#tmp18 := to_unit(s7_purchase);
    s7_#tmp19 := construct_Row_USERACCT_WATCH(USERACCT_WATCH_uw_u_id[s7_user_id][s7_item_id][s7_other_user_id], USERACCT_WATCH_uw_i_id[s7_user_id][s7_item_id][s7_other_user_id], USERACCT_WATCH_uw_i_u_id[s7_user_id][s7_item_id][s7_other_user_id]);
  // Partition check hop 7 func 'p_user' tables 'USERACCT_ITEM'=>'USERACCT_WATCH' keys [k0=user_id] first_span Span { start: 8665, end: 8856, filename: "/Users/farzad/Desktop/Research/benchbase-transact/auctionmark.transact" } current_span Span { start: 8926, end: 9116, filename: "/Users/farzad/Desktop/Research/benchbase-transact/auctionmark.transact" }
    assert {:msg "(PartitionFunctionInconsistency (partition_function_id . 15) (function_id . 20) (hop_id . 7) (table_id . 8) (span ((start . 8926) (end . 9116) (filename . \"/Users/farzad/Desktop/Research/benchbase-transact/auctionmark.transact\"))))"} (s7_user_id == s7_user_id);
    s7_watch := s7_#tmp19;
    s7_#tmp20 := to_unit(s7_watch);
    goto s7_epilogue;
  s7_hop_exit:
  s6_epilogue:
  s7_epilogue:
