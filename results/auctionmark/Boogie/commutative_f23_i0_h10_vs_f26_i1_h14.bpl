...
procedure Check_SliceCommut_Hop10_vs_Hop14()
modifies ITEM_COMMENT_ic_buyer_id, ITEM_COMMENT_ic_i_id, ITEM_COMMENT_ic_id, ITEM_COMMENT_ic_question, ITEM_COMMENT_ic_response, ITEM_COMMENT_ic_u_id, USERACCT_u_balance, USERACCT_u_comments, USERACCT_u_id, USERACCT_u_r_id, USERACCT_u_rating, USERACCT_u_sattr0, USERACCT_u_sattr1, USERACCT_u_sattr2, USERACCT_u_sattr3, USERACCT_u_sattr4;
{
  ...
  var s1_buy_now_price_init : real;
  ...
  var s0_#tmp31 : int;
  var s1_buyer#u_balance : real;
  var s1_buyer#u_comments : int;
  var s1_buyer#u_id : int;
  var s1_buyer#u_r_id : int;
  var s1_buyer#u_rating : int;
  var s1_buyer#u_sattr0 : String;
  var s1_buyer#u_sattr1 : String;
  var s1_buyer#u_sattr2 : String;
  var s1_buyer#u_sattr3 : String;
  var s1_buyer#u_sattr4 : String;
  var s1_#tmp40 : real;
  ...
  // Slice commutativity verification: hop 10 vs hop 14
  ...
  // --- Step 2: Save initial state ---
    ...
    s1_buy_now_price_init := s1_buy_now_price;
  ...
  // Executing A then B:
    ...
    if (s1_active) {
    s1_block18__ab:
      s1_buyer#u_balance := USERACCT_u_balance[s1_buyer_id];
      s1_buyer#u_comments := USERACCT_u_comments[s1_buyer_id];
      s1_buyer#u_id := USERACCT_u_id[s1_buyer_id];
      s1_buyer#u_r_id := USERACCT_u_r_id[s1_buyer_id];
      s1_buyer#u_rating := USERACCT_u_rating[s1_buyer_id];
      s1_buyer#u_sattr0 := USERACCT_u_sattr0[s1_buyer_id];
      s1_buyer#u_sattr1 := USERACCT_u_sattr1[s1_buyer_id];
      s1_buyer#u_sattr2 := USERACCT_u_sattr2[s1_buyer_id];
      s1_buyer#u_sattr3 := USERACCT_u_sattr3[s1_buyer_id];
      s1_buyer#u_sattr4 := USERACCT_u_sattr4[s1_buyer_id];
      s1_#tmp40 := s1_buyer#u_balance - s1_buy_now_price;
      s1_buyer#u_balance := s1_#tmp40;
      USERACCT_u_balance := USERACCT_u_balance[s1_buyer_id := s1_buyer#u_balance];
      USERACCT_u_comments := USERACCT_u_comments[s1_buyer_id := s1_buyer#u_comments];
      USERACCT_u_id := USERACCT_u_id[s1_buyer_id := s1_buyer#u_id];
      USERACCT_u_r_id := USERACCT_u_r_id[s1_buyer_id := s1_buyer#u_r_id];
      USERACCT_u_rating := USERACCT_u_rating[s1_buyer_id := s1_buyer#u_rating];
      USERACCT_u_sattr0 := USERACCT_u_sattr0[s1_buyer_id := s1_buyer#u_sattr0];
      USERACCT_u_sattr1 := USERACCT_u_sattr1[s1_buyer_id := s1_buyer#u_sattr1];
      USERACCT_u_sattr2 := USERACCT_u_sattr2[s1_buyer_id := s1_buyer#u_sattr2];
      USERACCT_u_sattr3 := USERACCT_u_sattr3[s1_buyer_id := s1_buyer#u_sattr3];
      USERACCT_u_sattr4 := USERACCT_u_sattr4[s1_buyer_id := s1_buyer#u_sattr4];
      s1_active := false;
  ...
  // Restoring initial state:
    ...
    s1_buy_now_price := s1_buy_now_price_init;
    s0_active := true;
    s1_active := true;
  // Executing B then A:
    if (s1_active) {
