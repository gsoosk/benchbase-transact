...
modifies ITEM_COMMENT_ic_buyer_id, ITEM_COMMENT_ic_i_id, ITEM_COMMENT_ic_id, ITEM_COMMENT_ic_question, ITEM_COMMENT_ic_response, ITEM_COMMENT_ic_u_id, USERACCT_FEEDBACK_uf_rating, USERACCT_u_balance, USERACCT_u_comments, USERACCT_u_id, USERACCT_u_r_id, USERACCT_u_rating, USERACCT_u_sattr0, USERACCT_u_sattr1, USERACCT_u_sattr2, USERACCT_u_sattr3, USERACCT_u_sattr4;
{
  ...
  var ITEM_COMMENT_ic_i_id_init : [int][int][int]int;
  var ITEM_COMMENT_ic_id_init : [int][int][int]int;
  var ITEM_COMMENT_ic_question_init : [int][int][int]String;
  var ITEM_COMMENT_ic_response_init : [int][int][int]String;
  var ITEM_COMMENT_ic_u_id_init : [int][int][int]int;
  ...
  var s0_response_init : String;
  var s1_from_id_init : int;
  var s1_to_id_init : int;
  var s1_item_id_init : int;
  var s1_seller_id_init : int;
  var s1_rating_init : int;
  var s0_c#ic_buyer_id : int;
  var s0_c#ic_i_id : int;
  var s0_c#ic_id : int;
  var s0_c#ic_question : String;
  var s0_c#ic_u_id : int;
  var s0_c#ic_response : String;
  var s0_seller#u_balance : real;
  var s0_seller#u_comments : int;
  var s0_seller#u_id : int;
  var s0_seller#u_r_id : int;
  var s0_seller#u_rating : int;
  var s0_seller#u_sattr0 : String;
  var s0_seller#u_sattr1 : String;
  var s0_seller#u_sattr2 : String;
  var s0_seller#u_sattr3 : String;
  var s0_seller#u_sattr4 : String;
  var s0_#tmp23 : int;
  var s1_u#u_balance : real;
  var s1_u#u_comments : int;
  var s1_u#u_id : int;
  var s1_u#u_r_id : int;
  var s1_u#u_rating : int;
  var s1_u#u_sattr0 : String;
  var s1_u#u_sattr1 : String;
  var s1_u#u_sattr2 : String;
  var s1_u#u_sattr3 : String;
  var s1_u#u_sattr4 : String;
  var s1_#tmp25 : int;
  var ITEM_COMMENT_ic_buyer_id_a_then_b : [int][int][int]int;
  var ITEM_COMMENT_ic_i_id_a_then_b : [int][int][int]int;
  var ITEM_COMMENT_ic_id_a_then_b : [int][int][int]int;
  var ITEM_COMMENT_ic_question_a_then_b : [int][int][int]String;
  var ITEM_COMMENT_ic_response_a_then_b : [int][int][int]String;
  var ITEM_COMMENT_ic_u_id_a_then_b : [int][int][int]int;
  var USERACCT_FEEDBACK_uf_rating_a_then_b : [int][int][int][int]int;
  ...
  var ITEM_COMMENT_ic_i_id_b_then_a : [int][int][int]int;
  var ITEM_COMMENT_ic_id_b_then_a : [int][int][int]int;
  var ITEM_COMMENT_ic_question_b_then_a : [int][int][int]String;
  var ITEM_COMMENT_ic_response_b_then_a : [int][int][int]String;
  var ITEM_COMMENT_ic_u_id_b_then_a : [int][int][int]int;
  var USERACCT_FEEDBACK_uf_rating_b_then_a : [int][int][int][int]int;
  ...
  // Slice commutativity verification: hop 10 vs hop 11
  // --- Step 1: Havoc initial state ---
    havoc ITEM_COMMENT_ic_buyer_id;
    havoc ITEM_COMMENT_ic_i_id;
    havoc ITEM_COMMENT_ic_id;
    havoc ITEM_COMMENT_ic_question;
    havoc ITEM_COMMENT_ic_response;
    havoc ITEM_COMMENT_ic_u_id;
  ...
  // --- Step 2: Save initial state ---
    ...
    ITEM_COMMENT_ic_i_id_init := ITEM_COMMENT_ic_i_id;
    ITEM_COMMENT_ic_id_init := ITEM_COMMENT_ic_id;
    ITEM_COMMENT_ic_question_init := ITEM_COMMENT_ic_question;
    ITEM_COMMENT_ic_response_init := ITEM_COMMENT_ic_response;
    ITEM_COMMENT_ic_u_id_init := ITEM_COMMENT_ic_u_id;
    ...
    s0_response_init := s0_response;
    s1_from_id_init := s1_from_id;
    s1_to_id_init := s1_to_id;
    s1_item_id_init := s1_item_id;
    s1_seller_id_init := s1_seller_id;
    s1_rating_init := s1_rating;
  // --- Step 3: Execute special interleavings ---
  // Executing A then B:
    if (s0_active) {
    s0_block14__ab:
      s0_c#ic_buyer_id := ITEM_COMMENT_ic_buyer_id[s0_comment_id][s0_item_id][s0_seller_id];
      s0_c#ic_i_id := ITEM_COMMENT_ic_i_id[s0_comment_id][s0_item_id][s0_seller_id];
      s0_c#ic_id := ITEM_COMMENT_ic_id[s0_comment_id][s0_item_id][s0_seller_id];
      s0_c#ic_question := ITEM_COMMENT_ic_question[s0_comment_id][s0_item_id][s0_seller_id];
      s0_c#ic_u_id := ITEM_COMMENT_ic_u_id[s0_comment_id][s0_item_id][s0_seller_id];
      s0_c#ic_response := s0_response;
      ITEM_COMMENT_ic_buyer_id := ITEM_COMMENT_ic_buyer_id[s0_comment_id := ITEM_COMMENT_ic_buyer_id[s0_comment_id][s0_item_id := ITEM_COMMENT_ic_buyer_id[s0_comment_id][s0_item_id][s0_seller_id := s0_c#ic_buyer_id]]];
      ITEM_COMMENT_ic_i_id := ITEM_COMMENT_ic_i_id[s0_comment_id := ITEM_COMMENT_ic_i_id[s0_comment_id][s0_item_id := ITEM_COMMENT_ic_i_id[s0_comment_id][s0_item_id][s0_seller_id := s0_c#ic_i_id]]];
      ITEM_COMMENT_ic_id := ITEM_COMMENT_ic_id[s0_comment_id := ITEM_COMMENT_ic_id[s0_comment_id][s0_item_id := ITEM_COMMENT_ic_id[s0_comment_id][s0_item_id][s0_seller_id := s0_c#ic_id]]];
      ITEM_COMMENT_ic_question := ITEM_COMMENT_ic_question[s0_comment_id := ITEM_COMMENT_ic_question[s0_comment_id][s0_item_id := ITEM_COMMENT_ic_question[s0_comment_id][s0_item_id][s0_seller_id := s0_c#ic_question]]];
      ITEM_COMMENT_ic_response := ITEM_COMMENT_ic_response[s0_comment_id := ITEM_COMMENT_ic_response[s0_comment_id][s0_item_id := ITEM_COMMENT_ic_response[s0_comment_id][s0_item_id][s0_seller_id := s0_c#ic_response]]];
      ITEM_COMMENT_ic_u_id := ITEM_COMMENT_ic_u_id[s0_comment_id := ITEM_COMMENT_ic_u_id[s0_comment_id][s0_item_id := ITEM_COMMENT_ic_u_id[s0_comment_id][s0_item_id][s0_seller_id := s0_c#ic_u_id]]];
      s0_seller#u_balance := USERACCT_u_balance[s0_seller_id];
      s0_seller#u_comments := USERACCT_u_comments[s0_seller_id];
      s0_seller#u_id := USERACCT_u_id[s0_seller_id];
      s0_seller#u_r_id := USERACCT_u_r_id[s0_seller_id];
      s0_seller#u_rating := USERACCT_u_rating[s0_seller_id];
      s0_seller#u_sattr0 := USERACCT_u_sattr0[s0_seller_id];
      s0_seller#u_sattr1 := USERACCT_u_sattr1[s0_seller_id];
      s0_seller#u_sattr2 := USERACCT_u_sattr2[s0_seller_id];
      s0_seller#u_sattr3 := USERACCT_u_sattr3[s0_seller_id];
      s0_seller#u_sattr4 := USERACCT_u_sattr4[s0_seller_id];
      s0_#tmp23 := s0_seller#u_comments - 1;
      s0_seller#u_comments := s0_#tmp23;
      USERACCT_u_balance := USERACCT_u_balance[s0_seller_id := s0_seller#u_balance];
      USERACCT_u_comments := USERACCT_u_comments[s0_seller_id := s0_seller#u_comments];
      USERACCT_u_id := USERACCT_u_id[s0_seller_id := s0_seller#u_id];
      USERACCT_u_r_id := USERACCT_u_r_id[s0_seller_id := s0_seller#u_r_id];
      USERACCT_u_rating := USERACCT_u_rating[s0_seller_id := s0_seller#u_rating];
      USERACCT_u_sattr0 := USERACCT_u_sattr0[s0_seller_id := s0_seller#u_sattr0];
      USERACCT_u_sattr1 := USERACCT_u_sattr1[s0_seller_id := s0_seller#u_sattr1];
      USERACCT_u_sattr2 := USERACCT_u_sattr2[s0_seller_id := s0_seller#u_sattr2];
      USERACCT_u_sattr3 := USERACCT_u_sattr3[s0_seller_id := s0_seller#u_sattr3];
      USERACCT_u_sattr4 := USERACCT_u_sattr4[s0_seller_id := s0_seller#u_sattr4];
      s0_active := false;
    ...
    if (s1_active) {
    s1_block15__ab:
      USERACCT_FEEDBACK_uf_rating := USERACCT_FEEDBACK_uf_rating[s1_to_id := USERACCT_FEEDBACK_uf_rating[s1_to_id][s1_item_id := USERACCT_FEEDBACK_uf_rating[s1_to_id][s1_item_id][s1_seller_id := USERACCT_FEEDBACK_uf_rating[s1_to_id][s1_item_id][s1_seller_id][s1_from_id := s1_rating]]]];
      s1_u#u_balance := USERACCT_u_balance[s1_to_id];
      s1_u#u_comments := USERACCT_u_comments[s1_to_id];
      s1_u#u_id := USERACCT_u_id[s1_to_id];
      s1_u#u_r_id := USERACCT_u_r_id[s1_to_id];
      s1_u#u_rating := USERACCT_u_rating[s1_to_id];
      s1_u#u_sattr0 := USERACCT_u_sattr0[s1_to_id];
      s1_u#u_sattr1 := USERACCT_u_sattr1[s1_to_id];
      s1_u#u_sattr2 := USERACCT_u_sattr2[s1_to_id];
      s1_u#u_sattr3 := USERACCT_u_sattr3[s1_to_id];
      s1_u#u_sattr4 := USERACCT_u_sattr4[s1_to_id];
      s1_#tmp25 := s1_u#u_rating + s1_rating;
      s1_u#u_rating := s1_#tmp25;
      USERACCT_u_balance := USERACCT_u_balance[s1_to_id := s1_u#u_balance];
      USERACCT_u_comments := USERACCT_u_comments[s1_to_id := s1_u#u_comments];
      USERACCT_u_id := USERACCT_u_id[s1_to_id := s1_u#u_id];
      USERACCT_u_r_id := USERACCT_u_r_id[s1_to_id := s1_u#u_r_id];
      USERACCT_u_rating := USERACCT_u_rating[s1_to_id := s1_u#u_rating];
      USERACCT_u_sattr0 := USERACCT_u_sattr0[s1_to_id := s1_u#u_sattr0];
      USERACCT_u_sattr1 := USERACCT_u_sattr1[s1_to_id := s1_u#u_sattr1];
      USERACCT_u_sattr2 := USERACCT_u_sattr2[s1_to_id := s1_u#u_sattr2];
      USERACCT_u_sattr3 := USERACCT_u_sattr3[s1_to_id := s1_u#u_sattr3];
      USERACCT_u_sattr4 := USERACCT_u_sattr4[s1_to_id := s1_u#u_sattr4];
      s1_active := false;
  ...
  // Snapshotting final state for a_then_b
    ...
    ITEM_COMMENT_ic_i_id_a_then_b := ITEM_COMMENT_ic_i_id;
    ITEM_COMMENT_ic_id_a_then_b := ITEM_COMMENT_ic_id;
    ITEM_COMMENT_ic_question_a_then_b := ITEM_COMMENT_ic_question;
    ITEM_COMMENT_ic_response_a_then_b := ITEM_COMMENT_ic_response;
    ITEM_COMMENT_ic_u_id_a_then_b := ITEM_COMMENT_ic_u_id;
    USERACCT_FEEDBACK_uf_rating_a_then_b := USERACCT_FEEDBACK_uf_rating;
  ...
  // Restoring initial state:
    ...
    ITEM_COMMENT_ic_i_id := ITEM_COMMENT_ic_i_id_init;
    ITEM_COMMENT_ic_id := ITEM_COMMENT_ic_id_init;
    ITEM_COMMENT_ic_question := ITEM_COMMENT_ic_question_init;
    ITEM_COMMENT_ic_response := ITEM_COMMENT_ic_response_init;
    ITEM_COMMENT_ic_u_id := ITEM_COMMENT_ic_u_id_init;
    ...
    s0_response := s0_response_init;
    s1_from_id := s1_from_id_init;
    s1_to_id := s1_to_id_init;
    s1_item_id := s1_item_id_init;
    s1_seller_id := s1_seller_id_init;
    s1_rating := s1_rating_init;
    s0_active := true;
    s1_active := true;
  // Executing B then A:
    if (s1_active) {
  ...
  // Snapshotting final state for b_then_a
    ...
    ITEM_COMMENT_ic_i_id_b_then_a := ITEM_COMMENT_ic_i_id;
    ITEM_COMMENT_ic_id_b_then_a := ITEM_COMMENT_ic_id;
    ITEM_COMMENT_ic_question_b_then_a := ITEM_COMMENT_ic_question;
    ITEM_COMMENT_ic_response_b_then_a := ITEM_COMMENT_ic_response;
    ITEM_COMMENT_ic_u_id_b_then_a := ITEM_COMMENT_ic_u_id;
    USERACCT_FEEDBACK_uf_rating_b_then_a := USERACCT_FEEDBACK_uf_rating;
  ...
  // Verifying A->B === B->A equivalence:
    assert {:msg "(SpecialInterleavingNonEquivalence (node_1 (function_id . 23) (instance . 0) (hop_id . 10)) (node_2 (function_id . 24) (instance . 1) (hop_id . 11)))"} (((((((((((((((((ITEM_COMMENT_ic_buyer_id_a_then_b == ITEM_COMMENT_ic_buyer_id_b_then_a) && (ITEM_COMMENT_ic_i_id_a_then_b == ITEM_COMMENT_ic_i_id_b_then_a)) && (ITEM_COMMENT_ic_id_a_then_b == ITEM_COMMENT_ic_id_b_then_a)) && (ITEM_COMMENT_ic_question_a_then_b == ITEM_COMMENT_ic_question_b_then_a)) && (ITEM_COMMENT_ic_response_a_then_b == ITEM_COMMENT_ic_response_b_then_a)) && (ITEM_COMMENT_ic_u_id_a_then_b == ITEM_COMMENT_ic_u_id_b_then_a)) && (USERACCT_FEEDBACK_uf_rating_a_then_b == USERACCT_FEEDBACK_uf_rating_b_then_a)) && (USERACCT_u_balance_a_then_b == USERACCT_u_balance_b_then_a)) && (USERACCT_u_comments_a_then_b == USERACCT_u_comments_b_then_a)) && (USERACCT_u_id_a_then_b == USERACCT_u_id_b_then_a)) && (USERACCT_u_r_id_a_then_b == USERACCT_u_r_id_b_then_a)) && (USERACCT_u_rating_a_then_b == USERACCT_u_rating_b_then_a)) && (USERACCT_u_sattr0_a_then_b == USERACCT_u_sattr0_b_then_a)) && (USERACCT_u_sattr1_a_then_b == USERACCT_u_sattr1_b_then_a)) && (USERACCT_u_sattr2_a_then_b == USERACCT_u_sattr2_b_then_a)) && (USERACCT_u_sattr3_a_then_b == USERACCT_u_sattr3_b_then_a)) && (USERACCT_u_sattr4_a_then_b == USERACCT_u_sattr4_b_then_a));
}
