...
modifies ITEM_BID_ib_bid, ITEM_BID_ib_buyer_id, ITEM_BID_ib_max_bid, ITEM_MAX_BID_imb_ib_i_id, ITEM_MAX_BID_imb_ib_id, ITEM_MAX_BID_imb_ib_u_id, ITEM_i_c_id, ITEM_i_current_price, ITEM_i_end_date, ITEM_i_id, ITEM_i_initial_price, ITEM_i_name, ITEM_i_num_bids, ITEM_i_num_comments, ITEM_i_start_date, ITEM_i_status, ITEM_i_u_id, REGION_r_name, USERACCT_u_r_id;
{
  ...
  var REGION_r_name_init : [int]String;
  ...
  var s0_#tmp4 : Row (Table (ITEM));
  var s0_item : Row (Table (ITEM));
  var s0_#tmp5 : unit;
  var s0_seller#u_r_id : int;
  var s0_#tmp7 : Row (Table (REGION));
  var s0_region : Row (Table (REGION));
  var s0_#tmp8 : unit;
  ...
  // --- Step 2: Save initial state ---
    ...
    REGION_r_name_init := REGION_r_name;
  ...
  // Executing A then B:
    if (s0_active) {
    s0_block5__ab:
      s0_#tmp4 := construct_Row_ITEM(ITEM_i_id[s0_item_id][s0_seller_id], ITEM_i_u_id[s0_item_id][s0_seller_id], ITEM_i_name[s0_item_id][s0_seller_id], ITEM_i_initial_price[s0_item_id][s0_seller_id], ITEM_i_current_price[s0_item_id][s0_seller_id], ITEM_i_num_bids[s0_item_id][s0_seller_id], ITEM_i_end_date[s0_item_id][s0_seller_id], ITEM_i_start_date[s0_item_id][s0_seller_id], ITEM_i_status[s0_item_id][s0_seller_id], ITEM_i_num_comments[s0_item_id][s0_seller_id], ITEM_i_c_id[s0_item_id][s0_seller_id]);
      s0_item := s0_#tmp4;
      s0_#tmp5 := to_unit(s0_item);
      s0_seller#u_r_id := USERACCT_u_r_id[s0_seller_id];
      s0_#tmp7 := construct_Row_REGION(REGION_r_id[s0_seller#u_r_id], REGION_r_name[s0_seller#u_r_id]);
      s0_region := s0_#tmp7;
      s0_#tmp8 := to_unit(s0_region);
      s0_active := false;
  ...
  // Restoring initial state:
    ...
    REGION_r_name := REGION_r_name_init;
