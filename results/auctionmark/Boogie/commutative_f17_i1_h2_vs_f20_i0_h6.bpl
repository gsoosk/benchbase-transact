...
procedure Check_SliceCommut_Hop2_vs_Hop6()
modifies ITEM_COMMENT_ic_buyer_id, ITEM_COMMENT_ic_question, ITEM_COMMENT_ic_response, ITEM_i_c_id, ITEM_i_current_price, ITEM_i_end_date, ITEM_i_id, ITEM_i_initial_price, ITEM_i_name, ITEM_i_num_bids, ITEM_i_num_comments, ITEM_i_start_date, ITEM_i_status, ITEM_i_u_id, USERACCT_FEEDBACK_uf_rating, USERACCT_u_balance, USERACCT_u_comments, USERACCT_u_r_id, USERACCT_u_rating, USERACCT_u_sattr0, USERACCT_u_sattr1, USERACCT_u_sattr2, USERACCT_u_sattr3, USERACCT_u_sattr4;
{
  ...
  var s1_user_id_init : int;
  var s1_other_user_id_init : int;
  ...
  var s1_#tmp9 : Row (Table (USERACCT));
  var s1_u : Row (Table (USERACCT));
  var s1_#tmp10 : unit;
  var s1_#tmp11 : Row (Table (USERACCT_FEEDBACK));
  var s1_feedback : Row (Table (USERACCT_FEEDBACK));
  var s1_#tmp12 : unit;
  var s1_#tmp13 : Row (Table (ITEM_COMMENT));
  var s1_comment : Row (Table (ITEM_COMMENT));
  var s1_#tmp14 : unit;
  var s1_#tmp15 : Row (Table (ITEM));
  var s1_item : Row (Table (ITEM));
  var s1_#tmp16 : unit;
  ...
  var s1_user_id_a_then_b : int;
  var s1_other_user_id_a_then_b : int;
  var s1_item_id_a_then_b : int;
  ...
  var s1_user_id_b_then_a : int;
  var s1_other_user_id_b_then_a : int;
  var s1_item_id_b_then_a : int;

  // Slice commutativity verification: hop 2 vs hop 6
  ...
  // --- Step 2: Save initial state ---
    ...
    s1_user_id_init := s1_user_id;
    s1_other_user_id_init := s1_other_user_id;
  ...
  // Executing A then B:
    ...
    if (s1_active) {
    s1_block6__ab:
      s1_#tmp9 := construct_Row_USERACCT(USERACCT_u_id[s1_user_id], USERACCT_u_rating[s1_user_id], USERACCT_u_balance[s1_user_id], USERACCT_u_comments[s1_user_id], USERACCT_u_r_id[s1_user_id], USERACCT_u_sattr0[s1_user_id], USERACCT_u_sattr1[s1_user_id], USERACCT_u_sattr2[s1_user_id], USERACCT_u_sattr3[s1_user_id], USERACCT_u_sattr4[s1_user_id]);
      s1_u := s1_#tmp9;
      s1_#tmp10 := to_unit(s1_u);
      s1_#tmp11 := construct_Row_USERACCT_FEEDBACK(USERACCT_FEEDBACK_uf_u_id[s1_user_id][s1_item_id][s1_other_user_id][s1_other_user_id], USERACCT_FEEDBACK_uf_i_id[s1_user_id][s1_item_id][s1_other_user_id][s1_other_user_id], USERACCT_FEEDBACK_uf_i_u_id[s1_user_id][s1_item_id][s1_other_user_id][s1_other_user_id], USERACCT_FEEDBACK_uf_from_id[s1_user_id][s1_item_id][s1_other_user_id][s1_other_user_id], USERACCT_FEEDBACK_uf_rating[s1_user_id][s1_item_id][s1_other_user_id][s1_other_user_id]);
      s1_feedback := s1_#tmp11;
      s1_#tmp12 := to_unit(s1_feedback);
      s1_#tmp13 := construct_Row_ITEM_COMMENT(ITEM_COMMENT_ic_id[s1_comment_id][s1_item_id][s1_user_id], ITEM_COMMENT_ic_i_id[s1_comment_id][s1_item_id][s1_user_id], ITEM_COMMENT_ic_u_id[s1_comment_id][s1_item_id][s1_user_id], ITEM_COMMENT_ic_buyer_id[s1_comment_id][s1_item_id][s1_user_id], ITEM_COMMENT_ic_question[s1_comment_id][s1_item_id][s1_user_id], ITEM_COMMENT_ic_response[s1_comment_id][s1_item_id][s1_user_id]);
      s1_comment := s1_#tmp13;
      s1_#tmp14 := to_unit(s1_comment);
      s1_#tmp15 := construct_Row_ITEM(ITEM_i_id[s1_item_id][s1_user_id], ITEM_i_u_id[s1_item_id][s1_user_id], ITEM_i_name[s1_item_id][s1_user_id], ITEM_i_initial_price[s1_item_id][s1_user_id], ITEM_i_current_price[s1_item_id][s1_user_id], ITEM_i_num_bids[s1_item_id][s1_user_id], ITEM_i_end_date[s1_item_id][s1_user_id], ITEM_i_start_date[s1_item_id][s1_user_id], ITEM_i_status[s1_item_id][s1_user_id], ITEM_i_num_comments[s1_item_id][s1_user_id], ITEM_i_c_id[s1_item_id][s1_user_id]);
      s1_item := s1_#tmp15;
      s1_#tmp16 := to_unit(s1_item);
  ...
  // Snapshotting final state for a_then_b
    ...
    s1_user_id_a_then_b := s1_user_id;
    s1_other_user_id_a_then_b := s1_other_user_id;
    s1_item_id_a_then_b := s1_item_id;
  // Restoring initial state:
    ...
    s1_user_id := s1_user_id_init;
    s1_other_user_id := s1_other_user_id_init;
