...
procedure Check_SliceCommut_Hop11_vs_Hop12()
modifies ITEM_i_c_id, ITEM_i_current_price, ITEM_i_end_date, ITEM_i_initial_price, ITEM_i_name, ITEM_i_num_bids, ITEM_i_num_comments, ITEM_i_start_date, ITEM_i_status, USERACCT_FEEDBACK_uf_rating, USERACCT_u_balance, USERACCT_u_comments, USERACCT_u_id, USERACCT_u_r_id, USERACCT_u_rating, USERACCT_u_sattr0, USERACCT_u_sattr1, USERACCT_u_sattr2, USERACCT_u_sattr3, USERACCT_u_sattr4;
{
  ...
  var s0_from_id_init : int;
  var s0_to_id_init : int;
  var s0_item_id_init : int;
  var s0_seller_id_init : int;
  var s0_rating_init : int;
  ...
  var s0_u#u_balance : real;
  var s0_u#u_comments : int;
  var s0_u#u_id : int;
  var s0_u#u_r_id : int;
  var s0_u#u_rating : int;
  var s0_u#u_sattr0 : String;
  var s0_u#u_sattr1 : String;
  var s0_u#u_sattr2 : String;
  var s0_u#u_sattr3 : String;
  var s0_u#u_sattr4 : String;
  var s0_#tmp25 : int;
  ...
  // Slice commutativity verification: hop 11 vs hop 12
  ...
  // --- Step 2: Save initial state ---
    ...
    s0_from_id_init := s0_from_id;
    s0_to_id_init := s0_to_id;
    s0_item_id_init := s0_item_id;
    s0_seller_id_init := s0_seller_id;
    s0_rating_init := s0_rating;
  ...
  // Executing A then B:
    if (s0_active) {
    s0_block15__ab:
      USERACCT_FEEDBACK_uf_rating := USERACCT_FEEDBACK_uf_rating[s0_to_id := USERACCT_FEEDBACK_uf_rating[s0_to_id][s0_item_id := USERACCT_FEEDBACK_uf_rating[s0_to_id][s0_item_id][s0_seller_id := USERACCT_FEEDBACK_uf_rating[s0_to_id][s0_item_id][s0_seller_id][s0_from_id := s0_rating]]]];
      s0_u#u_balance := USERACCT_u_balance[s0_to_id];
      s0_u#u_comments := USERACCT_u_comments[s0_to_id];
      s0_u#u_id := USERACCT_u_id[s0_to_id];
      s0_u#u_r_id := USERACCT_u_r_id[s0_to_id];
      s0_u#u_rating := USERACCT_u_rating[s0_to_id];
      s0_u#u_sattr0 := USERACCT_u_sattr0[s0_to_id];
      s0_u#u_sattr1 := USERACCT_u_sattr1[s0_to_id];
      s0_u#u_sattr2 := USERACCT_u_sattr2[s0_to_id];
      s0_u#u_sattr3 := USERACCT_u_sattr3[s0_to_id];
      s0_u#u_sattr4 := USERACCT_u_sattr4[s0_to_id];
      s0_#tmp25 := s0_u#u_rating + s0_rating;
      s0_u#u_rating := s0_#tmp25;
      USERACCT_u_balance := USERACCT_u_balance[s0_to_id := s0_u#u_balance];
      USERACCT_u_comments := USERACCT_u_comments[s0_to_id := s0_u#u_comments];
      USERACCT_u_id := USERACCT_u_id[s0_to_id := s0_u#u_id];
      USERACCT_u_r_id := USERACCT_u_r_id[s0_to_id := s0_u#u_r_id];
      USERACCT_u_rating := USERACCT_u_rating[s0_to_id := s0_u#u_rating];
      USERACCT_u_sattr0 := USERACCT_u_sattr0[s0_to_id := s0_u#u_sattr0];
      USERACCT_u_sattr1 := USERACCT_u_sattr1[s0_to_id := s0_u#u_sattr1];
      USERACCT_u_sattr2 := USERACCT_u_sattr2[s0_to_id := s0_u#u_sattr2];
      USERACCT_u_sattr3 := USERACCT_u_sattr3[s0_to_id := s0_u#u_sattr3];
      USERACCT_u_sattr4 := USERACCT_u_sattr4[s0_to_id := s0_u#u_sattr4];
      s0_active := false;
  ...
  // Restoring initial state:
    ...
    s0_from_id := s0_from_id_init;
    s0_to_id := s0_to_id_init;
    s0_item_id := s0_item_id_init;
    s0_seller_id := s0_seller_id_init;
    s0_rating := s0_rating_init;
  ...
  // Verifying A->B === B->A equivalence:
    assert {:msg "(SpecialInterleavingNonEquivalence (node_1 (function_id . 24) (instance . 0) (hop_id . 11)) (node_2 (function_id . 25) (instance . 0) (hop_id . 12)))"} ((((((((((((((((((((ITEM_i_c_id_a_then_b == ITEM_i_c_id_b_then_a) && (ITEM_i_current_price_a_then_b == ITEM_i_current_price_b_then_a)) && (ITEM_i_end_date_a_then_b == ITEM_i_end_date_b_then_a)) && (ITEM_i_initial_price_a_then_b == ITEM_i_initial_price_b_then_a)) && (ITEM_i_name_a_then_b == ITEM_i_name_b_then_a)) && (ITEM_i_num_bids_a_then_b == ITEM_i_num_bids_b_then_a)) && (ITEM_i_num_comments_a_then_b == ITEM_i_num_comments_b_then_a)) && (ITEM_i_start_date_a_then_b == ITEM_i_start_date_b_then_a)) && (ITEM_i_status_a_then_b == ITEM_i_status_b_then_a)) && (USERACCT_FEEDBACK_uf_rating_a_then_b == USERACCT_FEEDBACK_uf_rating_b_then_a)) && (USERACCT_u_balance_a_then_b == USERACCT_u_balance_b_then_a)) && (USERACCT_u_comments_a_then_b == USERACCT_u_comments_b_then_a)) && (USERACCT_u_id_a_then_b == USERACCT_u_id_b_then_a)) && (USERACCT_u_r_id_a_then_b == USERACCT_u_r_id_b_then_a)) && (USERACCT_u_rating_a_then_b == USERACCT_u_rating_b_then_a)) && (USERACCT_u_sattr0_a_then_b == USERACCT_u_sattr0_b_then_a)) && (USERACCT_u_sattr1_a_then_b == USERACCT_u_sattr1_b_then_a)) && (USERACCT_u_sattr2_a_then_b == USERACCT_u_sattr2_b_then_a)) && (USERACCT_u_sattr3_a_then_b == USERACCT_u_sattr3_b_then_a)) && (USERACCT_u_sattr4_a_then_b == USERACCT_u_sattr4_b_then_a));
}
