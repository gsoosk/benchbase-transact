...
modifies ITEM_i_c_id, ITEM_i_current_price, ITEM_i_end_date, ITEM_i_id, ITEM_i_initial_price, ITEM_i_name, ITEM_i_num_bids, ITEM_i_num_comments, ITEM_i_start_date, ITEM_i_status, ITEM_i_u_id, REGION_r_name, USERACCT_u_r_id;
{
  ...
  var s1_#tmp4 : Row (Table (ITEM));
  var s1_item : Row (Table (ITEM));
  var s1_#tmp5 : unit;
  var s1_seller#u_r_id : int;
  var s1_#tmp7 : Row (Table (REGION));
  var s1_region : Row (Table (REGION));
  var s1_#tmp8 : unit;
  ...
  // Executing A then B:
    ...
    if (s1_active) {
    s1_block5__ab:
      s1_#tmp4 := construct_Row_ITEM(ITEM_i_id[s1_item_id][s1_seller_id], ITEM_i_u_id[s1_item_id][s1_seller_id], ITEM_i_name[s1_item_id][s1_seller_id], ITEM_i_initial_price[s1_item_id][s1_seller_id], ITEM_i_current_price[s1_item_id][s1_seller_id], ITEM_i_num_bids[s1_item_id][s1_seller_id], ITEM_i_end_date[s1_item_id][s1_seller_id], ITEM_i_start_date[s1_item_id][s1_seller_id], ITEM_i_status[s1_item_id][s1_seller_id], ITEM_i_num_comments[s1_item_id][s1_seller_id], ITEM_i_c_id[s1_item_id][s1_seller_id]);
      s1_item := s1_#tmp4;
      s1_#tmp5 := to_unit(s1_item);
      s1_seller#u_r_id := USERACCT_u_r_id[s1_seller_id];
      s1_#tmp7 := construct_Row_REGION(REGION_r_id[s1_seller#u_r_id], REGION_r_name[s1_seller#u_r_id]);
      s1_region := s1_#tmp7;
      s1_#tmp8 := to_unit(s1_region);
      s1_active := false;
