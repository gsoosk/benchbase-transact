...
procedure Check_SliceCommut_Hop8_vs_Hop12()
modifies ITEM_BID_ib_bid, ITEM_BID_ib_buyer_id, ITEM_BID_ib_max_bid, ITEM_MAX_BID_imb_ib_i_id, ITEM_MAX_BID_imb_ib_id, ITEM_MAX_BID_imb_ib_u_id, ITEM_i_c_id, ITEM_i_current_price, ITEM_i_end_date, ITEM_i_id, ITEM_i_initial_price, ITEM_i_name, ITEM_i_num_bids, ITEM_i_num_comments, ITEM_i_start_date, ITEM_i_status, ITEM_i_u_id, USERACCT_u_balance, USERACCT_u_comments, USERACCT_u_id, USERACCT_u_r_id, USERACCT_u_rating, USERACCT_u_sattr0, USERACCT_u_sattr1, USERACCT_u_sattr2, USERACCT_u_sattr3, USERACCT_u_sattr4;
{
  ...
  var s0_new_bid_init : real;
  var s0_new_bid_id_init : int;
  ...
  // Slice commutativity verification: hop 8 vs hop 12
  ...
  // --- Step 2: Save initial state ---
    ...
    s0_new_bid_init := s0_new_bid;
    s0_new_bid_id_init := s0_new_bid_id;
  ...
  // Executing A then B:
    ...
    s0_block9__ab:
      s0_item#i_current_price := s0_new_bid;
      goto s0_block10__ab;
    s0_block10__ab:
    ...
    s0_block11__ab:
      ITEM_MAX_BID_imb_ib_id := ITEM_MAX_BID_imb_ib_id[s0_item_id := ITEM_MAX_BID_imb_ib_id[s0_item_id][s0_seller_id := s0_new_bid_id]];
      ITEM_MAX_BID_imb_ib_i_id := ITEM_MAX_BID_imb_ib_i_id[s0_item_id := ITEM_MAX_BID_imb_ib_i_id[s0_item_id][s0_seller_id := s0_item_id]];
      ITEM_MAX_BID_imb_ib_u_id := ITEM_MAX_BID_imb_ib_u_id[s0_item_id := ITEM_MAX_BID_imb_ib_u_id[s0_item_id][s0_seller_id := s0_seller_id]];
      goto s0_block12__ab;
    s0_block12__ab:
      s0_active := false;
  ...
  // Restoring initial state:
    ...
    s0_new_bid := s0_new_bid_init;
    s0_new_bid_id := s0_new_bid_id_init;
