...
procedure Check_SliceCommut_Hop13_vs_Hop14()
modifies ITEM_i_c_id, ITEM_i_current_price, ITEM_i_end_date, ITEM_i_id, ITEM_i_initial_price, ITEM_i_name, ITEM_i_num_bids, ITEM_i_num_comments, ITEM_i_start_date, ITEM_i_status, ITEM_i_u_id, USERACCT_u_balance, USERACCT_u_comments, USERACCT_u_id, USERACCT_u_r_id, USERACCT_u_rating, USERACCT_u_sattr0, USERACCT_u_sattr1, USERACCT_u_sattr2, USERACCT_u_sattr3, USERACCT_u_sattr4;
{
  ...
  var s0_buy_now_price_init : real;
  ...
  var s0_buyer_id_a_then_b : int;
  var s0_buy_now_price_a_then_b : real;
  ...
  var s0_buyer_id_b_then_a : int;
  var s0_buy_now_price_b_then_a : real;

  // Slice commutativity verification: hop 13 vs hop 14
  ...
  // --- Step 2: Save initial state ---
    ...
    s0_buy_now_price_init := s0_buy_now_price;
  ...
  // Executing A then B:
    ...
    s0_block17__ab:
      ...
      s0_#tmp30 := s0_seller#u_balance + s0_buy_now_price;
      s0_seller#u_balance := s0_#tmp30;
  ...
  // Snapshotting final state for a_then_b
    ...
    s0_buyer_id_a_then_b := s0_buyer_id;
    s0_buy_now_price_a_then_b := s0_buy_now_price;
  // Restoring initial state:
    ...
    s0_buy_now_price := s0_buy_now_price_init;
