...
modifies ITEM_BID_ib_bid, ITEM_BID_ib_buyer_id, ITEM_BID_ib_max_bid, ITEM_COMMENT_ic_buyer_id, ITEM_COMMENT_ic_question, ITEM_COMMENT_ic_response, ITEM_MAX_BID_imb_ib_i_id, ITEM_MAX_BID_imb_ib_id, ITEM_MAX_BID_imb_ib_u_id, ITEM_i_c_id, ITEM_i_current_price, ITEM_i_end_date, ITEM_i_id, ITEM_i_initial_price, ITEM_i_name, ITEM_i_num_bids, ITEM_i_num_comments, ITEM_i_start_date, ITEM_i_status, ITEM_i_u_id, USERACCT_FEEDBACK_uf_rating, USERACCT_u_balance, USERACCT_u_comments, USERACCT_u_r_id, USERACCT_u_rating, USERACCT_u_sattr0, USERACCT_u_sattr1, USERACCT_u_sattr2, USERACCT_u_sattr3, USERACCT_u_sattr4;
{
  var s0_user_id : int;
  var s0_other_user_id : int;
  var s0_item_id : int;
  var s0_comment_id : int;
  var s1_item_id : int;
  var s1_seller_id : int;
  var s1_buyer_id : int;
  var s1_new_bid : real;
  var s1_new_bid_id : int;
  var s0_active : bool;
  var s1_active : bool;
  var ITEM_BID_ib_bid_init : [int][int][int]real;
  var ITEM_BID_ib_buyer_id_init : [int][int][int]int;
  var ITEM_BID_ib_max_bid_init : [int][int][int]real;
  ...
  var ITEM_MAX_BID_imb_ib_i_id_init : [int][int]int;
  var ITEM_MAX_BID_imb_ib_id_init : [int][int]int;
  var ITEM_MAX_BID_imb_ib_u_id_init : [int][int]int;
  ...
  var USERACCT_FEEDBACK_uf_rating_init : [int][int][int][int]int;
  ...
  var s0_user_id_init : int;
  var s0_other_user_id_init : int;
  var s0_item_id_init : int;
  var s0_comment_id_init : int;
  var s1_item_id_init : int;
  var s1_seller_id_init : int;
  var s1_buyer_id_init : int;
  var s1_new_bid_init : real;
  var s1_new_bid_id_init : int;
  var s0_#tmp9 : Row (Table (USERACCT));
  var s0_u : Row (Table (USERACCT));
  var s0_#tmp10 : unit;
  var s0_#tmp11 : Row (Table (USERACCT_FEEDBACK));
  var s0_feedback : Row (Table (USERACCT_FEEDBACK));
  var s0_#tmp12 : unit;
  var s0_#tmp13 : Row (Table (ITEM_COMMENT));
  var s0_comment : Row (Table (ITEM_COMMENT));
  var s0_#tmp14 : unit;
  var s0_#tmp15 : Row (Table (ITEM));
  var s0_item : Row (Table (ITEM));
  var s0_#tmp16 : unit;
  ...
  var s1_cur_price : real;
  var s1_#tmp22 : int;
  var s1_#tmp23 : bool;
  var s1_#tmp24 : bool;
  var ITEM_BID_ib_bid_a_then_b : [int][int][int]real;
  var ITEM_BID_ib_buyer_id_a_then_b : [int][int][int]int;
  var ITEM_BID_ib_max_bid_a_then_b : [int][int][int]real;
  var ITEM_MAX_BID_imb_ib_i_id_a_then_b : [int][int]int;
  var ITEM_MAX_BID_imb_ib_id_a_then_b : [int][int]int;
  var ITEM_MAX_BID_imb_ib_u_id_a_then_b : [int][int]int;
  ...
  var s0_user_id_a_then_b : int;
  var s0_other_user_id_a_then_b : int;
  var s0_item_id_a_then_b : int;
  var ITEM_BID_ib_bid_b_then_a : [int][int][int]real;
  var ITEM_BID_ib_buyer_id_b_then_a : [int][int][int]int;
  var ITEM_BID_ib_max_bid_b_then_a : [int][int][int]real;
  var ITEM_MAX_BID_imb_ib_i_id_b_then_a : [int][int]int;
  var ITEM_MAX_BID_imb_ib_id_b_then_a : [int][int]int;
  var ITEM_MAX_BID_imb_ib_u_id_b_then_a : [int][int]int;
  ...
  var s0_user_id_b_then_a : int;
  var s0_other_user_id_b_then_a : int;
  var s0_item_id_b_then_a : int;

  // Slice commutativity verification: hop 6 vs hop 8
  // --- Step 1: Havoc initial state ---
    havoc ITEM_BID_ib_bid;
    havoc ITEM_BID_ib_buyer_id;
    havoc ITEM_BID_ib_max_bid;
    havoc ITEM_COMMENT_ic_buyer_id;
    havoc ITEM_COMMENT_ic_question;
    havoc ITEM_COMMENT_ic_response;
    havoc ITEM_MAX_BID_imb_ib_i_id;
    havoc ITEM_MAX_BID_imb_ib_id;
    havoc ITEM_MAX_BID_imb_ib_u_id;
    havoc ITEM_i_c_id;
    ...
    havoc ITEM_i_status;
    havoc ITEM_i_u_id;
    havoc USERACCT_FEEDBACK_uf_rating;
  ...
  // --- Step 2: Save initial state ---
    ITEM_BID_ib_bid_init := ITEM_BID_ib_bid;
    ITEM_BID_ib_buyer_id_init := ITEM_BID_ib_buyer_id;
    ITEM_BID_ib_max_bid_init := ITEM_BID_ib_max_bid;
    ...
    ITEM_MAX_BID_imb_ib_i_id_init := ITEM_MAX_BID_imb_ib_i_id;
    ITEM_MAX_BID_imb_ib_id_init := ITEM_MAX_BID_imb_ib_id;
    ITEM_MAX_BID_imb_ib_u_id_init := ITEM_MAX_BID_imb_ib_u_id;
    ...
    USERACCT_FEEDBACK_uf_rating_init := USERACCT_FEEDBACK_uf_rating;
    ...
    s0_user_id_init := s0_user_id;
    s0_other_user_id_init := s0_other_user_id;
    s0_item_id_init := s0_item_id;
    s0_comment_id_init := s0_comment_id;
    s1_item_id_init := s1_item_id;
    s1_seller_id_init := s1_seller_id;
    s1_buyer_id_init := s1_buyer_id;
    s1_new_bid_init := s1_new_bid;
    s1_new_bid_id_init := s1_new_bid_id;
  // --- Step 3: Execute special interleavings ---
  // Executing A then B:
    if (s0_active) {
    s0_block6__ab:
      s0_#tmp9 := construct_Row_USERACCT(USERACCT_u_id[s0_user_id], USERACCT_u_rating[s0_user_id], USERACCT_u_balance[s0_user_id], USERACCT_u_comments[s0_user_id], USERACCT_u_r_id[s0_user_id], USERACCT_u_sattr0[s0_user_id], USERACCT_u_sattr1[s0_user_id], USERACCT_u_sattr2[s0_user_id], USERACCT_u_sattr3[s0_user_id], USERACCT_u_sattr4[s0_user_id]);
      s0_u := s0_#tmp9;
      s0_#tmp10 := to_unit(s0_u);
      s0_#tmp11 := construct_Row_USERACCT_FEEDBACK(USERACCT_FEEDBACK_uf_u_id[s0_user_id][s0_item_id][s0_other_user_id][s0_other_user_id], USERACCT_FEEDBACK_uf_i_id[s0_user_id][s0_item_id][s0_other_user_id][s0_other_user_id], USERACCT_FEEDBACK_uf_i_u_id[s0_user_id][s0_item_id][s0_other_user_id][s0_other_user_id], USERACCT_FEEDBACK_uf_from_id[s0_user_id][s0_item_id][s0_other_user_id][s0_other_user_id], USERACCT_FEEDBACK_uf_rating[s0_user_id][s0_item_id][s0_other_user_id][s0_other_user_id]);
      s0_feedback := s0_#tmp11;
      s0_#tmp12 := to_unit(s0_feedback);
      s0_#tmp13 := construct_Row_ITEM_COMMENT(ITEM_COMMENT_ic_id[s0_comment_id][s0_item_id][s0_user_id], ITEM_COMMENT_ic_i_id[s0_comment_id][s0_item_id][s0_user_id], ITEM_COMMENT_ic_u_id[s0_comment_id][s0_item_id][s0_user_id], ITEM_COMMENT_ic_buyer_id[s0_comment_id][s0_item_id][s0_user_id], ITEM_COMMENT_ic_question[s0_comment_id][s0_item_id][s0_user_id], ITEM_COMMENT_ic_response[s0_comment_id][s0_item_id][s0_user_id]);
      s0_comment := s0_#tmp13;
      s0_#tmp14 := to_unit(s0_comment);
      s0_#tmp15 := construct_Row_ITEM(ITEM_i_id[s0_item_id][s0_user_id], ITEM_i_u_id[s0_item_id][s0_user_id], ITEM_i_name[s0_item_id][s0_user_id], ITEM_i_initial_price[s0_item_id][s0_user_id], ITEM_i_current_price[s0_item_id][s0_user_id], ITEM_i_num_bids[s0_item_id][s0_user_id], ITEM_i_end_date[s0_item_id][s0_user_id], ITEM_i_start_date[s0_item_id][s0_user_id], ITEM_i_status[s0_item_id][s0_user_id], ITEM_i_num_comments[s0_item_id][s0_user_id], ITEM_i_c_id[s0_item_id][s0_user_id]);
      s0_item := s0_#tmp15;
      s0_#tmp16 := to_unit(s0_item);
    ...
    s1_block8__ab:
      ...
      s1_cur_price := s1_item#i_current_price;
      s1_#tmp22 := s1_item#i_num_bids + 1;
      s1_item#i_num_bids := s1_#tmp22;
      s1_#tmp23 := s1_new_bid > s1_cur_price;
      if (s1_#tmp23) {
      goto s1_block9__ab;
    } else {
      goto s1_block10__ab;
    ...
    s1_block9__ab:
      s1_item#i_current_price := s1_new_bid;
      goto s1_block10__ab;
    s1_block10__ab:
      ...
      ITEM_BID_ib_buyer_id := ITEM_BID_ib_buyer_id[s1_new_bid_id := ITEM_BID_ib_buyer_id[s1_new_bid_id][s1_item_id := ITEM_BID_ib_buyer_id[s1_new_bid_id][s1_item_id][s1_seller_id := s1_buyer_id]]];
      ITEM_BID_ib_bid := ITEM_BID_ib_bid[s1_new_bid_id := ITEM_BID_ib_bid[s1_new_bid_id][s1_item_id := ITEM_BID_ib_bid[s1_new_bid_id][s1_item_id][s1_seller_id := s1_new_bid]]];
      ITEM_BID_ib_max_bid := ITEM_BID_ib_max_bid[s1_new_bid_id := ITEM_BID_ib_max_bid[s1_new_bid_id][s1_item_id := ITEM_BID_ib_max_bid[s1_new_bid_id][s1_item_id][s1_seller_id := s1_new_bid]]];
      s1_#tmp24 := s1_new_bid > s1_cur_price;
      if (s1_#tmp24) {
      goto s1_block11__ab;
    } else {
      goto s1_block12__ab;
    ...
    s1_block11__ab:
      ITEM_MAX_BID_imb_ib_id := ITEM_MAX_BID_imb_ib_id[s1_item_id := ITEM_MAX_BID_imb_ib_id[s1_item_id][s1_seller_id := s1_new_bid_id]];
      ITEM_MAX_BID_imb_ib_i_id := ITEM_MAX_BID_imb_ib_i_id[s1_item_id := ITEM_MAX_BID_imb_ib_i_id[s1_item_id][s1_seller_id := s1_item_id]];
      ITEM_MAX_BID_imb_ib_u_id := ITEM_MAX_BID_imb_ib_u_id[s1_item_id := ITEM_MAX_BID_imb_ib_u_id[s1_item_id][s1_seller_id := s1_seller_id]];
      goto s1_block12__ab;
    s1_block12__ab:
      s1_active := false;
  ...
  // Snapshotting final state for a_then_b
    ITEM_BID_ib_bid_a_then_b := ITEM_BID_ib_bid;
    ITEM_BID_ib_buyer_id_a_then_b := ITEM_BID_ib_buyer_id;
    ITEM_BID_ib_max_bid_a_then_b := ITEM_BID_ib_max_bid;
    ITEM_MAX_BID_imb_ib_i_id_a_then_b := ITEM_MAX_BID_imb_ib_i_id;
    ITEM_MAX_BID_imb_ib_id_a_then_b := ITEM_MAX_BID_imb_ib_id;
    ITEM_MAX_BID_imb_ib_u_id_a_then_b := ITEM_MAX_BID_imb_ib_u_id;
    ...
    s0_user_id_a_then_b := s0_user_id;
    s0_other_user_id_a_then_b := s0_other_user_id;
    s0_item_id_a_then_b := s0_item_id;
  // Restoring initial state:
    ITEM_BID_ib_bid := ITEM_BID_ib_bid_init;
    ITEM_BID_ib_buyer_id := ITEM_BID_ib_buyer_id_init;
    ITEM_BID_ib_max_bid := ITEM_BID_ib_max_bid_init;
    ...
    ITEM_MAX_BID_imb_ib_i_id := ITEM_MAX_BID_imb_ib_i_id_init;
    ITEM_MAX_BID_imb_ib_id := ITEM_MAX_BID_imb_ib_id_init;
    ITEM_MAX_BID_imb_ib_u_id := ITEM_MAX_BID_imb_ib_u_id_init;
    ...
    USERACCT_FEEDBACK_uf_rating := USERACCT_FEEDBACK_uf_rating_init;
    ...
    s0_user_id := s0_user_id_init;
    s0_other_user_id := s0_other_user_id_init;
    s0_item_id := s0_item_id_init;
    s0_comment_id := s0_comment_id_init;
    s1_item_id := s1_item_id_init;
    s1_seller_id := s1_seller_id_init;
    s1_buyer_id := s1_buyer_id_init;
    s1_new_bid := s1_new_bid_init;
    s1_new_bid_id := s1_new_bid_id_init;
    s0_active := true;
    s1_active := true;
  // Executing B then A:
    if (s1_active) {
  ...
  // Snapshotting final state for b_then_a
    ITEM_BID_ib_bid_b_then_a := ITEM_BID_ib_bid;
    ITEM_BID_ib_buyer_id_b_then_a := ITEM_BID_ib_buyer_id;
    ITEM_BID_ib_max_bid_b_then_a := ITEM_BID_ib_max_bid;
    ITEM_MAX_BID_imb_ib_i_id_b_then_a := ITEM_MAX_BID_imb_ib_i_id;
    ITEM_MAX_BID_imb_ib_id_b_then_a := ITEM_MAX_BID_imb_ib_id;
    ITEM_MAX_BID_imb_ib_u_id_b_then_a := ITEM_MAX_BID_imb_ib_u_id;
    ...
    s0_user_id_b_then_a := s0_user_id;
    s0_other_user_id_b_then_a := s0_other_user_id;
    s0_item_id_b_then_a := s0_item_id;
  // --- Step 4: Verify A→B ≡ B→A (Special interleavings equivalence) ---
  // Verifying A->B === B->A equivalence:
    assert {:msg "(SpecialInterleavingNonEquivalence (node_1 (function_id . 20) (instance . 1) (hop_id . 6)) (node_2 (function_id . 21) (instance . 1) (hop_id . 8)))"} ((((((((((((((((((((ITEM_BID_ib_bid_a_then_b == ITEM_BID_ib_bid_b_then_a) && (ITEM_BID_ib_buyer_id_a_then_b == ITEM_BID_ib_buyer_id_b_then_a)) && (ITEM_BID_ib_max_bid_a_then_b == ITEM_BID_ib_max_bid_b_then_a)) && (ITEM_MAX_BID_imb_ib_i_id_a_then_b == ITEM_MAX_BID_imb_ib_i_id_b_then_a)) && (ITEM_MAX_BID_imb_ib_id_a_then_b == ITEM_MAX_BID_imb_ib_id_b_then_a)) && (ITEM_MAX_BID_imb_ib_u_id_a_then_b == ITEM_MAX_BID_imb_ib_u_id_b_then_a)) && (ITEM_i_c_id_a_then_b == ITEM_i_c_id_b_then_a)) && (ITEM_i_current_price_a_then_b == ITEM_i_current_price_b_then_a)) && (ITEM_i_end_date_a_then_b == ITEM_i_end_date_b_then_a)) && (ITEM_i_id_a_then_b == ITEM_i_id_b_then_a)) && (ITEM_i_initial_price_a_then_b == ITEM_i_initial_price_b_then_a)) && (ITEM_i_name_a_then_b == ITEM_i_name_b_then_a)) && (ITEM_i_num_bids_a_then_b == ITEM_i_num_bids_b_then_a)) && (ITEM_i_num_comments_a_then_b == ITEM_i_num_comments_b_then_a)) && (ITEM_i_start_date_a_then_b == ITEM_i_start_date_b_then_a)) && (ITEM_i_status_a_then_b == ITEM_i_status_b_then_a)) && (ITEM_i_u_id_a_then_b == ITEM_i_u_id_b_then_a)) && (s0_user_id_a_then_b == s0_user_id_b_then_a)) && (s0_other_user_id_a_then_b == s0_other_user_id_b_then_a)) && (s0_item_id_a_then_b == s0_item_id_b_then_a));
}
