...
modifies ITEM_COMMENT_ic_buyer_id, ITEM_COMMENT_ic_i_id, ITEM_COMMENT_ic_id, ITEM_COMMENT_ic_question, ITEM_COMMENT_ic_response, ITEM_COMMENT_ic_u_id, ITEM_i_c_id, ITEM_i_current_price, ITEM_i_end_date, ITEM_i_initial_price, ITEM_i_name, ITEM_i_num_bids, ITEM_i_num_comments, ITEM_i_start_date, ITEM_i_status, USERACCT_u_balance, USERACCT_u_comments, USERACCT_u_id, USERACCT_u_r_id, USERACCT_u_rating, USERACCT_u_sattr0, USERACCT_u_sattr1, USERACCT_u_sattr2, USERACCT_u_sattr3, USERACCT_u_sattr4;
{
  ...
  var s1_name : String;
  var s1_initial_price : real;
  var s1_end_date : int;
  var s1_start_date : int;
  var s1_c_id : int;
  var s0_active : bool;
  var s1_active : bool;
  ...
  var s1_initial_price_init : real;
  var s1_end_date_init : int;
  var s1_start_date_init : int;
  ...
  // Slice commutativity verification: hop 10 vs hop 12
  ...
  // --- Step 2: Save initial state ---
    ...
    s1_initial_price_init := s1_initial_price;
    s1_end_date_init := s1_end_date;
    s1_start_date_init := s1_start_date;
  ...
  // Executing A then B:
    ...
    if (s1_active) {
    s1_block16__ab:
      ITEM_i_name := ITEM_i_name[s1_item_id := ITEM_i_name[s1_item_id][s1_seller_id := s1_name]];
      ITEM_i_initial_price := ITEM_i_initial_price[s1_item_id := ITEM_i_initial_price[s1_item_id][s1_seller_id := s1_initial_price]];
      ITEM_i_current_price := ITEM_i_current_price[s1_item_id := ITEM_i_current_price[s1_item_id][s1_seller_id := s1_initial_price]];
      ITEM_i_num_bids := ITEM_i_num_bids[s1_item_id := ITEM_i_num_bids[s1_item_id][s1_seller_id := 0]];
      ITEM_i_end_date := ITEM_i_end_date[s1_item_id := ITEM_i_end_date[s1_item_id][s1_seller_id := s1_end_date]];
      ITEM_i_start_date := ITEM_i_start_date[s1_item_id := ITEM_i_start_date[s1_item_id][s1_seller_id := s1_start_date]];
      ITEM_i_status := ITEM_i_status[s1_item_id := ITEM_i_status[s1_item_id][s1_seller_id := ITEM_STATUS_OPEN]];
      ITEM_i_num_comments := ITEM_i_num_comments[s1_item_id := ITEM_i_num_comments[s1_item_id][s1_seller_id := 0]];
      ITEM_i_c_id := ITEM_i_c_id[s1_item_id := ITEM_i_c_id[s1_item_id][s1_seller_id := s1_c_id]];
      ...
      s1_#tmp27 := s1_seller#u_balance - s1_initial_price;
      s1_seller#u_balance := s1_#tmp27;
  ...
  // Restoring initial state:
    ...
    s1_initial_price := s1_initial_price_init;
    s1_end_date := s1_end_date_init;
    s1_start_date := s1_start_date_init;
