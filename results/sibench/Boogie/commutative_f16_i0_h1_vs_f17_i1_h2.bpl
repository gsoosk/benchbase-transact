...
modifies SITable_id, SITable_value;
{
  ...
  // Verifying A->B === B->A equivalence:
    assert {:msg "(SpecialInterleavingNonEquivalence (node_1 (function_id . 16) (instance . 0) (hop_id . 1)) (node_2 (function_id . 17) (instance . 1) (hop_id . 2)))"} ((SITable_id_a_then_b == SITable_id_b_then_a) && (SITable_value_a_then_b == SITable_value_b_then_a));
}
