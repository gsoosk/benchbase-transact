...
modifies locktable_empid, locktable_salary;
{
  ...
  // Verifying A->B === B->A equivalence:
    assert {:msg "(SpecialInterleavingNonEquivalence (node_1 (function_id . 18) (instance . 1) (hop_id . 201)) (node_2 (function_id . 19) (instance . 1) (hop_id . 204)))"} ((((locktable_empid_a_then_b == locktable_empid_b_then_a) && (locktable_salary_a_then_b == locktable_salary_b_then_a)) && (s0_key2_a_then_b == s0_key2_b_then_a)) && (s0_newSalary_a_then_b == s0_newSalary_b_then_a));
}
