...
modifies iotable_data1, iotable_data2, iotable_empid;
{
  ...
  // Slice commutativity verification: hop 205 vs hop 206
  ...
  // Verifying A->B === B->A equivalence:
    assert {:msg "(SpecialInterleavingNonEquivalence (node_1 (function_id . 20) (instance . 0) (hop_id . 205)) (node_2 (function_id . 20) (instance . 1) (hop_id . 206)))"} ((((((iotable_data1_a_then_b == iotable_data1_b_then_a) && (iotable_data2_a_then_b == iotable_data2_b_then_a)) && (iotable_empid_a_then_b == iotable_empid_b_then_a)) && (s0_leftKey_a_then_b == s0_leftKey_b_then_a)) && (s0_newData1_a_then_b == s0_newData1_b_then_a)) && (s0_newData2_a_then_b == s0_newData2_b_then_a));
}
