...
modifies locktable_empid, locktable_salary;
{
  ...
  // Verifying A->B === B->A equivalence:
    assert {:msg "(SpecialInterleavingNonEquivalence (node_1 (function_id . 18) (instance . 0) (hop_id . 202)) (node_2 (function_id . 19) (instance . 0) (hop_id . 203)))"} ((((locktable_empid_a_then_b == locktable_empid_b_then_a) && (locktable_salary_a_then_b == locktable_salary_b_then_a)) && (s1_leftKey_a_then_b == s1_leftKey_b_then_a)) && (s1_newSalary_a_then_b == s1_newSalary_b_then_a));
}
