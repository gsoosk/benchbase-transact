...
procedure Check_SliceCommut_Hop202_vs_Hop202()
modifies locktable_empid, locktable_salary;
{
  ...
  // Slice commutativity verification: hop 202 vs hop 202
  ...
  // Verifying A->B === B->A equivalence:
    assert {:msg "(SpecialInterleavingNonEquivalence (node_1 (function_id . 18) (instance . 0) (hop_id . 202)) (node_2 (function_id . 18) (instance . 1) (hop_id . 202)))"} ((locktable_empid_a_then_b == locktable_empid_b_then_a) && (locktable_salary_a_then_b == locktable_salary_b_then_a));
}
