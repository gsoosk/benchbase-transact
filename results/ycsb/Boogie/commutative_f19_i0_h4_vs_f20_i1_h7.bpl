...
modifies UserTable_field1, UserTable_field10, UserTable_field2, UserTable_field3, UserTable_field4, UserTable_field5, UserTable_field6, UserTable_field7, UserTable_field8, UserTable_field9, UserTable_ycsb_key;
{
  ...
  var s1_#tmp32 : int;
  var s1_#tmp33 : Row (Table (UserTable));
  ...
  // Executing A then B:
    ...
    if (s1_active) {
    s1_block7__ab:
      s1_#tmp32 := s1_startKey + 2;
      s1_#tmp33 := construct_Row_UserTable(UserTable_ycsb_key[s1_#tmp32], UserTable_field1[s1_#tmp32], UserTable_field2[s1_#tmp32], UserTable_field3[s1_#tmp32], UserTable_field4[s1_#tmp32], UserTable_field5[s1_#tmp32], UserTable_field6[s1_#tmp32], UserTable_field7[s1_#tmp32], UserTable_field8[s1_#tmp32], UserTable_field9[s1_#tmp32], UserTable_field10[s1_#tmp32]);
      s1_r := s1_#tmp33;
      s1_#tmp45 := to_unit(s1_r);
