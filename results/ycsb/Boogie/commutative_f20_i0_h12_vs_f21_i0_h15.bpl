...
modifies UserTable_field1, UserTable_field10, UserTable_field2, UserTable_field3, UserTable_field4, UserTable_field5, UserTable_field6, UserTable_field7, UserTable_field8, UserTable_field9, UserTable_ycsb_key;
{
  ...
  var s0_#tmp102 : int;
  var s0_#tmp103 : Row (Table (UserTable));
  ...
  // Executing A then B:
    if (s0_active) {
    s0_block12__ab:
      s0_#tmp102 := s0_startKey + 7;
      s0_#tmp103 := construct_Row_UserTable(UserTable_ycsb_key[s0_#tmp102], UserTable_field1[s0_#tmp102], UserTable_field2[s0_#tmp102], UserTable_field3[s0_#tmp102], UserTable_field4[s0_#tmp102], UserTable_field5[s0_#tmp102], UserTable_field6[s0_#tmp102], UserTable_field7[s0_#tmp102], UserTable_field8[s0_#tmp102], UserTable_field9[s0_#tmp102], UserTable_field10[s0_#tmp102]);
      s0_r := s0_#tmp103;
      s0_#tmp115 := to_unit(s0_r);
  ...
  // Snapshotting final state for a_then_b
    ...
    s0_startKey_a_then_b := s0_startKey;
  ...
  // Snapshotting final state for b_then_a
    ...
    s0_startKey_b_then_a := s0_startKey;
  // --- Step 4: Verify A→B ≡ B→A (Special interleavings equivalence) ---
  // Verifying A->B === B->A equivalence:
    assert {:msg "(SpecialInterleavingNonEquivalence (node_1 (function_id . 20) (instance . 0) (hop_id . 12)) (node_2 (function_id . 21) (instance . 0) (hop_id . 15)))"} ((((((((((((UserTable_field1_a_then_b == UserTable_field1_b_then_a) && (UserTable_field10_a_then_b == UserTable_field10_b_then_a)) && (UserTable_field2_a_then_b == UserTable_field2_b_then_a)) && (UserTable_field3_a_then_b == UserTable_field3_b_then_a)) && (UserTable_field4_a_then_b == UserTable_field4_b_then_a)) && (UserTable_field5_a_then_b == UserTable_field5_b_then_a)) && (UserTable_field6_a_then_b == UserTable_field6_b_then_a)) && (UserTable_field7_a_then_b == UserTable_field7_b_then_a)) && (UserTable_field8_a_then_b == UserTable_field8_b_then_a)) && (UserTable_field9_a_then_b == UserTable_field9_b_then_a)) && (UserTable_ycsb_key_a_then_b == UserTable_ycsb_key_b_then_a)) && (s0_startKey_a_then_b == s0_startKey_b_then_a));
}
