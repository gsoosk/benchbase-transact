...
modifies UserTable_field1, UserTable_field10, UserTable_field2, UserTable_field3, UserTable_field4, UserTable_field5, UserTable_field6, UserTable_field7, UserTable_field8, UserTable_field9;
{
  var s0_keyname : int;
  var s1_keyname : int;
  var s1_f1 : String;
  ...
  var s0_#tmp0 : Row (Table (UserTable));
  var s0_r : Row (Table (UserTable));
  var s0_#tmp1 : unit;
  ...
  // Executing A then B:
    if (s0_active) {
    s0_block1__ab:
      s0_#tmp0 := construct_Row_UserTable(UserTable_ycsb_key[s0_keyname], UserTable_field1[s0_keyname], UserTable_field2[s0_keyname], UserTable_field3[s0_keyname], UserTable_field4[s0_keyname], UserTable_field5[s0_keyname], UserTable_field6[s0_keyname], UserTable_field7[s0_keyname], UserTable_field8[s0_keyname], UserTable_field9[s0_keyname], UserTable_field10[s0_keyname]);
      s0_r := s0_#tmp0;
      s0_#tmp1 := to_unit(s0_r);
      s0_active := false;
    ...
    if (s1_active) {
    s1_block3__ab:
      UserTable_field1 := UserTable_field1[s1_keyname := s1_f1];
      UserTable_field2 := UserTable_field2[s1_keyname := s1_f2];
      UserTable_field3 := UserTable_field3[s1_keyname := s1_f3];
      UserTable_field4 := UserTable_field4[s1_keyname := s1_f4];
      UserTable_field5 := UserTable_field5[s1_keyname := s1_f5];
      UserTable_field6 := UserTable_field6[s1_keyname := s1_f6];
      UserTable_field7 := UserTable_field7[s1_keyname := s1_f7];
      UserTable_field8 := UserTable_field8[s1_keyname := s1_f8];
      UserTable_field9 := UserTable_field9[s1_keyname := s1_f9];
      UserTable_field10 := UserTable_field10[s1_keyname := s1_f10];
      s1_active := false;
  ...
  // Verifying A->B === B->A equivalence:
    assert {:msg "(SpecialInterleavingNonEquivalence (node_1 (function_id . 16) (instance . 0) (hop_id . 1)) (node_2 (function_id . 18) (instance . 0) (hop_id . 3)))"} ((((((((((UserTable_field1_a_then_b == UserTable_field1_b_then_a) && (UserTable_field10_a_then_b == UserTable_field10_b_then_a)) && (UserTable_field2_a_then_b == UserTable_field2_b_then_a)) && (UserTable_field3_a_then_b == UserTable_field3_b_then_a)) && (UserTable_field4_a_then_b == UserTable_field4_b_then_a)) && (UserTable_field5_a_then_b == UserTable_field5_b_then_a)) && (UserTable_field6_a_then_b == UserTable_field6_b_then_a)) && (UserTable_field7_a_then_b == UserTable_field7_b_then_a)) && (UserTable_field8_a_then_b == UserTable_field8_b_then_a)) && (UserTable_field9_a_then_b == UserTable_field9_b_then_a));
}
