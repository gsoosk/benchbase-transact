...
modifies UserTable_field1, UserTable_field10, UserTable_field2, UserTable_field3, UserTable_field4, UserTable_field5, UserTable_field6, UserTable_field7, UserTable_field8, UserTable_field9, UserTable_ycsb_key;
{
  ...
  var s0_#tmp46 : int;
  var s0_#tmp47 : Row (Table (UserTable));
  ...
  // Executing A then B:
    if (s0_active) {
    s0_block8__ab:
      s0_#tmp46 := s0_startKey + 3;
      s0_#tmp47 := construct_Row_UserTable(UserTable_ycsb_key[s0_#tmp46], UserTable_field1[s0_#tmp46], UserTable_field2[s0_#tmp46], UserTable_field3[s0_#tmp46], UserTable_field4[s0_#tmp46], UserTable_field5[s0_#tmp46], UserTable_field6[s0_#tmp46], UserTable_field7[s0_#tmp46], UserTable_field8[s0_#tmp46], UserTable_field9[s0_#tmp46], UserTable_field10[s0_#tmp46]);
      s0_r := s0_#tmp47;
      s0_#tmp59 := to_unit(s0_r);
