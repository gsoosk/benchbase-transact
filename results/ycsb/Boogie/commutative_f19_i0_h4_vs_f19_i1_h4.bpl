...
modifies UserTable_field1, UserTable_field10, UserTable_field2, UserTable_field3, UserTable_field4, UserTable_field5, UserTable_field6, UserTable_field7, UserTable_field8, UserTable_field9, UserTable_ycsb_key;
{
  ...
  // Executing A then B:
    ...
    s1_block4__ab:
      ...
      s1_r#field10 := UserTable_field10[s1_keyname];
      s1_r#field2 := UserTable_field2[s1_keyname];
      s1_r#field3 := UserTable_field3[s1_keyname];
      s1_r#field4 := UserTable_field4[s1_keyname];
      s1_r#field5 := UserTable_field5[s1_keyname];
      s1_r#field6 := UserTable_field6[s1_keyname];
      s1_r#field7 := UserTable_field7[s1_keyname];
      s1_r#field8 := UserTable_field8[s1_keyname];
      s1_r#field9 := UserTable_field9[s1_keyname];
      s1_r#ycsb_key := UserTable_ycsb_key[s1_keyname];
      UserTable_field1 := UserTable_field1[s1_keyname := s1_r#field1];
