...
modifies UserTable_field1, UserTable_field10, UserTable_field2, UserTable_field3, UserTable_field4, UserTable_field5, UserTable_field6, UserTable_field7, UserTable_field8, UserTable_field9, UserTable_ycsb_key;
{
  ...
  var s0_#tmp18 : int;
  var s0_#tmp19 : Row (Table (UserTable));
  ...
  // Executing A then B:
    if (s0_active) {
    s0_block6__ab:
      s0_#tmp18 := s0_startKey + 1;
      s0_#tmp19 := construct_Row_UserTable(UserTable_ycsb_key[s0_#tmp18], UserTable_field1[s0_#tmp18], UserTable_field2[s0_#tmp18], UserTable_field3[s0_#tmp18], UserTable_field4[s0_#tmp18], UserTable_field5[s0_#tmp18], UserTable_field6[s0_#tmp18], UserTable_field7[s0_#tmp18], UserTable_field8[s0_#tmp18], UserTable_field9[s0_#tmp18], UserTable_field10[s0_#tmp18]);
      s0_r := s0_#tmp19;
      s0_#tmp31 := to_unit(s0_r);
