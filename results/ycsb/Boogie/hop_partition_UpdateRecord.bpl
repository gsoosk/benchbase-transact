...
modifies UserTable_field1, UserTable_field10, UserTable_field2, UserTable_field3, UserTable_field4, UserTable_field5, UserTable_field6, UserTable_field7, UserTable_field8, UserTable_field9, UserTable_ycsb_key;
{
  ...
  // Partition check hop 2 func 'f' tables 'UserTable'=>'UserTable' keys [k0=keyname] first_span Span { start: 1185, end: 1213, filename: "/Users/farzad/Desktop/Research/benchbase-transact/ycsb.transact" } current_span Span { start: 1455, end: 1487, filename: "/Users/farzad/Desktop/Research/benchbase-transact/ycsb.transact" }
    assert {:msg "(PartitionFunctionInconsistency (partition_function_id . 15) (function_id . 17) (hop_id . 2) (table_id . 0) (span ((start . 1455) (end . 1487) (filename . \"/Users/farzad/Desktop/Research/benchbase-transact/ycsb.transact\"))))"} (s2_keyname == s2_keyname);
