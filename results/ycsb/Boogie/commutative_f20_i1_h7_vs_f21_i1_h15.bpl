...
procedure Check_SliceCommut_Hop7_vs_Hop15()
modifies UserTable_field1, UserTable_field10, UserTable_field2, UserTable_field3, UserTable_field4, UserTable_field5, UserTable_field6, UserTable_field7, UserTable_field8, UserTable_field9, UserTable_ycsb_key;
{
  ...
  var s0_#tmp32 : int;
  var s0_#tmp33 : Row (Table (UserTable));
  ...
  // Slice commutativity verification: hop 7 vs hop 15
  ...
  // Executing A then B:
    if (s0_active) {
    s0_block7__ab:
      s0_#tmp32 := s0_startKey + 2;
      s0_#tmp33 := construct_Row_UserTable(UserTable_ycsb_key[s0_#tmp32], UserTable_field1[s0_#tmp32], UserTable_field2[s0_#tmp32], UserTable_field3[s0_#tmp32], UserTable_field4[s0_#tmp32], UserTable_field5[s0_#tmp32], UserTable_field6[s0_#tmp32], UserTable_field7[s0_#tmp32], UserTable_field8[s0_#tmp32], UserTable_field9[s0_#tmp32], UserTable_field10[s0_#tmp32]);
      s0_r := s0_#tmp33;
      s0_#tmp45 := to_unit(s0_r);
