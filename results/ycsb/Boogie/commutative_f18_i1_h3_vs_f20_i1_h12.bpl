...
procedure Check_SliceCommut_Hop3_vs_Hop12()
modifies UserTable_field1, UserTable_field10, UserTable_field2, UserTable_field3, UserTable_field4, UserTable_field5, UserTable_field6, UserTable_field7, UserTable_field8, UserTable_field9;
{
  ...
  // Slice commutativity verification: hop 3 vs hop 12
  ...
  // Verifying A->B === B->A equivalence:
    assert {:msg "(SpecialInterleavingNonEquivalence (node_1 (function_id . 18) (instance . 1) (hop_id . 3)) (node_2 (function_id . 20) (instance . 1) (hop_id . 12)))"} (((((((((((UserTable_field1_a_then_b == UserTable_field1_b_then_a) && (UserTable_field10_a_then_b == UserTable_field10_b_then_a)) && (UserTable_field2_a_then_b == UserTable_field2_b_then_a)) && (UserTable_field3_a_then_b == UserTable_field3_b_then_a)) && (UserTable_field4_a_then_b == UserTable_field4_b_then_a)) && (UserTable_field5_a_then_b == UserTable_field5_b_then_a)) && (UserTable_field6_a_then_b == UserTable_field6_b_then_a)) && (UserTable_field7_a_then_b == UserTable_field7_b_then_a)) && (UserTable_field8_a_then_b == UserTable_field8_b_then_a)) && (UserTable_field9_a_then_b == UserTable_field9_b_then_a)) && (s1_startKey_a_then_b == s1_startKey_b_then_a));
}
