...
procedure Check_SliceCommut_Hop4_vs_Hop13()
modifies UserTable_field1, UserTable_field10, UserTable_field2, UserTable_field3, UserTable_field4, UserTable_field5, UserTable_field6, UserTable_field7, UserTable_field8, UserTable_field9, UserTable_ycsb_key;
{
  ...
  var s1_startKey_init : int;
  var s0_r#field1 : String;
  var s0_r#field10 : String;
  var s0_r#field2 : String;
  var s0_r#field3 : String;
  var s0_r#field4 : String;
  var s0_r#field5 : String;
  var s0_r#field6 : String;
  var s0_r#field7 : String;
  var s0_r#field8 : String;
  var s0_r#field9 : String;
  var s0_r#ycsb_key : int;
  var s1_#tmp116 : int;
  var s1_#tmp117 : Row (Table (UserTable));
  var s1_r : Row (Table (UserTable));
  var s1_#tmp129 : unit;
  ...
  var s1_startKey_b_then_a : int;

  // Slice commutativity verification: hop 4 vs hop 13
  ...
  // --- Step 2: Save initial state ---
    ...
    s1_startKey_init := s1_startKey;
  // --- Step 3: Execute special interleavings ---
  // Executing A then B:
    if (s0_active) {
    s0_block4__ab:
      s0_r#field1 := UserTable_field1[s0_keyname];
      s0_r#field10 := UserTable_field10[s0_keyname];
      s0_r#field2 := UserTable_field2[s0_keyname];
      s0_r#field3 := UserTable_field3[s0_keyname];
      s0_r#field4 := UserTable_field4[s0_keyname];
      s0_r#field5 := UserTable_field5[s0_keyname];
      s0_r#field6 := UserTable_field6[s0_keyname];
      s0_r#field7 := UserTable_field7[s0_keyname];
      s0_r#field8 := UserTable_field8[s0_keyname];
      s0_r#field9 := UserTable_field9[s0_keyname];
      s0_r#ycsb_key := UserTable_ycsb_key[s0_keyname];
      UserTable_field1 := UserTable_field1[s0_keyname := s0_r#field1];
      UserTable_field10 := UserTable_field10[s0_keyname := s0_r#field10];
      UserTable_field2 := UserTable_field2[s0_keyname := s0_r#field2];
      UserTable_field3 := UserTable_field3[s0_keyname := s0_r#field3];
      UserTable_field4 := UserTable_field4[s0_keyname := s0_r#field4];
      UserTable_field5 := UserTable_field5[s0_keyname := s0_r#field5];
      UserTable_field6 := UserTable_field6[s0_keyname := s0_r#field6];
      UserTable_field7 := UserTable_field7[s0_keyname := s0_r#field7];
      UserTable_field8 := UserTable_field8[s0_keyname := s0_r#field8];
      UserTable_field9 := UserTable_field9[s0_keyname := s0_r#field9];
      UserTable_ycsb_key := UserTable_ycsb_key[s0_keyname := s0_r#ycsb_key];
      s0_active := false;
    ...
    if (s1_active) {
    s1_block13__ab:
      s1_#tmp116 := s1_startKey + 8;
      s1_#tmp117 := construct_Row_UserTable(UserTable_ycsb_key[s1_#tmp116], UserTable_field1[s1_#tmp116], UserTable_field2[s1_#tmp116], UserTable_field3[s1_#tmp116], UserTable_field4[s1_#tmp116], UserTable_field5[s1_#tmp116], UserTable_field6[s1_#tmp116], UserTable_field7[s1_#tmp116], UserTable_field8[s1_#tmp116], UserTable_field9[s1_#tmp116], UserTable_field10[s1_#tmp116]);
      s1_r := s1_#tmp117;
      s1_#tmp129 := to_unit(s1_r);
  ...
  // Snapshotting final state for a_then_b
    ...
    s1_startKey_a_then_b := s1_startKey;
  ...
  // Snapshotting final state for b_then_a
    ...
    s1_startKey_b_then_a := s1_startKey;
  // --- Step 4: Verify A→B ≡ B→A (Special interleavings equivalence) ---
  // Verifying A->B === B->A equivalence:
    assert {:msg "(SpecialInterleavingNonEquivalence (node_1 (function_id . 19) (instance . 1) (hop_id . 4)) (node_2 (function_id . 20) (instance . 0) (hop_id . 13)))"} ((((((((((((UserTable_field1_a_then_b == UserTable_field1_b_then_a) && (UserTable_field10_a_then_b == UserTable_field10_b_then_a)) && (UserTable_field2_a_then_b == UserTable_field2_b_then_a)) && (UserTable_field3_a_then_b == UserTable_field3_b_then_a)) && (UserTable_field4_a_then_b == UserTable_field4_b_then_a)) && (UserTable_field5_a_then_b == UserTable_field5_b_then_a)) && (UserTable_field6_a_then_b == UserTable_field6_b_then_a)) && (UserTable_field7_a_then_b == UserTable_field7_b_then_a)) && (UserTable_field8_a_then_b == UserTable_field8_b_then_a)) && (UserTable_field9_a_then_b == UserTable_field9_b_then_a)) && (UserTable_ycsb_key_a_then_b == UserTable_ycsb_key_b_then_a)) && (s1_startKey_a_then_b == s1_startKey_b_then_a));
}
