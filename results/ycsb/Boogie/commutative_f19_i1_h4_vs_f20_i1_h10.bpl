...
modifies UserTable_field1, UserTable_field10, UserTable_field2, UserTable_field3, UserTable_field4, UserTable_field5, UserTable_field6, UserTable_field7, UserTable_field8, UserTable_field9, UserTable_ycsb_key;
{
  ...
  var s1_#tmp74 : int;
  var s1_#tmp75 : Row (Table (UserTable));
  ...
  // Executing A then B:
    ...
    if (s1_active) {
    s1_block10__ab:
      s1_#tmp74 := s1_startKey + 5;
      s1_#tmp75 := construct_Row_UserTable(UserTable_ycsb_key[s1_#tmp74], UserTable_field1[s1_#tmp74], UserTable_field2[s1_#tmp74], UserTable_field3[s1_#tmp74], UserTable_field4[s1_#tmp74], UserTable_field5[s1_#tmp74], UserTable_field6[s1_#tmp74], UserTable_field7[s1_#tmp74], UserTable_field8[s1_#tmp74], UserTable_field9[s1_#tmp74], UserTable_field10[s1_#tmp74]);
      s1_r := s1_#tmp75;
      s1_#tmp87 := to_unit(s1_r);
