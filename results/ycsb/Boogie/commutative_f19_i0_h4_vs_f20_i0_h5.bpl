...
procedure Check_SliceCommut_Hop4_vs_Hop5()
modifies UserTable_field1, UserTable_field10, UserTable_field2, UserTable_field3, UserTable_field4, UserTable_field5, UserTable_field6, UserTable_field7, UserTable_field8, UserTable_field9, UserTable_ycsb_key;
{
  ...
  var s1_#tmp4 : int;
  var s1_#tmp5 : Row (Table (UserTable));
  ...
  // Slice commutativity verification: hop 4 vs hop 5
  ...
  // Executing A then B:
    ...
    if (s1_active) {
    s1_block5__ab:
      s1_#tmp4 := s1_startKey + 0;
      s1_#tmp5 := construct_Row_UserTable(UserTable_ycsb_key[s1_#tmp4], UserTable_field1[s1_#tmp4], UserTable_field2[s1_#tmp4], UserTable_field3[s1_#tmp4], UserTable_field4[s1_#tmp4], UserTable_field5[s1_#tmp4], UserTable_field6[s1_#tmp4], UserTable_field7[s1_#tmp4], UserTable_field8[s1_#tmp4], UserTable_field9[s1_#tmp4], UserTable_field10[s1_#tmp4]);
      s1_r := s1_#tmp5;
      s1_#tmp17 := to_unit(s1_r);
